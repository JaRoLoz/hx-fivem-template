...
extern class Natives {
	...
	static function ActivateDamageTrackerOnNetworkId(netID:Number, toggle:Bool):Void;
	static function ActivateDamageTrackerOnPlayer(player:Number, toggle:Bool):Void;
	static function N_0xbec0816ff5acbcda(player:Number, toggle:Bool):Void;
	static function ActivateFrontendMenu(menuhash:Number, togglePause:Bool, component:Number):Void;
	...
	static function AddCoverBlockingArea(playerX:Number, playerY:Number, playerZ:Number, radiusX:Number, radiusY:Number, radiusZ:Number, p6:Bool, p7:Bool,
		p8:Bool, p9:Bool):Void;
	static function AddCoverPoint(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Bool):Number;
	static function AddDecal(decalType:Number, posX:Number, posY:Number, posZ:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		width:Number, height:Number, rCoef:Number, gCoef:Number, bCoef:Number, opacity:Number, timeout:Number, p17:Bool, p18:Bool, p19:Bool):Number;
	...
	static function AddDoorToSystem(doorHash:Number, modelHash:Number, x:Number, y:Number, z:Number, p5:Bool, scriptDoor:Bool, isLocal:Bool):Void;
	...
	static function AddExplosion(x:Number, y:Number, z:Number, explosionType:Number, damageScale:Number, isAudible:Bool, isInvisible:Bool,
		cameraShake:Number):Void;
	static function AddExplosionWithUserVfx(x:Number, y:Number, z:Number, explosionType:Number, explosionFx:Number, damageScale:Number, isAudible:Bool,
		isInvisible:Bool, cameraShake:Number):Void;
	static function AddSpecfxExplosion(x:Number, y:Number, z:Number, explosionType:Number, explosionFx:Number, damageScale:Number, isAudible:Bool,
		isInvisible:Bool, cameraShake:Number):Void;
	...
	static function AddLineToConversation(index:Number, p1:String, p2:String, p3:Number, p4:Number, p5:Bool, p6:Bool, p7:Bool, p8:Bool, p9:Number, p10:Bool,
		p11:Bool, p12:Bool):Void;
	...
	static function AddModelToCreatorBudget(modelHash:Number):Bool;
	static function N_0x0bc3144deb678666(modelHash:Number):Bool;
	static function AddNavmeshBlockingObject(x:Number, y:Number, z:Number, width:Number, length:Number, height:Number, heading:Number, p7:Bool,
		p8:Number):Number;
	...
	static function AddOwnedExplosion(ped:Number, x:Number, y:Number, z:Number, explosionType:Number, damageScale:Number, isAudible:Bool, isInvisible:Bool,
		cameraShake:Number):Void;
	...
	static function AddPopMultiplierArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p6:Number, p7:Number, p8:Bool):Number;
	static function N_0x67f6413d3220e18d(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p6:Number, p7:Number, p8:Bool):Number;
	static function AddPopMultiplierSphere(x:Number, y:Number, z:Number, radius:Number, pedMultiplier:Number, vehicleMultiplier:Number, p6:Bool,
		p7:Bool):Number;
	static function N_0x32c7a7e8c43a1f80(x:Number, y:Number, z:Number, radius:Number, pedMultiplier:Number, vehicleMultiplier:Number, p6:Bool, p7:Bool):Number;
	...
	static function AddRoadNodeSpeedZone(x:Number, y:Number, z:Number, radius:Number, speed:Number, p5:Bool):Number;
	static function N_0x2ce544c68fb812a0(x:Number, y:Number, z:Number, radius:Number, speed:Number, p5:Bool):Number;
	static function AddSpeedZoneForCoord(x:Number, y:Number, z:Number, radius:Number, speed:Number, p5:Bool):Number;
	static function AddRope(x:Number, y:Number, z:Number, rotX:Number, rotY:Number, rotZ:Number, maxLength:Number, ropeType:Number, initLength:Number,
		minLength:Number, lengthChangeRate:Number, onlyPPU:Bool, collisionOn:Bool, lockFromFront:Bool, timeMultiplier:Number, breakable:Bool,
		unkPtr:Number):AddRopeReturnType;
	static function AddScenarioBlockingArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p6:Bool, p7:Bool, p8:Bool, p9:Bool):Number;
	...
	static function AddTextComponentFormattedInteger(value:Number, commaSeparated:Bool):Void;
	static function N_0x0e4c749ff9de9cc4(value:Number, commaSeparated:Bool):Void;
	...
	static function AddToItemset(p0:Number, p1:Number):Bool;
	...
	static function AddVehicleCrewEmblem(vehicle:Number, ped:Number, boneIndex:Number, x1:Number, x2:Number, x3:Number, y1:Number, y2:Number, y3:Number,
		z1:Number, z2:Number, z3:Number, scale:Number, p13:Number, alpha:Number):Bool;
	...
	static function AddVehicleStuckCheckWithWarp(p0:Number, p1:Number, p2:Number, p3:Bool, p4:Bool, p5:Bool, p6:Number):Void;
	...
	static function N_0xdea36202fc3382df(toggle:Bool):Void;
	...
	static function N_0x60734cc207c9833c(toggle:Bool):Void;
	...
	static function GetScreenEffectIsActive(effectName:String):Bool;
	static function AnimpostfxPlay(effectName:String, duration:Number, looped:Bool):Void;
	static function StartScreenEffect(effectName:String, duration:Number, looped:Bool):Void;
	...
	static function ApplyDamageToPed(ped:Number, damageAmount:Number, armorFirst:Bool):Void;
	...
	static function ApplyForceToEntityCenterOfMass(entity:Number, forceType:Number, x:Number, y:Number, z:Number, p5:Bool, isDirectionRel:Bool,
		isForceRel:Bool, p8:Bool):Void;
	...
	static function ApplyPedDamageDecal(ped:Number, damageZone:Number, xOffset:Number, yOffset:Number, heading:Number, scale:Number, alpha:Number,
		variation:Number, fadeIn:Bool, decalName:String):Void;
	...
	static function AreAllVehicleWindowsIntact(vehicle:Number):Bool;
	static function AreAnyVehicleSeatsFree(vehicle:Number):Bool;
	static function IsAnyVehicleSeatEmpty(vehicle:Number):Bool;
	static function AreBombBayDoorsOpen(aircraft:Number):Bool;
	static function N_0xd0917a423314bba8(aircraft:Number):Bool;
	static function GetAreBombBayDoorsOpen(aircraft:Number):Bool;
	static function AreEntitiesEntirelyInsideGarage(garageHash:Number, p1:Bool, p2:Bool, p3:Bool, p4:Number):Bool;
	static function N_0x85b6c850546fdde2(garageHash:Number, p1:Bool, p2:Bool, p3:Bool, p4:Number):Bool;
	static function AreHeliStubWingsDeployed(vehicle:Number):Bool;
	static function N_0xaef12960fa943792(vehicle:Number):Bool;
	static function AreNodesLoadedForArea(x1:Number, y1:Number, x2:Number, y2:Number):Bool;
	static function N_0xf7b79a50b905a30d(x1:Number, y1:Number, x2:Number, y2:Number):Bool;
	static function ArePathNodesLoadedInArea(x1:Number, y1:Number, x2:Number, y2:Number):Bool;
	static function AreOutriggerLegsDeployed(vehicle:Number):Bool;
	static function N_0x3a9128352eac9e85(vehicle:Number):Bool;
	static function ArePlanePropellersIntact(plane:Number):Bool;
	static function N_0x755d6d5267cbbd7e(plane:Number):Bool;
	static function ArePropellersUndamaged(plane:Number):Bool;
	static function ArePlaneWingsIntact(plane:Number):Bool;
	static function N_0x5991a01434ce9677(plane:Number):Bool;
	static function AddAMarkerOverVehicle(plane:Number):Bool;
	static function AreVehicleWingsIntact(plane:Number):Bool;
	static function ArePlayerFlashingStarsAboutToDrop(player:Number):Bool;
	static function ArePlayerStarsGreyedOut(player:Number):Bool;
	static function AreProfileSettingsValid():Bool;
	static function N_0x5aa3befa29f03ad4():Bool;
	...
	static function AttachCamToEntity(cam:Number, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, isRelative:Bool):Void;
	static function AttachCamToPedBone(cam:Number, ped:Number, boneIndex:Number, xOffset:Number, yOffset:Number, zOffset:Number, isRelative:Bool):Void;
	static function AttachCamToPedBone_2(cam:Number, ped:Number, boneIndex:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number,
		p9:Bool):Void;
	static function AttachCamToVehicleBone(cam:Number, vehicle:Number, boneIndex:Number, relativeRotation:Bool, rotX:Number, rotY:Number, rotZ:Number,
		offX:Number, offY:Number, offZ:Number, fixedDirection:Bool):Void;
	static function N_0x8db3f12a02caef72(cam:Number, vehicle:Number, boneIndex:Number, relativeRotation:Bool, rotX:Number, rotY:Number, rotZ:Number,
		offX:Number, offY:Number, offZ:Number, fixedDirection:Bool):Void;
	...
	static function AttachEntitiesToRope(ropeId:Number, ent1:Number, ent2:Number, ent1_x:Number, ent1_y:Number, ent1_z:Number, ent2_x:Number, ent2_y:Number,
		ent2_z:Number, length:Number, p10:Bool, p11:Bool, boneName1:String, boneName2:String):Void;
	static function AttachEntityBoneToEntityBone(entity1:Number, entity2:Number, entityBone:Number, entityBone2:Number, p4:Bool, p5:Bool):Void;
	static function N_0x5c48b75732c8456c(entity1:Number, entity2:Number, entityBone:Number, entityBone2:Number, p4:Bool, p5:Bool):Void;
	static function AttachEntityBoneToEntityBonePhysically(entity1:Number, entity2:Number, entityBone:Number, entityBone2:Number, p4:Bool, p5:Bool):Void;
	static function N_0xfd1695c5d3b05439(entity1:Number, entity2:Number, entityBone:Number, entityBone2:Number, p4:Bool, p5:Bool):Void;
	...
	static function AttachEntityToEntity(entity1:Number, entity2:Number, boneIndex:Number, xPos:Number, yPos:Number, zPos:Number, xRot:Number, yRot:Number,
		zRot:Number, p9:Bool, useSoftPinning:Bool, collision:Bool, isPed:Bool, rotationOrder:Number, syncRot:Bool):Void;
	static function AttachEntityToEntityPhysically(entity1:Number, entity2:Number, boneIndex1:Number, boneIndex2:Number, xPos1:Number, yPos1:Number,
		zPos1:Number, xPos2:Number, yPos2:Number, zPos2:Number, xRot:Number, yRot:Number, zRot:Number, breakForce:Number, fixedRot:Bool, p15:Bool,
		collision:Bool, teleport:Bool, p18:Number):Void;
	static function AttachPortablePickupToPed(pickupObject:Number, ped:Number):Void;
	static function AttachRopeToEntity(ropeId:Number, entity:Number, x:Number, y:Number, z:Number, p5:Bool):Void;
	...
	static function AttachVehicleToTowTruck(towTruck:Number, vehicle:Number, rear:Bool, hookOffsetX:Number, hookOffsetY:Number, hookOffsetZ:Number):Void;
	...
	static function N_0x3d120012440e6683():Bool;
	...
	static function BeginScaleformMovieMethod(scaleform:Number, methodName:String):Bool;
	static function PushScaleformMovieFunction(scaleform:Number, methodName:String):Bool;
	static function BeginScaleformMovieMethodOnFrontend(functionName:String):Bool;
	static function N_0xab58c27c2e6123c6(functionName:String):Bool;
	static function PushScaleformMovieFunctionN(functionName:String):Bool;
	static function BeginScaleformMovieMethodN(functionName:String):Bool;
	static function BeginScaleformMovieMethodOnFrontendHeader(functionName:String):Bool;
	static function N_0xb9449845f73f5e9c(functionName:String):Bool;
	static function BeginScaleformMovieMethodV(functionName:String):Bool;
	static function BeginScaleformScriptHudMovieMethod(hudComponent:Number, methodName:String):Bool;
	static function PushScaleformMovieFunctionFromHudComponent(hudComponent:Number, methodName:String):Bool;
	static function BeginScaleformMovieMethodHudComponent(hudComponent:Number, methodName:String):Bool;
	static function BeginSrl():Void;
	static function BeginTakeHighQualityPhoto():Bool;
	static function N_0xa67c35c56eb1bd9d():Bool;
	static function BeginTakeMissionCreatorPhoto():Bool;
	static function N_0x1dd2139a9a20dce8():Bool;
	...
	static function N_0xf154b8d1775b2dec(toggle:Bool):Void;
	static function BlockDecisionMakerEvent(name:Number, eventType:Number):Void;
	static function BlockDispatchServiceResourceCreation(dispatchService:Number, toggle:Bool):Void;
	static function N_0x9b2bd3773123ea2f(dispatchService:Number, toggle:Bool):Void;
	static function BlockPedDeadBodyShockingEvents(ped:Number, toggle:Bool):Void;
	static function N_0xe43a13c9e4cccbcf(ped:Number, toggle:Bool):Void;
	static function BreakEntityGlass(entity:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Bool):Void;
	static function BreakObjectFragmentChild(p0:Number, p1:Number, p2:Bool):Void;
	static function N_0xe7e4c198b0185900(p0:Number, p1:Number, p2:Bool):Void;
	static function BreakOffVehicleWheel(vehicle:Number, wheelIndex:Number, leaveDebrisTrail:Bool, deleteWheel:Bool, unknownFlag:Bool, putOnFire:Bool):Void;
	static function BringVehicleToHalt(vehicle:Number, distance:Number, duration:Number, bControlVerticalVelocity:Bool):Void;
	static function N_0x260be8f09e326a20(vehicle:Number, distance:Number, duration:Number, bControlVerticalVelocity:Bool):Void;
	static function SetVehicleHalt(vehicle:Number, distance:Number, duration:Number, bControlVerticalVelocity:Bool):Void;
	static function BusyspinnerIsDisplaying():Bool;
	static function N_0xb2a592b04648a9cb():Bool;
	static function BusyspinnerIsOn():Bool;
	static function N_0xd422fcc5f239a915():Bool;
	static function IsLoadingPromptBeingDisplayed():Bool;
	...
	static function CallMinimapScaleformFunction(miniMap:Number, fnName:String):Bool;
	...
	static function CallScaleformMovieFunctionStringParams(scaleform:Number, methodName:String, param1:String, param2:String, param3:String, param4:String,
		param5:String):Void;
	static function CanAnchorBoatHere(vehicle:Number):Bool;
	static function N_0x2467a2d807d37ca3(vehicle:Number):Bool;
	static function GetBoatAnchor(vehicle:Number):Bool;
	static function CanBoatBeAnchored(vehicle:Number):Bool;
	static function CanAnchorBoatHere_2(vehicle:Number):Bool;
	static function CanBoatBeAnchored_2(vehicle:Number):Bool;
	...
	static function CanKnockPedOffVehicle(ped:Number):Bool;
	static function CanPayGoon():Bool;
	static function N_0x9777734dad16992f():Bool;
	static function CanPedHearPlayer(player:Number, ped:Number):Bool;
	static function CanPedInCombatSeeTarget(ped:Number, target:Number):Bool;
	static function CanPedRagdoll(ped:Number):Bool;
	static function CanPedSeeHatedPed(ped1:Number, ped2:Number):Bool;
	static function N_0x6cd5a433374d4cfb(ped1:Number, ped2:Number):Bool;
	static function CanPedSeePed(ped1:Number, ped2:Number):Bool;
	static function CanPedSpeak(ped:Number, speechName:String, unk:Bool):Bool;
	static function N_0x49b99bf3fda89a7a(ped:Number, speechName:String, unk:Bool):Bool;
	static function CanPhoneBeSeenOnScreen():Bool;
	static function CanPlayerStartMission(player:Number):Bool;
	static function CanRegisterMissionEntities(ped_amt:Number, vehicle_amt:Number, object_amt:Number, pickup_amt:Number):Bool;
	static function CanRegisterMissionObjects(amount:Number):Bool;
	static function CanRegisterMissionPeds(amount:Number):Bool;
	static function CanRegisterMissionPickups(amount:Number):Bool;
	static function CanRegisterMissionVehicles(amount:Number):Bool;
	static function CanRequestAssetsForCutsceneEntity():Bool;
	static function N_0xb56bbbcc2955d9cb():Bool;
	static function CanSetEnterStateForRegisteredEntity(cutsceneEntName:String, modelHash:Number):Bool;
	static function CanSetExitStateForCamera(p0:Bool):Bool;
	static function CanSetExitStateForRegisteredEntity(cutsceneEntName:String, modelHash:Number):Bool;
	static function CanShuffleSeat(vehicle:Number, seatIndex:Number):Bool;
	static function CanUseWeaponOnParachute(weaponHash:Number):Bool;
	...
	static function CapInterior(interiorID:Number, toggle:Bool):Void;
	...
	static function SetFarShadowsSuppressed(toggle:Bool):Void;
	...
	static function N_0x6ddbf9dffc4ac080(p0:Bool):Void;
	static function CascadeShadowsSetCascadeBounds(p0:Number, p1:Bool, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Number):Void;
	static function N_0xd2936cab8b58fcbd(p0:Number, p1:Bool, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Number):Void;
	...
	static function N_0xd39d13c9febf0511(p0:Bool):Void;
	...
	static function N_0x015c49a93e3e086e(toggle:Bool):Void;
	static function DisablePhoneThisFrame(toggle:Bool):Void;
	static function CellCamIsCharVisibleNoFaceCheck(entity:Number):Bool;
	...
	static function SetPhoneLean(toggle:Bool):Void;
	...
	static function ChangePlayerPed(player:Number, ped:Number, b2:Bool, resetDamage:Bool):Void;
	...
	static function ClearAdditionalText(p0:Number, p1:Bool):Void;
	...
	static function ClearAmbientZoneListState(p1:Bool):Number;
	static function ClearAmbientZoneState(zoneName:String, p1:Bool):Void;
	static function ClearAngledAreaOfVehicles(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number, p7:Bool, p8:Bool, p9:Bool,
		p10:Bool, p11:Bool):Void;
	static function ClearArea(X:Number, Y:Number, Z:Number, radius:Number, p4:Bool, ignoreCopCars:Bool, ignoreObjects:Bool, p7:Bool):Void;
	static function ClearAreaLeaveVehicleHealth(x:Number, y:Number, z:Number, radius:Number, p4:Bool, p5:Bool, p6:Bool, p7:Bool):Void;
	static function N_0x957838aaf91bd12d(x:Number, y:Number, z:Number, radius:Number, p4:Bool, p5:Bool, p6:Bool, p7:Bool):Void;
	static function ClearAreaOfEverything(x:Number, y:Number, z:Number, radius:Number, p4:Bool, p5:Bool, p6:Bool, p7:Bool):Void;
	static function ClearAreaOfCops(x:Number, y:Number, z:Number, radius:Number, createNetEvent:Bool):Void;
	static function ClearAreaOfObjects(x:Number, y:Number, z:Number, radius:Number, flags:Number):Void;
	static function ClearAreaOfPeds(x:Number, y:Number, z:Number, radius:Number, createNetEvent:Bool):Void;
	static function ClearAreaOfProjectiles(x:Number, y:Number, z:Number, radius:Number, createNetEvent:Bool):Void;
	static function ClearAreaOfVehicles(x:Number, y:Number, z:Number, radius:Number, p4:Bool, p5:Bool, p6:Bool, p7:Bool, p8:Bool):Void;
	...
	static function ClearFloatingHelp(hudIndex:Number, p1:Bool):Void;
	static function ClearFocus():Void;
	static function ClearGarageArea(garageHash:Number, isNetwork:Bool):Void;
	static function N_0xda05194260cdcdf9(garageHash:Number, isNetwork:Bool):Void;
	...
	static function ClearObjectsInsideGarage(garageHash:Number, vehicles:Bool, peds:Bool, objects:Bool, isNetwork:Bool):Void;
	static function N_0x190428512b240692(garageHash:Number, vehicles:Bool, peds:Bool, objects:Bool, isNetwork:Bool):Void;
	...
	static function ClonePed(ped:Number, isNetwork:Bool, bScriptHostPed:Bool, copyHeadBlendFlag:Bool):Number;
	static function ClonePedEx(ped:Number, heading:Number, isNetwork:Bool, bScriptHostPed:Bool, p4:Number):Number;
	static function N_0x668fd40bcba5de48(ped:Number, heading:Number, isNetwork:Bool, bScriptHostPed:Bool, p4:Number):Number;
	static function ClonePed_2(ped:Number, heading:Number, isNetwork:Bool, bScriptHostPed:Bool, p4:Number):Number;
	...
	static function CloudDidRequestSucceed(handle:Number):Bool;
	static function N_0x3a3d5568af297cd5(handle:Number):Bool;
	static function CloudGetAvailabilityCheckResult():Bool;
	static function NetworkEnableMotionDrugged():Bool;
	static function N_0x0b0cc10720653f3b():Bool;
	static function CloudHasRequestCompleted(handle:Number):Bool;
	static function N_0x4c61b39930d045da(handle:Number):Bool;
	static function CloudIsCheckingAvailability():Bool;
	static function N_0xc7abac5de675ee3b():Bool;
	static function CommitRuntimeTexture(tex:Number):Void;
	static function CompareStrings(str1:String, str2:String, matchCase:Bool, maxLength:Number):Number;
	...
	static function ControlMountedWeapon(ped:Number):Bool;
	...
	static function CreateAmbientPickup(pickupHash:Number, posX:Number, posY:Number, posZ:Number, flags:Number, value:Number, modelHash:Number,
		returnHandle:Bool, p8:Bool):Number;
	static function CreateAudioSubmix(name:String):Number;
	static function CreateCam(camName:String, active:Bool):Number;
	static function CreateCamWithParams(camName:String, posX:Number, posY:Number, posZ:Number, rotX:Number, rotY:Number, rotZ:Number, fov:Number, active:Bool,
		rotationOrder:Number):Number;
	static function CreateCamera(camHash:Number, active:Bool):Number;
	static function CreateCameraWithParams(camHash:Number, posX:Number, posY:Number, posZ:Number, rotX:Number, rotY:Number, rotZ:Number, fov:Number,
		active:Bool, rotationOrder:Number):Number;
	...
	static function CreateFakeMpGamerTag(ped:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number):Number;
	static function N_0xbfefe3321a3f5015(ped:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number):Number;
	static function CreateMpGamerTag(ped:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number):Number;
	static function CreateForcedObject(x:Number, y:Number, z:Number, p3:Number, modelHash:Number, p5:Bool):Void;
	static function CreateGroup(unused:Number):Number;
	static function CreateIncident(dispatchService:Number, x:Number, y:Number, z:Number, numUnits:Number, radius:Number,
		outIncidentID:Number):CreateIncidentReturnType;
	static function CreateIncidentWithEntity(dispatchService:Number, ped:Number, numUnits:Number, radius:Number,
		outIncidentID:Number):CreateIncidentWithEntityReturnType;
	static function CreateItemset(distri:Bool):Number;
	static function CreateMissionTrain(variation:Number, x:Number, y:Number, z:Number, direction:Bool):Number;
	static function CreateMobilePhone(phoneType:Number):Void;
	static function CreateModelHide(x:Number, y:Number, z:Number, radius:Number, model:Number, p5:Bool):Void;
	static function CreateModelHideExcludingScriptObjects(x:Number, y:Number, z:Number, radius:Number, model:Number, p5:Bool):Void;
	static function CreateModelSwap(x:Number, y:Number, z:Number, radius:Number, originalModel:Number, newModel:Number, p6:Bool):Void;
	static function CreateMoneyPickups(x:Number, y:Number, z:Number, value:Number, amount:Number, model:Number):Void;
	static function CreateMpGamerTagWithCrewColor(player:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number,
		crewR:Number, crewG:Number, crewB:Number):Void;
	static function N_0x6dd05e9d83efa4c9(player:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number,
		crewR:Number, crewG:Number, crewB:Number):Void;
	static function CreateMpGamerTagColor(player:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number,
		crewR:Number, crewG:Number, crewB:Number):Void;
	static function SetMpGamerTagColor(player:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number,
		crewR:Number, crewG:Number, crewB:Number):Void;
	static function CreateMpGamerTagForNetPlayer(player:Number, username:String, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:String, crewRank:Number,
		crewR:Number, crewG:Number, crewB:Number):Void;
	static function CreateNewScriptedConversation():Void;
	static function CreateNmMessage(startImmediately:Bool, messageId:Number):Void;
	static function CreateNonNetworkedAmbientPickup(pickupHash:Number, posX:Number, posY:Number, posZ:Number, flags:Number, value:Number, modelHash:Number,
		p7:Bool, p8:Bool):Number;
	static function N_0x9c93764223e29c50(pickupHash:Number, posX:Number, posY:Number, posZ:Number, flags:Number, value:Number, modelHash:Number, p7:Bool,
		p8:Bool):Number;
	static function CreateNonNetworkedPortablePickup(pickupHash:Number, x:Number, y:Number, z:Number, placeOnGround:Bool, modelHash:Number):Number;
	static function N_0x125494b98a21aaf7(pickupHash:Number, x:Number, y:Number, z:Number, placeOnGround:Bool, modelHash:Number):Number;
	static function CreatePortablePickup_2(pickupHash:Number, x:Number, y:Number, z:Number, placeOnGround:Bool, modelHash:Number):Number;
	static function CreateObject(modelHash:Number, x:Number, y:Number, z:Number, isNetwork:Bool, netMissionEntity:Bool, doorFlag:Bool):Number;
	static function CreateObjectNoOffset(modelHash:Number, x:Number, y:Number, z:Number, isNetwork:Bool, netMissionEntity:Bool, doorFlag:Bool):Number;
	static function CreateParachuteBagObject(ped:Number, p1:Bool, p2:Bool):Number;
	static function N_0x8c4f3bf23b6237db(ped:Number, p1:Bool, p2:Bool):Number;
	static function CreateParachuteObject(ped:Number, p1:Bool, p2:Bool):Number;
	static function CreatePatrolRoute():Void;
	static function CreatePed(pedType:Number, modelHash:Number, x:Number, y:Number, z:Number, heading:Number, isNetwork:Bool, bScriptHostPed:Bool):Number;
	static function CreatePedInsideVehicle(vehicle:Number, pedType:Number, modelHash:Number, seat:Number, isNetwork:Bool, bScriptHostPed:Bool):Number;
	...
	static function CreatePickup(pickupHash:Number, posX:Number, posY:Number, posZ:Number, p4:Number, value:Number, p6:Bool, modelHash:Number):Number;
	static function CreatePickupRotate(pickupHash:Number, posX:Number, posY:Number, posZ:Number, rotX:Number, rotY:Number, rotZ:Number, flag:Number,
		amount:Number, p9:Number, p10:Bool, modelHash:Number):Number;
	static function CreatePortablePickup(pickupHash:Number, x:Number, y:Number, z:Number, placeOnGround:Bool, modelHash:Number):Number;
	static function CreateRandomPed(posX:Number, posY:Number, posZ:Number):Number;
	static function CreateRandomPedAsDriver(vehicle:Number, returnHandle:Bool):Number;
	...
	static function CreateScriptVehicleGenerator(x:Number, y:Number, z:Number, heading:Number, p4:Number, p5:Number, modelHash:Number, p7:Number, p8:Number,
		p9:Number, p10:Number, p11:Bool, p12:Bool, p13:Bool, p14:Bool, p15:Bool, p16:Number):Number;
	...
	static function CreateVehicle(modelHash:Number, x:Number, y:Number, z:Number, heading:Number, isNetwork:Bool, netMissionEntity:Bool):Number;
	static function CreateWeaponObject(weaponHash:Number, ammoCount:Number, x:Number, y:Number, z:Number, showWorldModel:Bool, scale:Number, p7:Number):Number;
	static function CustomMenuCoordinates(p0:Number):Void;
	static function N_0x487a82c650eb7799(p0:Number):Void;
	static function DataarrayAddBool(value:Bool):Number;
	static function ArrayValueAddBoolean(value:Bool):Number;
	...
	static function DatadictSetBool(key:String, value:Bool):Number;
	static function ObjectValueAddBoolean(key:String, value:Bool):Number;
	...
	static function DatafileDeleteRequestedFile(p0:Number):Bool;
	static function N_0x8f5ea1c01d65a100(p0:Number):Bool;
	...
	static function DatafileHasLoadedFileData(p0:Number):Bool;
	static function N_0x15ff52b809db2353(p0:Number):Bool;
	static function DatafileHasValidFileData(p0:Number):Bool;
	static function N_0xf8cc1ebe0b62e29f(p0:Number):Bool;
	static function DatafileIsSavePending():Bool;
	static function N_0xbedb96a7584aa8cf():Bool;
	static function DatafileIsValidRequestId(index:Number):Bool;
	static function N_0xfccae5b92a830878(index:Number):Bool;
	static function DatafileLoadOfflineUgc(filename:String):Bool;
	static function LoadUgcFile(filename:String):Bool;
	static function DatafileSelectActiveFile(p0:Number):Bool;
	static function N_0x22da66936e0fff37(p0:Number):Bool;
	static function DatafileSelectCreatorStats(p0:Number):Bool;
	static function N_0x01095c95cd46b624(p0:Number):Bool;
	static function DatafileSelectUgcData(p0:Number):Bool;
	static function N_0xa69ac4ade82b57a4(p0:Number):Bool;
	static function DatafileSelectUgcPlayerData(p0:Number):Bool;
	static function N_0x52818819057f2b40(p0:Number):Bool;
	static function DatafileSelectUgcStats(p0:Number, p1:Bool):Bool;
	static function N_0x9cb0bfa7a9342c3d(p0:Number, p1:Bool):Bool;
	static function DatafileStartSaveToCloud(filename:String):Bool;
	static function N_0x83bcce3224735f05(filename:String):Bool;
	...
	static function DecorExistOn(entity:Number, propertyName:String):Bool;
	static function DecorGetBool(entity:Number, propertyName:String):Bool;
	...
	static function DecorIsRegisteredAsType(propertyName:String, _type:Number):Bool;
	static function DecorRegister(propertyName:String, _type:Number):Void;
	static function DecorRegisterLock():Void;
	static function DecorRemove(entity:Number, propertyName:String):Bool;
	static function DecorSetBool(entity:Number, propertyName:String, value:Bool):Bool;
	static function DecorSetFloat(entity:Number, propertyName:String, value:Number):Bool;
	static function DecorSetInt(entity:Number, propertyName:String, value:Number):Bool;
	static function DecorSetTime(entity:Number, propertyName:String, timestamp:Number):Bool;
	...
	static function DepositVc(amount:Number):Bool;
	static function N_0xe260e0bb9cd995ac(amount:Number):Bool;
	static function DestroyAllCams(bScriptHostCam:Bool):Void;
	static function DestroyCam(cam:Number, bScriptHostCam:Bool):Void;
	...
	static function DetachEntity(entity:Number, _dynamic:Bool, collision:Bool):Void;
	...
	static function DetachVehicleFromAnyCargobob(vehicle:Number):Bool;
	static function DetachVehicleFromAnyTowTruck(vehicle:Number):Bool;
	...
	static function DisableControlAction(padIndex:Number, control:Number, disable:Bool):Void;
	...
	static function DisableHospitalRestart(hospitalIndex:Number, toggle:Bool):Void;
	static function DisableIdleCamera(state:Bool):Void;
	...
	static function DisableInterior(interiorID:Number, toggle:Bool):Void;
	static function DisableMultiplayerChat(disable:Bool):Void;
	static function SetTextChatUnk(disable:Bool):Void;
	...
	static function DisablePedPainAudio(ped:Number, toggle:Bool):Void;
	static function DisablePlaneAileron(vehicle:Number, p1:Bool, p2:Bool):Void;
	static function DisablePlayerFiring(player:Number, toggle:Bool):Void;
	static function DisablePlayerVehicleRewards(player:Number):Void;
	static function DisablePoliceRestart(policeIndex:Number, toggle:Bool):Void;
	...
	static function DisableVehicleNeonLights(vehicle:Number, toggle:Bool):Void;
	static function N_0x83f813570ff519de(vehicle:Number, toggle:Bool):Void;
	static function DisableVehiclePassengerIdleCamera(state:Bool):Void;
	...
	static function DisableVehicleWeapon(disabled:Bool, weaponHash:Number, vehicle:Number, owner:Number):Void;
	static function DisableVehicleWorldCollision(vehicle:Number):Void;
	static function N_0x75627043c6aa90ad(vehicle:Number):Void;
	static function DisableWorldhorizonRendering(state:Bool):Void;
	...
	static function N_0x82cedc33687e1f50(toggle:Bool):Void;
	...
	static function N_0x552369f549563ad5(value:Bool):Void;
	static function ForceAmbientSiren(value:Bool):Void;
	...
	static function DoesAirDefenseZoneExist(zoneId:Number):Bool;
	static function N_0xcd79a550999d7d4f(zoneId:Number):Bool;
	static function DoesAnimDictExist(animDict:String):Bool;
	static function DoesBlipExist(blip:Number):Bool;
	static function DoesBlipHaveGpsRoute(blip:Number):Bool;
	static function N_0xdd2238f57b977751(blip:Number):Bool;
	static function DoesCamExist(cam:Number):Bool;
	static function DoesCargobobHavePickUpRope(cargobob:Number):Bool;
	static function IsCargobobHookActive(cargobob:Number):Bool;
	static function DoesCargobobHavePickupMagnet(cargobob:Number):Bool;
	static function IsCargobobMagnetActive(cargobob:Number):Bool;
	static function DoesCutsceneEntityExist(cutsceneEntName:String, modelHash:Number):Bool;
	static function DoesEntityBelongToThisScript(entity:Number, p2:Bool):Bool;
	static function DoesEntityExist(entity:Number):Bool;
	static function DoesEntityHaveAnimDirector(entity:Number):Bool;
	static function DoesEntityHaveDrawable(entity:Number):Bool;
	static function DoesEntityHavePhysics(entity:Number):Bool;
	static function DoesEntityHaveSkeletonData(entity:Number):Bool;
	static function DoesExtraExist(vehicle:Number, extraId:Number):Bool;
	static function DoesGroupExist(groupId:Number):Bool;
	static function DoesLatestBriefStringExist(briefValue:Number):Bool;
	static function N_0x5e657ef1099edd65(briefValue:Number):Bool;
	static function DoesNavmeshBlockingObjectExist(p0:Number):Bool;
	static function N_0x0eaeb0db4b132399(p0:Number):Bool;
	static function DoesObjectOfTypeExistAtCoords(x:Number, y:Number, z:Number, radius:Number, hash:Number, p5:Bool):Bool;
	static function DoesParticleFxLoopedExist(ptfxHandle:Number):Bool;
	static function DoesPedHaveAiBlip(ped:Number):Bool;
	static function DoesPickupExist(pickup:Number):Bool;
	static function DoesPickupObjectExist(pickupObject:Number):Bool;
	static function DoesPickupOfTypeExistInArea(pickupHash:Number, x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsPickupWithinRadius(pickupHash:Number, x:Number, y:Number, z:Number, radius:Number):Bool;
	static function DoesPlayerVehHaveRadio():Bool;
	static function N_0x109697e2ffbac8a1():Bool;
	static function DoesPopMultiplierAreaExist(id:Number):Bool;
	static function N_0x1327e2fe9746baee(id:Number):Bool;
	static function DoesPopMultiplierSphereExist(id:Number):Bool;
	static function N_0x171bafb3c60389f4(id:Number):Bool;
	static function DoesRayfireMapObjectExist(object:Number):Bool;
	static function N_0x52af537a0c5b8aad(object:Number):Bool;
	static function DoesDesObjectExist(object:Number):Bool;
	static function DoesRelationshipGroupExist(groupHash:Number):Bool;
	static function N_0xcc6e3b6bb69501f1(groupHash:Number):Bool;
	static function DoesRopeBelongToThisScript(ropeId:Number):Bool;
	static function N_0x271c9d3aca5d6409(ropeId:Number):Bool;
	static function DoesRopeExist(ropeId:Number):DoesRopeExistReturnType;
	static function DoesScenarioBlockingAreaExist(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function N_0x8a24b067d175a7bd(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function DoesScenarioExistInArea(x:Number, y:Number, z:Number, radius:Number, b:Bool):Bool;
	static function DoesScenarioGroupExist(scenarioGroup:String):Bool;
	static function DoesScenarioOfTypeExistInArea(p0:Number, p1:Number, p2:Number, p3:String, p4:Number, p5:Bool):Bool;
	static function DoesScriptExist(scriptName:String):Bool;
	static function DoesScriptVehicleGeneratorExist(vehicleGenerator:Number):Bool;
	static function DoesScriptWithNameHashExist(scriptHash:Number):Bool;
	static function N_0xf86aa3c56ba31381(scriptHash:Number):Bool;
	static function DoesScriptedCoverPointExistAtCoords(x:Number, y:Number, z:Number):Bool;
	static function DoesShopPedApparelHaveRestrictionTag(componentHash:Number, restrictionTagHash:Number, componentId:Number):Bool;
	static function N_0x341de7ed1d2a1bfd(componentHash:Number, restrictionTagHash:Number, componentId:Number):Bool;
	...
	static function DoesVehicleAllowRappel(vehicle:Number):Bool;
	static function N_0x4e417c547182c84d(vehicle:Number):Bool;
	static function DoesVehicleExistWithDecorator(decorator:String):Bool;
	static function DoesVehicleHaveCrewEmblem(vehicle:Number, p1:Number):Bool;
	static function HasVehicleGotDecal(vehicle:Number, p1:Number):Bool;
	static function DoesVehicleHaveDecal(vehicle:Number, p1:Number):Bool;
	static function DoesVehicleHaveLandingGear(vehicle:Number):Bool;
	static function N_0xe43701c36caff1a4(vehicle:Number):Bool;
	static function GetVehicleHasLandingGear(vehicle:Number):Bool;
	static function DoesVehicleHaveRoof(vehicle:Number):Bool;
	static function DoesVehicleHaveSearchlight(vehicle:Number):Bool;
	static function DoesVehicleHaveStuckVehicleCheck(vehicle:Number):Bool;
	static function DoesVehicleHaveWeapons(vehicle:Number):Bool;
	static function DoesVehicleTyreExist(vehicle:Number, tyreIndex:Number):Bool;
	static function N_0x534e36d4db9ecc5d(vehicle:Number, tyreIndex:Number):Bool;
	static function DoesWeaponTakeWeaponComponent(weaponHash:Number, componentHash:Number):Bool;
	static function DontRenderInGameUi(p0:Bool):Void;
	static function N_0x22a249a53034450a(p0:Bool):Void;
	static function DontTiltMinimapThisFrame():Void;
	static function CenterPlayerOnRadarThisFrame():Void;
	static function DoorControl(modelHash:Number, x:Number, y:Number, z:Number, locked:Bool, xRotMult:Number, yRotMult:Number, zRotMult:Number):Void;
	...
	static function DoorSystemGetIsPhysicsLoaded(doorHash:Number):Bool;
	static function N_0xdf97cdd4fc08fd34(doorHash:Number):Bool;
	...
	static function DoorSystemSetAutomaticDistance(doorHash:Number, distance:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function N_0x9ba001cb45cbf627(doorHash:Number, distance:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function DoorSystemSetAutomaticRate(doorHash:Number, rate:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function N_0x03c27e13b42a0e82(doorHash:Number, rate:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function DoorSystemSetDoorState(doorHash:Number, state:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function N_0x6bab9442830c7f53(doorHash:Number, state:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function SetDoorAccelerationLimit(doorHash:Number, state:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function DoorSystemSetHoldOpen(doorHash:Number, toggle:Bool):Void;
	static function N_0xd9b71952f78a2640(doorHash:Number, toggle:Bool):Void;
	static function DoorSystemSetOpenRatio(doorHash:Number, ajar:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function N_0xb6e6fba95c7324ac(doorHash:Number, ajar:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function SetDoorAjarAngle(doorHash:Number, ajar:Number, requestDoor:Bool, forceUpdate:Bool):Void;
	static function DoorSystemSetSpringRemoved(doorHash:Number, removed:Bool, requestDoor:Bool, forceUpdate:Bool):Void;
	static function N_0xc485e07e4f0b7958(doorHash:Number, removed:Bool, requestDoor:Bool, forceUpdate:Bool):Void;
	...
	static function DrawGizmo(matrixPtr:Number, id:String):Bool;
	...
	static function N_0x1072f115dab0717e(p0:Bool, p1:Bool):Void;
	static function DrawMarker(_type:Number, posX:Number, posY:Number, posZ:Number, dirX:Number, dirY:Number, dirZ:Number, rotX:Number, rotY:Number,
		rotZ:Number, scaleX:Number, scaleY:Number, scaleZ:Number, red:Number, green:Number, blue:Number, alpha:Number, bobUpAndDown:Bool, faceCamera:Bool,
		p19:Number, rotate:Bool, textureDict:String, textureName:String, drawOnEnts:Bool):Void;
	static function DrawMarker_2(_type:Number, posX:Number, posY:Number, posZ:Number, dirX:Number, dirY:Number, dirZ:Number, rotX:Number, rotY:Number,
		rotZ:Number, scaleX:Number, scaleY:Number, scaleZ:Number, red:Number, green:Number, blue:Number, alpha:Number, bobUpAndDown:Bool, faceCamera:Bool,
		p19:Number, rotate:Bool, textureDict:String, textureName:String, drawOnEnts:Bool, p24:Bool):Void;
	...
	static function DrawShowroom(p0:String, ped:Number, p2:Number, posX:Number, posY:Number, posZ:Number):Bool;
	static function N_0x98c4fe6ec34154ca(p0:String, ped:Number, p2:Number, posX:Number, posY:Number, posZ:Number):Bool;
	...
	static function EnableAircraftObstacleAvoidance(vehicle:Number, avoidObstacles:Bool):Void;
	static function N_0x8aa9180de2fedd45(vehicle:Number, avoidObstacles:Bool):Void;
	static function EnableAlienBloodVfx(toggle:Bool):Void;
	static function N_0x9dce1f0f78260875(toggle:Bool):Void;
	static function EnableAllControlActions(padIndex:Number):Void;
	static function EnableClownBloodVfx(toggle:Bool):Void;
	static function SetCameraEndtime(toggle:Bool):Void;
	static function EnableControlAction(padIndex:Number, control:Number, enable:Bool):Void;
	static function EnableCrosshairThisFrame():Void;
	static function EnableDispatchService(dispatchService:Number, toggle:Bool):Void;
	static function N_0xdc0f817884cdd856(dispatchService:Number, toggle:Bool):Void;
	...
	static function N_0x74c180030fde4b69(toggle:Bool):Void;
	static function EnableMovieSubtitles(toggle:Bool):Void;
	static function EnableSavingInGarage(garageHash:Number, toggle:Bool):Void;
	static function N_0xf2e1a7133dd356a6(garageHash:Number, toggle:Bool):Void;
	...
	static function EnableSpecialAbility(player:Number, toggle:Bool):Void;
	static function EnableStallWarningSounds(vehicle:Number, toggle:Bool):Void;
	static function N_0xc15907d667f7cfb2(vehicle:Number, toggle:Bool):Void;
	...
	static function EnableTennisMode(ped:Number, toggle:Bool, p2:Bool):Void;
	static function EnableVehicleExhaustPops(vehicle:Number, toggle:Bool):Void;
	static function N_0x2be4bc731d039d5a(vehicle:Number, toggle:Bool):Void;
	...
	static function EndTextCommandDisplayHelp(shape:Number, loop:Bool, beep:Bool, duration:Number):Void;
	static function DisplayHelpTextFromStringLabel(shape:Number, loop:Bool, beep:Bool, duration:Number):Void;
	static function EndTextCommandDisplayText(x:Number, y:Number):Void;
	static function DrawText(x:Number, y:Number):Void;
	static function EndTextCommandGetWidth(p0:Bool):Number;
	static function GetTextScreenWidth(p0:Bool):Number;
	static function EndTextCommandIsMessageDisplayed():Bool;
	static function N_0x8a9ba1ab3e237613():Bool;
	static function EndTextCommandIsThisHelpMessageBeingDisplayed(hudIndex:Number):Bool;
	static function N_0x10bddbfc529428dd(hudIndex:Number):Bool;
	...
	static function N_0xcfdbdf5ae59ba0f4(p0:Bool):Void;
	...
	static function EndTextCommandPrint(duration:Number, drawImmediately:Bool):Void;
	static function DrawSubtitleTimed(duration:Number, drawImmediately:Bool):Void;
	...
	static function EndTextCommandThefeedPostCrewRankup(chTitle:String, clanTxd:String, clanTxn:String, isImportant:Bool, showSubtitle:Bool):Number;
	static function N_0x8efccf6ec66d85e4(chTitle:String, clanTxd:String, clanTxn:String, isImportant:Bool, showSubtitle:Bool):Number;
	static function EndTextCommandThefeedPostCrewtag(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, hasFounderStatus:Bool,
		isImportant:Bool, clanHandle:Number, r:Number, g:Number, b:Number):EndTextCommandThefeedPostCrewtagReturnType;
	static function N_0x97c9e4e7024a8f2c(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, hasFounderStatus:Bool, isImportant:Bool,
		clanHandle:Number, r:Number, g:Number, b:Number):N_0x97c9e4e7024a8f2cReturnType;
	static function NotificationSendApartmentInvite(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, hasFounderStatus:Bool,
		isImportant:Bool, clanHandle:Number, r:Number, g:Number, b:Number):NotificationSendApartmentInviteReturnType;
	static function DrawNotificationApartmentInvite(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, hasFounderStatus:Bool,
		isImportant:Bool, clanHandle:Number, r:Number, g:Number, b:Number):DrawNotificationApartmentInviteReturnType;
	static function EndTextCommandThefeedPostCrewtagWithGameName(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, isLeader:Bool,
		isImportant:Bool, clanHandle:Number, gamerStr:String, r:Number, g:Number, b:Number):EndTextCommandThefeedPostCrewtagWithGameNameReturnType;
	static function N_0x137bc35589e34e1e(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, isLeader:Bool, isImportant:Bool,
		clanHandle:Number, gamerStr:String, r:Number, g:Number, b:Number):N_0x137bc35589e34e1eReturnType;
	static function NotificationSendClanInvite(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, isLeader:Bool, isImportant:Bool,
		clanHandle:Number, gamerStr:String, r:Number, g:Number, b:Number):NotificationSendClanInviteReturnType;
	static function DrawNotificationClanInvite(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, rank:Number, isLeader:Bool, isImportant:Bool,
		clanHandle:Number, gamerStr:String, r:Number, g:Number, b:Number):DrawNotificationClanInviteReturnType;
	static function EndTextCommandThefeedPostMessagetext(textureDict:String, textureName:String, flash:Bool, iconType:Number, sender:String,
		subject:String):Number;
	static function SetNotificationMessage(textureDict:String, textureName:String, flash:Bool, iconType:Number, sender:String, subject:String):Number;
	static function EndTextCommandThefeedPostMessagetextGxtEntry(txdName:String, textureName:String, flash:Bool, iconType:Number, sender:String,
		subject:String):Number;
	static function N_0xc6f580e4c94926ac(txdName:String, textureName:String, flash:Bool, iconType:Number, sender:String, subject:String):Number;
	static function SetNotificationMessage_3(txdName:String, textureName:String, flash:Bool, iconType:Number, sender:String, subject:String):Number;
	static function EndTextCommandThefeedPostMessagetextEntry(txdName:String, textureName:String, flash:Bool, iconType:Number, sender:String,
		subject:String):Number;
	static function EndTextCommandThefeedPostMessagetextTu(picTxd:String, picTxn:String, flash:Bool, iconType:Number, nameStr:String, subtitleStr:String,
		durationMultiplier:Number):Number;
	static function N_0x1e6611149db3db6b(picTxd:String, picTxn:String, flash:Bool, iconType:Number, nameStr:String, subtitleStr:String,
		durationMultiplier:Number):Number;
	static function SetNotificationMessage_4(picTxd:String, picTxn:String, flash:Bool, iconType:Number, nameStr:String, subtitleStr:String,
		durationMultiplier:Number):Number;
	static function EndTextCommandThefeedPostMessagetextWithCrewTag(picTxd:String, picTxn:String, flash:Bool, iconType:Number, nameStr:String,
		subtitleStr:String, duration:Number, crewPackedStr:String):Number;
	static function SetNotificationMessageClanTag(picTxd:String, picTxn:String, flash:Bool, iconType:Number, nameStr:String, subtitleStr:String,
		duration:Number, crewPackedStr:String):Number;
	static function EndTextCommandThefeedPostMessagetextWithCrewTagAndAdditionalIcon(picTxd:String, picTxn:String, flash:Bool, iconType1:Number,
		nameStr:String, subtitleStr:String, duration:Number, crewPackedStr:String, iconType2:Number, textColor:Number):Number;
	static function SetNotificationMessageClanTag_2(picTxd:String, picTxn:String, flash:Bool, iconType1:Number, nameStr:String, subtitleStr:String,
		duration:Number, crewPackedStr:String, iconType2:Number, textColor:Number):Number;
	static function EndTextCommandThefeedPostMpticker(blink:Bool, bHasTokens:Bool):Number;
	static function DrawNotification_4(blink:Bool, bHasTokens:Bool):Number;
	...
	static function EndTextCommandThefeedPostStats(statTitle:String, iconEnum:Number, stepVal:Bool, barValue:Number, isImportant:Bool, picTxd:String,
		picTxn:String):Number;
	static function N_0x2b7e9a4eaaa93c89(statTitle:String, iconEnum:Number, stepVal:Bool, barValue:Number, isImportant:Bool, picTxd:String,
		picTxn:String):Number;
	static function SetNotificationMessage_2(statTitle:String, iconEnum:Number, stepVal:Bool, barValue:Number, isImportant:Bool, picTxd:String,
		picTxn:String):Number;
	static function EndTextCommandThefeedPostTicker(isImportant:Bool, bHasTokens:Bool):Number;
	static function DrawNotification(isImportant:Bool, bHasTokens:Bool):Number;
	static function EndTextCommandThefeedPostTickerForced(blink:Bool, bHasTokens:Bool):Number;
	static function DrawNotification_2(blink:Bool, bHasTokens:Bool):Number;
	static function EndTextCommandThefeedPostTickerWithTokens(isImportant:Bool, bHasTokens:Bool):Number;
	static function DrawNotification_3(isImportant:Bool, bHasTokens:Bool):Number;
	...
	static function EndTextCommandThefeedPostUnlockTu(chTitle:String, iconType:Number, chSubtitle:String, isImportant:Bool):Number;
	static function N_0xc8f3aaf93d0600bf(chTitle:String, iconType:Number, chSubtitle:String, isImportant:Bool):Number;
	static function EndTextCommandThefeedPostUnlockTuWithColor(chTitle:String, iconType:Number, chSubtitle:String, isImportant:Bool, titleColor:Number,
		p5:Bool):Number;
	static function N_0x7ae0589093a2e088(chTitle:String, iconType:Number, chSubtitle:String, isImportant:Bool, titleColor:Number, p5:Bool):Number;
	...
	static function ExplodeProjectiles(ped:Number, weaponHash:Number, p2:Bool):Void;
	static function ExplodeVehicle(vehicle:Number, isAudible:Bool, isInvisible:Bool):Void;
	static function ExplodeVehicleInCutscene(vehicle:Number, p1:Bool):Void;
	...
	static function N_0xa75e2b6733da5142():Bool;
	static function FacebookIsAvailable():Bool;
	static function N_0x43865688ae10f0d7():Bool;
	static function FacebookIsSendingData():Bool;
	static function N_0x62b9fec9a11f10ef():Bool;
	static function FacebookSetCreateCharacterComplete():Bool;
	static function N_0xdc48473142545431():Bool;
	static function FacebookSetHeistComplete(heistName:String, cashEarned:Number, xpEarned:Number):Bool;
	static function N_0x098ab65b9ed9a9ec(heistName:String, cashEarned:Number, xpEarned:Number):Bool;
	static function FacebookSetMilestoneComplete(milestoneId:Number):Bool;
	static function N_0x0ae1f1653b554ab9(milestoneId:Number):Bool;
	...
	static function N_0xcef214315d276fd1(toggle:Bool):Void;
	static function SetIsInTournament(toggle:Bool):Void;
	...
	static function N_0xa41bcd7213805aac(p0:Bool):Void;
	...
	static function ForcePedAiAndAnimationUpdate(ped:Number, p1:Bool, p2:Bool):Void;
	static function N_0x2208438012482a1a(ped:Number, p1:Bool, p2:Bool):Void;
	static function ForcePedMotionState(ped:Number, motionStateHash:Number, p2:Bool, p3:Number, p4:Bool):Bool;
	...
	static function ForcePlaybackRecordedVehicleUpdate(vehicle:Number, p1:Bool):Void;
	static function N_0x1f2e4e06dea8992b(vehicle:Number, p1:Bool):Void;
	...
	static function N_0xdc459cfa0cce245b(toggle:Bool):Void;
	...
	static function ForceSnowPass(enabled:Bool):Void;
	...
	static function ForceSubmarineSurfaceMode(vehicle:Number, toggle:Bool):Void;
	static function N_0x33506883545ac0df(vehicle:Number, toggle:Bool):Void;
	...
	static function FreezeEntityPosition(entity:Number, toggle:Bool):Void;
	...
	static function GenerateDirectionsToCoord(x:Number, y:Number, z:Number, p3:Bool):GenerateDirectionsToCoordReturnType;
	...
	static function N_0xfc859e2374407556():Bool;
	...
	static function GetAnimInitialOffsetRotation(animDict:String, animName:String, x:Number, y:Number, z:Number, xRot:Number, yRot:Number, zRot:Number,
		p8:Number, p9:Number):Vector3;
	static function GetAspectRatio(b:Bool):Number;
	static function GetScreenAspectRatio(b:Bool):Number;
	static function GetAudibleMusicTrackTextId():Number;
	static function GetBaseElementMetadata(p3:Number, p4:Bool):GetBaseElementMetadataReturnType;
	static function N_0xb335f761606db47c(p3:Number, p4:Bool):N_0xb335f761606db47cReturnType;
	...
	static function GetBestPedWeapon(ped:Number, p1:Bool):Number;
	...
	static function GetBoatBoomPositionRatio_2(vehicle:Number, p1:Bool):Void;
	static function N_0xc1f981a6f74f0c23(vehicle:Number, p1:Bool):Void;
	static function GetBoatBoomPositionRatio_3(vehicle:Number, p1:Bool):Void;
	static function N_0x0f3b4d4e43177236(vehicle:Number, p1:Bool):Void;
	...
	static function GetCanVehicleJump(vehicle:Number):Bool;
	static function HasVehicleJumpingAbility(vehicle:Number):Bool;
	static function DoesVehicleHaveJumpingAbility(vehicle:Number):Bool;
	...
	static function GetClosestObjectOfType(x:Number, y:Number, z:Number, radius:Number, modelHash:Number, isMission:Bool, p6:Bool, p7:Bool):Number;
	static function GetClosestPed(x:Number, y:Number, z:Number, radius:Number, p4:Bool, p5:Bool, p7:Bool, p8:Bool, pedType:Number):GetClosestPedReturnType;
	static function GetClosestRoad(x:Number, y:Number, z:Number, p3:Number, p4:Number, p10:Bool):GetClosestRoadReturnType;
	...
	static function GetControlGroupInstructionalButton(padIndex:Number, controlGroup:Number, p2:Bool):String;
	static function N_0x80c2fd58d720c801(padIndex:Number, controlGroup:Number, p2:Bool):String;
	static function GetControlInstructionalButton(padIndex:Number, control:Number, p2:Bool):String;
	static function N_0x0499d7b09fc9b407(padIndex:Number, control:Number, p2:Bool):String;
	...
	static function GetIsProjectileTypeInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, projectileHash:Number,
		ownedByPlayer:Bool):GetIsProjectileTypeInAreaReturnType;
	static function GetCoordsOfProjectileTypeWithinDistance(ped:Number, weaponHash:Number, distance:Number,
		ownedByPlayer:Bool):GetCoordsOfProjectileTypeWithinDistanceReturnType;
	static function N_0xdfb4138eefed7b81(ped:Number, weaponHash:Number, distance:Number, ownedByPlayer:Bool):N_0xdfb4138eefed7b81ReturnType;
	static function GetProjectileNearPedCoords(ped:Number, weaponHash:Number, distance:Number, ownedByPlayer:Bool):GetProjectileNearPedCoordsReturnType;
	...
	static function GetCurrentPedWeapon(ped:Number, p2:Bool):GetCurrentPedWeaponReturnType;
	...
	static function GetDistanceBetweenCoords(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, useZ:Bool):Number;
	...
	static function GetDoesVehicleHaveTombstone(vehicle:Number):Bool;
	static function GetDriftTyresEnabled(vehicle:Number):Bool;
	...
	static function GetEntityCanBeDamaged(entity:Number):Bool;
	static function N_0xd95cc5d2ab15a09f(entity:Number):Bool;
	static function GetEntityCollisionDisabled(entity:Number):Bool;
	static function N_0xccf1e97befdae480(entity:Number):Bool;
	static function GetEntityCollisonDisabled(entity:Number):Bool;
	static function GetEntityCoords(entity:Number, alive:Bool):Vector3;
	...
	static function GetEntityHeight(entity:Number, X:Number, Y:Number, Z:Number, atTop:Bool, inWorldCoords:Bool):Number;
	...
	static function GetEntitySpeedVector(entity:Number, relative:Bool):Vector3;
	...
	static function GetEventExists(eventGroup:Number, eventIndex:Number):Bool;
	...
	static function N_0x8d30f648014a92b5():Bool;
	...
	static function N_0x869daacbbe9fa006():Bool;
	static function GetGpsBlipRouteLength():Number;
	static function N_0xbbb45c3cf5c8aa85():Number;
	static function GetGpsWaypointRouteEnd(p1:Bool, p2:Number, p3:Number):GetGpsWaypointRouteEndReturnType;
	static function N_0xf3162836c28f9da5(p1:Bool, p2:Number, p3:Number):N_0xf3162836c28f9da5ReturnType;
	...
	static function GetGroundZFor_3dCoord(x:Number, y:Number, z:Number, ignoreWater:Bool):GetGroundZFor_3dCoordReturnType;
	static function GetGroundZFor_3dCoord_2(x:Number, y:Number, z:Number, p4:Bool):GetGroundZFor_3dCoord_2ReturnType;
	static function N_0x9e82f0f362881b29(x:Number, y:Number, z:Number, p4:Bool):N_0x9e82f0f362881b29ReturnType;
	static function GetGroupSize(groupID:Number):GetGroupSizeReturnType;
	static function GetHasObjectFragInst(object:Number):Bool;
	static function N_0x0c112765300c7e1e(object:Number):Bool;
	static function DoesEntityHaveFragInst(object:Number):Bool;
	static function GetHasRetractableWheels(vehicle:Number):Bool;
	static function GetHasLowerableWheels(vehicle:Number):Bool;
	static function DoesVehicleHaveRetractableWheels(vehicle:Number):Bool;
	static function GetHasRocketBoost(vehicle:Number):Bool;
	static function HasVehicleRocketBoost(vehicle:Number):Bool;
	static function DoesVehicleHaveRocketBoost(vehicle:Number):Bool;
	...
	static function GetIsArenaPropPhysicsDisabled(entity:Number, p1:Number):Bool;
	static function N_0x43c677f1e1158005(entity:Number, p1:Number):Bool;
	static function GetIsAutoSaveOff():Bool;
	static function N_0x6e04f06094c87047():Bool;
	static function GetIsBoatCapsized(vehicle:Number):Bool;
	static function N_0xba91d045575699ad(vehicle:Number):Bool;
	static function GetIsDoorValid(vehicle:Number, doorIndex:Number):Bool;
	static function DoesVehicleHaveDoor(vehicle:Number, doorIndex:Number):Bool;
	static function GetIsHidef():Bool;
	static function GetIsLeftVehicleHeadlightDamaged(vehicle:Number):Bool;
	static function IsHeadlightLBroken(vehicle:Number):Bool;
	static function GetIsLoadingScreenActive():Bool;
	static function GetIsPedGadgetEquipped(ped:Number, gadgetHash:Number):Bool;
	static function GetIsPetrolDecalInRange(xCoord:Number, yCoord:Number, zCoord:Number, radius:Number):Bool;
	static function N_0x2f09f7976c512404(xCoord:Number, yCoord:Number, zCoord:Number, radius:Number):Bool;
	static function GetIsPlayerInAnimalForm():Bool;
	static function N_0x9689123e3f213aa5():Bool;
	static function GetIsPreloadedConversationReady():Bool;
	static function N_0xe73364db90778ffa():Bool;
	static function GetIsRightVehicleHeadlightDamaged(vehicle:Number):Bool;
	static function IsHeadlightRBroken(vehicle:Number):Bool;
	static function GetIsTaskActive(ped:Number, taskIndex:Number):Bool;
	static function GetIsUsingAlternateDriveby():Bool;
	static function N_0x0f70731baccfbb96():Bool;
	static function GetIsVehicleEmpDisabled(vehicle:Number):Bool;
	static function GetIsVehicleEngineRunning(vehicle:Number):Bool;
	static function IsVehicleEngineOn(vehicle:Number):Bool;
	static function GetIsVehiclePrimaryColourCustom(vehicle:Number):Bool;
	static function GetIsVehicleSecondaryColourCustom(vehicle:Number):Bool;
	static function GetIsVehicleShuntBoostActive(vehicle:Number):Bool;
	static function GetIsWaypointRecordingLoaded(name:String):Bool;
	static function GetIsWheelsLoweredStateActive(vehicle:Number):Bool;
	static function N_0x1da0da9cb3f0c8bf(vehicle:Number):Bool;
	...
	static function GetMapdataEntityMatrix(mapDataHash:Number, entityInternalIdx:Number, matrixPtr:Number):Bool;
	...
	static function GetMaxAmmoInClip(ped:Number, weaponHash:Number, p2:Bool):Number;
	...
	static function GetMinimapFowCoordinateIsRevealed(x:Number, y:Number, z:Number):Bool;
	static function N_0x6e31b91145873922(x:Number, y:Number, z:Number):Bool;
	static function IsMinimapAreaRevealed(x:Number, y:Number, z:Number):Bool;
	...
	static function GetNgstatBoolHash(index:Number, spStat:Bool, charStat:Bool, character:Number, section:String):Number;
	static function N_0xba52ff538ed2bc71(index:Number, spStat:Bool, charStat:Bool, character:Number, section:String):Number;
	static function GetNgstatIntHash(index:Number, spStat:Bool, charStat:Bool, character:Number, section:String):Number;
	static function N_0x2b4cdca6f07ff3da(index:Number, spStat:Bool, charStat:Bool, character:Number, section:String):Number;
	...
	static function GetNumCreatedMissionObjects(p0:Bool):Number;
	static function N_0x12b6281b6c6706c0(p0:Bool):Number;
	static function GetNumCreatedMissionPeds(p0:Bool):Number;
	static function N_0xcb215c4b56a7fae7(p0:Bool):Number;
	static function GetNumCreatedMissionVehicles(p0:Bool):Number;
	static function N_0x0cd9ab83489430ea(p0:Bool):Number;
	...
	static function GetNumModColors(paintType:Number, p1:Bool):Number;
	...
	static function GetNumReservedMissionObjects(p0:Bool):Number;
	static function GetNumReservedMissionPeds(p0:Bool):Number;
	static function GetNumReservedMissionVehicles(p0:Bool):Number;
	...
	static function GetObjectFragmentDamageHealth(p0:Number, p1:Bool):Number;
	...
	static function GetPackedBoolStatKey(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function N_0x80c75307b1c42837(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPstatBoolHash(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPackedIntStatKey(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function N_0x61e111e323419e07(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPstatIntHash(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPackedTuBoolStatKey(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function N_0xc4bb08ee7907471e(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetTupstatBoolHash(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPackedTitleUpdateBoolStatKey(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPackedTuIntStatKey(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function N_0xd16c2ad6b8e32854(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetTupstatIntHash(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	static function GetPackedTitleUpdateIntStatKey(index:Number, spStat:Bool, charStat:Bool, character:Number):Number;
	...
	static function GetPedConfigFlag(ped:Number, flagId:Number, p2:Bool):Bool;
	...
	static function GetPedDefensiveAreaPosition(ped:Number, p1:Bool):Vector3;
	static function GetPedDensityMultiplier():Number;
	static function GetPedDesiredMoveBlendRatio(ped:Number):Number;
	static function GetPedDiesInWater(ped:Number):Bool;
	...
	static function GetPedExtractedDisplacement(ped:Number, worldSpace:Bool):Vector3;
	...
	static function GetPedResetFlag(ped:Number, flagId:Number):Bool;
	static function GetPedSourceOfDeath(ped:Number):Number;
	static function GetPedKiller(ped:Number):Number;
	static function GetPedStealthMovement(ped:Number):Bool;
	...
	static function GetPlayerHasReserveParachute(player:Number):Bool;
	...
	static function GetPlayerInvincible(player:Number):Bool;
	static function GetPlayerInvincible_2(player:Number):Bool;
	...
	static function GetProjectileNearPed(ped:Number, weaponHash:Number, distance:Number, ownedByPlayer:Bool):GetProjectileNearPedReturnType;
	static function N_0x82fde6a57ee4ee44(ped:Number, weaponHash:Number, distance:Number, ownedByPlayer:Bool):N_0x82fde6a57ee4ee44ReturnType;
	...
	static function GetRandomVehicleModelInMemory(p0:Bool):GetRandomVehicleModelInMemoryReturnType;
	static function GetRandomVehicleNode(x:Number, y:Number, z:Number, radius:Number, p4:Bool, p5:Bool, p6:Bool):GetRandomVehicleNodeReturnType;
	...
	static function N_0x35fb78dc42b7bd21():Bool;
	...
	static function GetSafeCoordForPed(x:Number, y:Number, z:Number, onGround:Bool, flags:Number):GetSafeCoordForPedReturnType;
	...
	static function GetScaleformMovieMethodReturnValueBool(methodReturn:Number):Bool;
	static function N_0xd80a80346a45d761(methodReturn:Number):Bool;
	...
	static function GetSizeOfSaveData(p0:Bool):Number;
	static function N_0xa09f896ce912481f(p0:Bool):Number;
	...
	static function GetStatusOfSortedListOperation(p0:Bool):Number;
	static function N_0xf5bed327cea362b1(p0:Bool):Number;
	...
	static function GetSubmarineIsBelowFirstCrushDepth(submarine:Number):Bool;
	...
	static function GetTaskMoveNetworkEvent(ped:Number, eventName:String):Bool;
	static function N_0xb4f47213df45a64c(ped:Number, eventName:String):Bool;
	static function GetTaskMoveNetworkSignalBool(ped:Number, signalName:String):Bool;
	static function N_0xa7ffba498e4aaf67(ped:Number, signalName:String):Bool;
	...
	static function GetTennisSwingAnimComplete(ped:Number):Bool;
	static function N_0x17df68d720aa77f8(ped:Number):Bool;
	...
	static function N_0xeb3dac2c86001e5e():Bool;
	...
	static function IsNightvisionInactive():Bool;
	static function IsNightvisionActive():Bool;
	static function GetUsingseethrough():Bool;
	static function IsSeethroughActive():Bool;
	...
	static function GetVehicleCanActivateParachute(vehicle:Number):Bool;
	static function CanVehicleParachuteBeActivated(vehicle:Number):Bool;
	...
	static function GetVehicleDoorsLockedForPlayer(vehicle:Number, player:Number):Bool;
	...
	static function GetVehicleHandbrake(vehicle:Number):Bool;
	...
	static function GetVehicleHasKers(vehicle:Number):Bool;
	static function N_0x50634e348c8d44ef(vehicle:Number):Bool;
	static function HasVehicleKersBoost(vehicle:Number):Bool;
	static function GetVehicleHasParachute(vehicle:Number):Bool;
	static function HasVehicleParachute(vehicle:Number):Bool;
	static function DoesVehicleHaveParachute(vehicle:Number):Bool;
	...
	static function GetVehicleIsMercenary(vehicle:Number):Bool;
	static function N_0xd4c4642cb7f50b5d(vehicle:Number):Bool;
	...
	static function GetVehicleModColor_1Name(vehicle:Number, p1:Bool):String;
	static function N_0xb45085b721efd38c(vehicle:Number, p1:Bool):String;
	...
	static function GetVehicleModVariation(vehicle:Number, modType:Number):Bool;
	...
	static function GetVehicleNodeIsGpsAllowed(nodeID:Number):Bool;
	static function N_0xa2ae5c478b96e3b6(nodeID:Number):Bool;
	static function GetSupportsGpsRouteFlag(nodeID:Number):Bool;
	static function GetVehicleNodeIsSwitchedOff(nodeID:Number):Bool;
	static function N_0x4f5070aa58f69279(nodeID:Number):Bool;
	static function GetIsSlowRoadFlag(nodeID:Number):Bool;
	...
	static function GetVehiclePedIsIn(ped:Number, lastVehicle:Bool):Number;
	...
	static function GetVehicleTyresCanBurst(vehicle:Number):Bool;
	...
	static function GetVehicleWheelIsPowered(vehicle:Number, wheelIndex:Number):Bool;
	...
	static function GetWeaponObjectFromPed(ped:Number, p1:Bool):Number;
	...
	static function GiveAchievementToPlayer(achievement:Number):Bool;
	static function GiveDelayedWeaponToPed(ped:Number, weaponHash:Number, ammoCount:Number, bForceInHand:Bool):Void;
	...
	static function GivePedHelmet(ped:Number, cannotRemove:Bool, helmetFlag:Number, textureIndex:Number):Void;
	static function GivePedNmMessage(ped:Number):Void;
	static function GivePedToPauseMenu(ped:Number, p1:Number):Void;
	static function GivePlayerRagdollControl(player:Number, toggle:Bool):Void;
	...
	static function GiveWeaponToPed(ped:Number, weaponHash:Number, ammoCount:Number, isHidden:Bool, bForceInHand:Bool):Void;
	...
	static function N_0xa51c4b86b71652ae(toggle:Bool):Void;
	static function GolfTrailSetFacing(p0:Bool):Void;
	static function N_0x06f761ea47c1d3ed(p0:Bool):Void;
	...
	static function N_0xb1bb03742917a5d6(_type:Number, xPos:Number, yPos:Number, zPos:Number, p4:Number, red:Number, green:Number, blue:Number,
		alpha:Number):Void;
	static function GolfTrailSetPath(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Bool):Void;
	static function N_0x312342e1a4874f3f(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Bool):Void;
	...
	static function HasAchievementBeenPassed(achievement:Number):Bool;
	static function HasActionModeAssetLoaded(asset:String):Bool;
	static function HasAdditionalTextLoaded(slot:Number):Bool;
	static function HasAnimDictLoaded(animDict:String):Bool;
	static function HasAnimEventFired(entity:Number, actionHash:Number):Bool;
	static function HasAnimSetLoaded(animSet:String):Bool;
	static function HasAsyncInstallFinished():Bool;
	static function N_0x14832bf2aba53fc5():Bool;
	static function HasBulletImpactedInArea(x:Number, y:Number, z:Number, p3:Number, p4:Bool, p5:Bool):Bool;
	static function HasBulletImpactedInBox(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Bool):Bool;
	static function HasButtonCombinationJustBeenEntered(hash:Number, amount:Number):Bool;
	static function N_0x071e2a839de82d90(hash:Number, amount:Number):Bool;
	static function HasCheatStringJustBeenEntered(hash:Number):Bool;
	static function N_0x557e43c447e700a8(hash:Number):Bool;
	static function HasClipSetLoaded(clipSet:String):Bool;
	static function HasClosestObjectOfTypeBeenBroken(p0:Number, p1:Number, p2:Number, p3:Number, modelHash:Number, p5:Number):Bool;
	static function HasClosestObjectOfTypeBeenCompletelyDestroyed(x:Number, y:Number, z:Number, radius:Number, modelHash:Number, p5:Bool):Bool;
	static function N_0x46494a2475701343(x:Number, y:Number, z:Number, radius:Number, modelHash:Number, p5:Bool):Bool;
	...
	static function HasCollisionForModelLoaded(model:Number):Bool;
	static function HasCollisionLoadedAroundEntity(entity:Number):Bool;
	static function HasCutFileLoaded(cutsceneName:String):Bool;
	static function N_0xa1c996c2a744262e(cutsceneName:String):Bool;
	static function HasCutsceneCutThisFrame():Bool;
	static function N_0x708bdd8cd795b043():Bool;
	...
	static function N_0xa277800a9eae340e():Bool;
	static function HasEntityAnimFinished(entity:Number, animDict:String, animName:String, p3:Number):Bool;
	static function HasEntityBeenDamagedByAnyObject(entity:Number):Bool;
	static function HasEntityBeenDamagedByAnyPed(entity:Number):Bool;
	static function HasEntityBeenDamagedByAnyVehicle(entity:Number):Bool;
	static function HasEntityBeenDamagedByEntity(entity1:Number, entity2:Number, p2:Bool):Bool;
	static function HasEntityBeenDamagedByWeapon(entity:Number, weaponHash:Number, weaponType:Number):Bool;
	static function HasEntityClearLosToEntity(entity1:Number, entity2:Number, flags:Number):Bool;
	static function HasEntityClearLosToEntityInFront(entity1:Number, entity2:Number):Bool;
	...
	static function HasEntityCollidedWithAnything(entity:Number):Bool;
	static function HasFilledVehiclePopulation():Bool;
	static function N_0x91d6dd290888cbab():Bool;
	static function HasForceCleanupOccurred(cleanupFlags:Number):Bool;
	static function HasMinimapOverlayLoaded(id:Number):Bool;
	static function HasModelLoaded(model:Number):Bool;
	static function HasMultiplayerAudioDataLoaded():Bool;
	static function N_0x544810ed9db6bbe6():Bool;
	static function HasMultiplayerAudioDataUnloaded():Bool;
	static function N_0x5b50abb1fe3746f4():Bool;
	static function HasNamedPtfxAssetLoaded(fxName:String):Bool;
	static function HasNetworkTimeStarted():Bool;
	static function N_0x46718aceedeafc84():Bool;
	static function HasObjectBeenBroken(object:Number):Bool;
	static function HasPedBeenDamagedByWeapon(ped:Number, weaponHash:Number, weaponType:Number):Bool;
	static function HasPedGotWeapon(ped:Number, weaponHash:Number, p2:Bool):Bool;
	static function HasPedGotWeaponComponent(ped:Number, weaponHash:Number, componentHash:Number):Bool;
	static function HasPedHeadBlendFinished(ped:Number):Bool;
	static function HasPedPreloadPropDataFinished(ped:Number):Bool;
	static function N_0x784002a632822099(ped:Number):Bool;
	static function HasPedPreloadVariationDataFinished(ped:Number):Bool;
	static function N_0x66680a92700f43df(ped:Number):Bool;
	static function HasPedReceivedEvent(ped:Number, eventId:Number):Bool;
	static function HasPedheadshotImgUploadFailed():Bool;
	static function N_0x876928dddfccc9cd():Bool;
	static function HasPedheadshotImgUploadSucceeded():Bool;
	static function N_0xe8a169e666cbc541():Bool;
	static function HasPickupBeenCollected(pickup:Number):Bool;
	static function HasPlayerBeenShotByCop(player:Number, ms:Number, p2:Bool):Bool;
	static function N_0xbc0753c9ca14b506(player:Number, ms:Number, p2:Bool):Bool;
	static function HasPlayerBeenSpottedInStolenVehicle(player:Number):Bool;
	static function HasPlayerDamagedAtLeastOneNonAnimalPed(player:Number):Bool;
	static function HasPlayerDamagedAtLeastOnePed(player:Number):Bool;
	static function HasPlayerLeftTheWorld(player:Number):Bool;
	static function HasPreloadModsFinished(p0:Number):Bool;
	static function HasPtfxAssetLoaded():Bool;
	static function HasResumedFromSuspend():Bool;
	static function N_0xe8b9c0ec9e183f35():Bool;
	static function HasScaleformContainerMovieLoadedIntoParent(scaleformHandle:Number):Bool;
	static function HasScaleformMovieFilenameLoaded(scaleformName:String):Bool;
	static function N_0x0c1c5d756fb5f337(scaleformName:String):Bool;
	static function HasNamedScaleformMovieLoaded(scaleformName:String):Bool;
	static function HasScaleformMovieLoaded(scaleformHandle:Number):Bool;
	static function HasScaleformScriptHudMovieLoaded(hudComponent:Number):Bool;
	static function HasHudScaleformLoaded(hudComponent:Number):Bool;
	static function HasScriptLoaded(scriptName:String):Bool;
	static function HasScriptWithNameHashLoaded(scriptHash:Number):Bool;
	static function HasStreamedScriptLoaded(scriptHash:Number):Bool;
	static function HasSoundFinished(soundId:Number):Bool;
	...
	static function HasThisAdditionalTextLoaded(gxt:String, slot:Number):Bool;
	static function HasThisCutsceneLoaded(cutsceneName:String):Bool;
	static function HasVehicleAssetLoaded(vehicleAsset:Number):Bool;
	static function HasVehicleGotProjectileAttached(driver:Number, vehicle:Number, weaponHash:Number, p3:Number):Bool;
	static function HasVehiclePhoneExplosiveDevice():Bool;
	static function N_0x6adaabd3068c5235():Bool;
	static function HasVehicleRecordingBeenLoaded(recording:Number, script:String):Bool;
	static function HasWeaponAssetLoaded(weaponHash:Number):Bool;
	static function HasWeaponGotWeaponComponent(weapon:Number, addonHash:Number):Bool;
	static function HaveAllStreamingRequestsCompleted(ped:Number):Bool;
	static function N_0x7350823473013c02(ped:Number):Bool;
	static function HasStreamedPedAssetsLoaded(ped:Number):Bool;
	static function HaveCreditsReachedEnd():Bool;
	static function N_0x075f1d57402c93ba():Bool;
	static function HaveVehicleModsStreamedIn(vehicle:Number):Bool;
	static function N_0x9a83f5f9963775ef(vehicle:Number):Bool;
	static function IsVehicleModLoadDone(vehicle:Number):Bool;
	...
	static function HidePedBloodDamageByZone(ped:Number, p1:Number, p2:Bool):Void;
	static function N_0x62ab793144de75dc(ped:Number, p1:Number, p2:Bool):Void;
	static function HidePedWeaponForScriptedCutscene(ped:Number, toggle:Bool):Void;
	static function HidePortablePickupWhenDetached(pickup:Number, toggle:Bool):Void;
	static function N_0x867458251d47ccb2(pickup:Number, toggle:Bool):Void;
	static function HidePickup(pickup:Number, toggle:Bool):Void;
	static function HideScriptedHudComponentThisFrame(id:Number):Void;
	static function HideVehicleTombstone(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0xeb354e5376bc81a7(show:Bool):Void;
	static function ShowWeaponWheel(show:Bool):Void;
	...
	static function N_0x14c9fdcc41f81f63(toggle:Bool):Void;
	...
	static function InvokeFunctionReference(referenceIdentity:String, argsSerialized:String, argsLength:Number,
		retvalLength:Number):InvokeFunctionReferenceReturnType;
	...
	static function N_0x74bd83ea840f6bc9():Bool;
	static function IsAlarmPlaying(alarmName:String):Bool;
	static function IsAmbientSpeechDisabled(ped:Number):Bool;
	static function IsAmbientSpeechPlaying(ped:Number):Bool;
	static function IsAmbientZoneEnabled(ambientZone:String):Bool;
	static function IsAnEntity(handle:Number):Bool;
	static function IsAnimalVocalizationPlaying(pedHandle:Number):Bool;
	static function N_0xc265df9fb44a9fbd(pedHandle:Number):Bool;
	...
	static function IsAnyEntityAttachedToHandlerFrame(vehicle:Number):Bool;
	static function N_0x62ca17b74c435651(vehicle:Number):Bool;
	static function IsAnyEntityEntirelyInsideGarage(garageHash:Number, p1:Bool, p2:Bool, p3:Bool, p4:Number):Bool;
	static function N_0x673ed815d6e323b7(garageHash:Number, p1:Bool, p2:Bool, p3:Bool, p4:Number):Bool;
	static function IsAnyHostilePedNearPoint(ped:Number, x:Number, y:Number, z:Number, radius:Number):Bool;
	static function N_0x68772db2b2526f9f(ped:Number, x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsAnyObjectNearPoint(x:Number, y:Number, z:Number, range:Number, p4:Bool):Bool;
	static function IsAnyPedNearPoint(x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsAnyPedRappellingFromHeli(vehicle:Number):Bool;
	static function N_0x291e373d483e7ee7(vehicle:Number):Bool;
	static function AnyPassengersRappeling(vehicle:Number):Bool;
	static function IsAnyPassengerRappelingFromVehicle(vehicle:Number):Bool;
	static function IsAnyPedShootingInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p6:Bool, p7:Bool):Bool;
	static function IsAnySpeechPlaying(ped:Number):Bool;
	static function IsAnyVehicleNearPoint(x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsAreaOccupied(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Bool, p8:Bool, p9:Bool, p10:Bool, p11:Number,
		p12:Bool):Bool;
	...
	static function IsBigVehicle(vehicle:Number):Bool;
	static function IsBigmapActive():Bool;
	static function IsBigmapFull():Bool;
	static function IsBitSet(address:Number, offset:Number):Bool;
	static function IsBlipFlashing(blip:Number):Bool;
	static function IsBlipOnMinimap(blip:Number):Bool;
	static function IsBlipShortRange(blip:Number):Bool;
	static function IsBoatAnchoredAndFrozen(vehicle:Number):Bool;
	static function N_0xb0ad1238a709b1a2(vehicle:Number):Bool;
	static function IsBonnetCinematicCamRendering():Bool;
	static function N_0xd7360051c885628b():Bool;
	static function IsBulletInAngledArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number, ownedByPlayer:Bool):Bool;
	static function IsBulletInArea(x:Number, y:Number, z:Number, radius:Number, ownedByPlayer:Bool):Bool;
	static function IsBulletInBox(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, ownedByPlayer:Bool):Bool;
	static function IsCamActive(cam:Number):Bool;
	static function IsCamInterpolating(cam:Number):Bool;
	static function IsCamPlayingAnim(cam:Number, animName:String, animDictionary:String):Bool;
	static function IsCamRendering(cam:Number):Bool;
	static function IsCamShaking(cam:Number):Bool;
	static function IsCamSplinePaused(p0:Number):Bool;
	static function IsCinematicCamInputActive():Bool;
	static function N_0xf5f1e89a970b7796():Bool;
	static function IsCinematicCamActive():Bool;
	...
	static function N_0xca9d2aa3e326d720():Bool;
	static function IsCinematicShotActive(p0:Number):Bool;
	static function IsCollisionMarkedOutside(x:Number, y:Number, z:Number):Bool;
	static function N_0xeea5ac2eda7c33e8(x:Number, y:Number, z:Number):Bool;
	static function AreCoordsCollidingWithExterior(x:Number, y:Number, z:Number):Bool;
	static function IsCommandLineBenchmarkValueSet():Bool;
	static function N_0xa049a5be0f04f2f8():Bool;
	static function IsCommerceDataValid():Bool;
	static function N_0xea14eef5b7cd2c30():Bool;
	static function IsCommerceStoreOpen():Bool;
	static function N_0x2eac52b4019e2782():Bool;
	static function IsContentItemLocked(itemHash:Number):Bool;
	static function IsOutfitEmpty(itemHash:Number):Bool;
	static function IsDlcDataEmpty(itemHash:Number):Bool;
	static function IsControlEnabled(padIndex:Number, control:Number):Bool;
	static function IsControlJustPressed(padIndex:Number, control:Number):Bool;
	static function IsControlJustReleased(padIndex:Number, control:Number):Bool;
	static function IsControlPressed(padIndex:Number, control:Number):Bool;
	static function IsControlReleased(padIndex:Number, control:Number):Bool;
	static function IsConversationPedDead(ped:Number):Bool;
	static function IsCopPedInArea_3d(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function IsCopVehicleInArea_3d(x1:Number, x2:Number, y1:Number, y2:Number, z1:Number, z2:Number):Bool;
	static function IsCutsceneActive():Bool;
	static function IsCutscenePlaybackFlagSet(flag:Number):Bool;
	static function N_0x71b74d2ae19338d0(flag:Number):Bool;
	static function IsCutscenePlaying():Bool;
	static function IsDamageTrackerActiveOnNetworkId(netID:Number):Bool;
	static function IsDamageTrackerActiveOnPlayer(player:Number):Bool;
	static function N_0xb2092a1eaa7fd45f(player:Number):Bool;
	static function IsDecalAlive(decal:Number):Bool;
	static function IsDisabledControlJustPressed(padIndex:Number, control:Number):Bool;
	static function IsDisabledControlJustReleased(padIndex:Number, control:Number):Bool;
	static function IsDisabledControlPressed(padIndex:Number, control:Number):Bool;
	static function IsDisabledControlReleased(padIndex:Number, control:Number):Bool;
	static function N_0xfb6c4072e9a32e92(padIndex:Number, control:Number):Bool;
	static function IsDlcPresent(dlcHash:Number):Bool;
	static function IsDlcVehicleMod(hash:Number):Bool;
	static function N_0x0564b9ff9631b82c(hash:Number):Bool;
	static function IsDoorClosed(doorHash:Number):Bool;
	static function IsDoorRegisteredWithSystem(doorHash:Number):Bool;
	static function N_0xc153c43ea202c8c1(doorHash:Number):Bool;
	static function DoesDoorExist(doorHash:Number):Bool;
	static function IsDrivebyTaskUnderneathDrivingTask(ped:Number):Bool;
	static function IsDuiAvailable(duiObject:Number):Bool;
	static function IsDuplicityVersion():Bool;
	static function IsDurangoVersion():Bool;
	static function IsEntityAMissionEntity(entity:Number):Bool;
	static function IsEntityAPed(entity:Number):Bool;
	static function IsEntityAVehicle(entity:Number):Bool;
	static function IsEntityAnObject(entity:Number):Bool;
	static function IsEntityAtCoord(entity:Number, xPos:Number, yPos:Number, zPos:Number, xSize:Number, ySize:Number, zSize:Number, p7:Bool, p8:Bool,
		p9:Number):Bool;
	static function IsEntityAtEntity(entity1:Number, entity2:Number, xSize:Number, ySize:Number, zSize:Number, p5:Bool, p6:Bool, p7:Number):Bool;
	static function IsEntityAttached(entity:Number):Bool;
	static function IsEntityAttachedToAnyObject(entity:Number):Bool;
	static function IsEntityAttachedToAnyPed(entity:Number):Bool;
	static function IsEntityAttachedToAnyVehicle(entity:Number):Bool;
	static function IsEntityAttachedToEntity(_from:Number, to:Number):Bool;
	static function IsEntityAttachedToHandlerFrame(vehicle:Number, entity:Number):Bool;
	static function SetPedEnabledBikeRingtone(vehicle:Number, entity:Number):Bool;
	static function IsVehicleNearEntity(vehicle:Number, entity:Number):Bool;
	static function IsEntityDead(entity:Number):Bool;
	static function IsEntityFocus(entity:Number):Bool;
	static function IsEntityGhostedToLocalPlayer(entity:Number):Bool;
	static function N_0x21d04d7bc538c146(entity:Number):Bool;
	static function IsEntityAGhost(entity:Number):Bool;
	static function IsEntityInAir(entity:Number):Bool;
	static function IsEntityInAngledArea(entity:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number, debug:Bool,
		includez:Bool, p10:Number):Bool;
	static function IsEntityInArea(entity:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p7:Bool, p8:Bool, p9:Number):Bool;
	static function IsEntityInWater(entity:Number):Bool;
	static function IsEntityInZone(entity:Number, zone:String):Bool;
	static function IsEntityOccluded(entity:Number):Bool;
	static function IsEntityOnFire(entity:Number):Bool;
	static function IsEntityOnScreen(entity:Number):Bool;
	static function IsEntityPlayingAnim(entity:Number, animDict:String, animName:String, taskFlag:Number):Bool;
	static function IsEntityPositionFrozen(entity:Number):Bool;
	static function IsEntityStatic(entity:Number):Bool;
	static function IsEntityTouchingEntity(entity:Number, targetEntity:Number):Bool;
	static function IsEntityTouchingModel(entity:Number, modelHash:Number):Bool;
	static function IsEntityUpright(entity:Number, angle:Number):Bool;
	static function IsEntityUpsidedown(entity:Number):Bool;
	static function IsEntityVisible(entity:Number):Bool;
	static function IsEntityVisibleToScript(entity:Number):Bool;
	static function IsEntityWaitingForWorldCollision(entity:Number):Bool;
	static function IsExplosionActiveInArea(explosionType:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function N_0x6070104b699b2ef4(explosionType:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function IsExplosionInAngledArea(explosionType:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number):Bool;
	static function IsExplosionInArea(explosionType:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function IsExplosionInSphere(explosionType:Number, x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsFirstPersonAimCamActive():Bool;
	static function IsFlashLightOn(ped:Number):Bool;
	static function SetWeaponSmokegrenadeAssigned(ped:Number):Bool;
	static function IsFloatingHelpTextOnScreen(hudIndex:Number):Bool;
	static function N_0x2432784aca090da4(hudIndex:Number):Bool;
	...
	static function N_0x3bab9a4e4f2ff5c7():Bool;
	...
	static function IsGarageEmpty(garageHash:Number, p1:Bool, p2:Number):Bool;
	static function IsHandlerFrameAboveContainer(handler:Number, container:Number):Bool;
	static function N_0x89d630cf5ea96d23(handler:Number, container:Number):Bool;
	static function IsHeliLandingAreaBlocked(vehicle:Number):Bool;
	static function N_0x634148744f385576(vehicle:Number):Bool;
	static function IsHeliPartBroken(vehicle:Number, p1:Bool, p2:Bool, p3:Bool):Bool;
	...
	static function IsHornActive(vehicle:Number):Bool;
	static function IsHoveringOverMissionCreatorBlip():Bool;
	static function N_0x4167efe0527d706e():Bool;
	static function IsHudComponentActive(id:Number):Bool;
	static function IsHudHidden():Bool;
	static function IsHudPreferenceSwitchedOn():Bool;
	static function IsInItemset(p0:Number, p1:Number):Bool;
	static function IsInPowerSavingMode():Bool;
	static function N_0x684a41975f077262():Bool;
	static function IsInVehicleCamDisabled():Bool;
	static function N_0x4f32c0d5a90a9b40():Bool;
	static function IsIncidentValid(incidentId:Number):Bool;
	static function IsInteriorCapped(interiorID:Number):Bool;
	static function IsInteriorDisabled(interior:Number):Bool;
	static function IsInteriorEntitySetActive(interior:Number, entitySetName:String):Bool;
	static function N_0x35f7dd45e8c0a16d(interior:Number, entitySetName:String):Bool;
	static function IsInteriorPropEnabled(interior:Number, entitySetName:String):Bool;
	static function IsInteriorReady(interiorID:Number):Bool;
	...
	static function IsItemsetValid(p0:Number):Bool;
	...
	static function N_0x9049fe339d5f6f6f():Bool;
	static function IsMinimapRendering():Bool;
	static function N_0xaf754f20eb5cd51a():Bool;
	static function IsRadarEnabled():Bool;
	static function IsMissionCompletePlaying():Bool;
	static function IsMissionCompleteReadyForUi():Bool;
	static function N_0x6f259f82d873b8b8():Bool;
	static function IsMissionCreatorBlip(blip:Number):Bool;
	static function IsMissionNewsStoryUnlocked(newsStory:Number):Bool;
	static function GetNumberOfPassengerVoiceVariations(newsStory:Number):Bool;
	static function IsMissionTrain(vehicle:Number):Bool;
	static function IsMobilePhoneCallOngoing():Bool;
	static function IsMobilePhoneRadioActive():Bool;
	static function IsModelAPed(model:Number):Bool;
	static function IsModelAVehicle(model:Number):Bool;
	static function IsModelInCdimage(model:Number):Bool;
	static function IsModelValid(model:Number):Bool;
	static function IsMountedWeaponTaskUnderneathDrivingTask(ped:Number):Bool;
	static function IsMouseCursorAboveInstructionalButtons():Bool;
	static function N_0x3d9acb1eb139e702():Bool;
	static function IsMoveBlendRatioRunning(ped:Number):Bool;
	static function IsMoveBlendRatioSprinting(ped:Number):Bool;
	static function IsMoveBlendRatioStill(ped:Number):Bool;
	static function IsMoveBlendRatioWalking(ped:Number):Bool;
	static function IsMpGamerTagActive(gamerTagId:Number):Bool;
	static function N_0x4e929e7a5796fd26(gamerTagId:Number):Bool;
	static function IsMpGamerTagFree(gamerTagId:Number):Bool;
	static function AddTrevorRandomModifier(gamerTagId:Number):Bool;
	static function IsMpGamerTagMovieActive():Bool;
	static function N_0x6e0eb3eb47c8d7aa():Bool;
	static function HasMpGamerTag():Bool;
	static function IsMultiplayerChatActive():Bool;
	static function IsTextChatActive():Bool;
	static function IsMusicOneshotPlaying():Bool;
	static function N_0xa097ab275061fb21():Bool;
	static function IsNamedRendertargetLinked(modelHash:Number):Bool;
	...
	static function IsNavmeshLoadedInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function IsNavmeshRequiredRegionOwnedByAnyThread():Bool;
	static function N_0x705a844002b39dc0():Bool;
	static function IsNetworkIdOwnedByParticipant(netId:Number):Bool;
	static function N_0xa1607996431332df(netId:Number):Bool;
	static function NetworkCanNetworkIdBeSeen(netId:Number):Bool;
	...
	static function IsObjectAPickup(object:Number):Bool;
	static function N_0xfc481c641ebbd27d(object:Number):Bool;
	static function IsObjectAPortablePickup(object:Number):Bool;
	static function N_0x0378c08504160d0d(object:Number):Bool;
	static function IsObjectEntirelyInsideGarage(garageHash:Number, entity:Number, p2:Number, p3:Number):Bool;
	static function N_0x372ef6699146a1e4(garageHash:Number, entity:Number, p2:Number, p3:Number):Bool;
	static function IsObjectNearPoint(objectHash:Number, x:Number, y:Number, z:Number, range:Number):Bool;
	static function IsObjectPartiallyInsideGarage(garageHash:Number, entity:Number, p2:Number):Bool;
	static function N_0xf0eed5a6bc7b237a(garageHash:Number, entity:Number, p2:Number):Bool;
	static function IsObjectVisible(object:Number):Bool;
	static function IsObjectWithinBrainActivationRange(object:Number):Bool;
	static function IsOnlinePoliciesMenuActive():Bool;
	static function N_0x6f72cd94f7b5b68c():Bool;
	...
	static function IsPedAPlayer(ped:Number):Bool;
	static function IsPedActiveInScenario(ped:Number):Bool;
	static function IsPedAimingFromCover(ped:Number):Bool;
	static function IsPedArmed(ped:Number, typeFlags:Number):Bool;
	static function IsPedBeingArrested(ped:Number):Bool;
	static function IsPedBeingJacked(ped:Number):Bool;
	static function IsPedBeingStealthKilled(ped:Number):Bool;
	static function IsPedBeingStunned(ped:Number, p1:Number):Bool;
	static function IsPedBlushColorValid(colorID:Number):Bool;
	static function N_0x604e810189ee3a59(colorID:Number):Bool;
	static function IsPedBlushColorValid_2(colorId:Number):Bool;
	static function N_0xf41b5d290c99a3d6(colorId:Number):Bool;
	static function IsPedBodyBlemishValid(colorID:Number):Bool;
	static function N_0x09e7eca981d9b210(colorID:Number):Bool;
	static function IsPedClimbing(ped:Number):Bool;
	static function IsPedComponentVariationGen9Exclusive(ped:Number, componentId:Number, drawableId:Number):Bool;
	static function IsPedComponentVariationValid(ped:Number, componentId:Number, drawableId:Number, textureId:Number):Bool;
	static function IsPedCuffed(ped:Number):Bool;
	static function IsPedCurrentWeaponSilenced(ped:Number):Bool;
	static function IsPedDeadOrDying(ped:Number, p1:Bool):Bool;
	static function IsPedDefensiveAreaActive(ped:Number, p1:Bool):Bool;
	static function N_0xba63d9fe45412247(ped:Number, p1:Bool):Bool;
	static function IsPedDiving(ped:Number):Bool;
	static function IsPedDoingBeastJump(ped:Number):Bool;
	static function N_0x451d05012ccec234(ped:Number):Bool;
	static function IsPedDoingDriveby(ped:Number):Bool;
	static function IsPedDucking(ped:Number):Bool;
	...
	static function IsPedFacingPed(ped:Number, otherPed:Number, angle:Number):Bool;
	static function IsPedFalling(ped:Number):Bool;
	static function IsPedFatallyInjured(ped:Number):Bool;
	static function IsPedFleeing(ped:Number):Bool;
	static function IsPedGettingIntoAVehicle(ped:Number):Bool;
	static function IsPedGettingUp(ped:Number):Bool;
	static function IsPedGoingIntoCover(ped:Number):Bool;
	static function IsPedGroupMember(ped:Number, groupId:Number):Bool;
	static function IsPedHairColorValid(colorID:Number):Bool;
	static function N_0xe0d36e5d9e99cc21(colorID:Number):Bool;
	static function IsPedHairColorValid_2(colorId:Number):Bool;
	static function N_0xed6d8e27a43b8cde(colorId:Number):Bool;
	static function IsPedHangingOnToVehicle(ped:Number):Bool;
	static function IsPedHeadingTowardsPosition(ped:Number, x:Number, y:Number, z:Number, p4:Number):Bool;
	static function N_0xfcf37a457cb96dc0(ped:Number, x:Number, y:Number, z:Number, p4:Number):Bool;
	static function IsPedHeadtrackingEntity(ped:Number, entity:Number):Bool;
	static function IsPedHeadtrackingPed(ped1:Number, ped2:Number):Bool;
	static function IsPedHelmetUnk(ped:Number):Bool;
	static function N_0xb9496ce47546db2c(ped:Number):Bool;
	static function IsPedHuman(ped:Number):Bool;
	static function IsPedHurt(ped:Number):Bool;
	static function IsPedInAnyBoat(ped:Number):Bool;
	static function IsPedInAnyHeli(ped:Number):Bool;
	static function IsPedInAnyPlane(ped:Number):Bool;
	static function IsPedInAnyPoliceVehicle(ped:Number):Bool;
	static function IsPedInAnySub(ped:Number):Bool;
	static function IsPedInAnyTaxi(ped:Number):Bool;
	static function IsPedInAnyTrain(ped:Number):Bool;
	static function IsPedInAnyVehicle(ped:Number, atGetIn:Bool):Bool;
	static function IsPedInCombat(ped:Number, target:Number):Bool;
	static function IsPedInCover(ped:Number, exceptUseWeapon:Bool):Bool;
	static function IsPedInCoverFacingLeft(ped:Number):Bool;
	static function IsPedInCurrentConversation(ped:Number):Bool;
	static function IsPedInFlyingVehicle(ped:Number):Bool;
	static function IsPedInGroup(ped:Number):Bool;
	static function IsPedInHighCover(ped:Number):Bool;
	static function N_0x6a03bf943d767c93(ped:Number):Bool;
	static function IsPedStandingInCover(ped:Number):Bool;
	static function IsPedInMeleeCombat(ped:Number):Bool;
	static function IsPedInModel(ped:Number, modelHash:Number):Bool;
	static function IsPedInParachuteFreeFall(ped:Number):Bool;
	static function IsPedInVehicle(ped:Number, vehicle:Number, atGetIn:Bool):Bool;
	static function IsPedInWrithe(ped:Number):Bool;
	static function IsPedInjured(ped:Number):Bool;
	static function IsPedJacking(ped:Number):Bool;
	static function IsPedJumping(ped:Number):Bool;
	static function IsPedJumpingOutOfVehicle(ped:Number):Bool;
	static function IsPedLipstickColorValid(colorID:Number):Bool;
	static function N_0x0525a2c2562f3cd4(colorID:Number):Bool;
	static function IsPedLipstickColorValid_2(colorId:Number):Bool;
	static function N_0x3e802f11fbe27674(colorId:Number):Bool;
	static function IsPedMale(ped:Number):Bool;
	static function IsPedModel(ped:Number, modelHash:Number):Bool;
	static function IsPedOnAnyBike(ped:Number):Bool;
	static function IsPedOnFoot(ped:Number):Bool;
	static function IsPedOnMount(ped:Number):Bool;
	static function IsPedOnSpecificVehicle(ped:Number, vehicle:Number):Bool;
	static function IsPedOnVehicle(ped:Number):Bool;
	static function IsPedOpeningADoor(ped:Number):Bool;
	static function N_0x26af0e8e30bd2a2c(ped:Number):Bool;
	static function IsPedPerformingDependentComboLimit(ped:Number):Bool;
	static function N_0xebd0edba5be957cf(ped:Number):Bool;
	static function IsPedPerformingMeleeAction(ped:Number):Bool;
	static function N_0xdcca191df9980fd7(ped:Number):Bool;
	static function IsPedPerformingStealthKill(ped:Number):Bool;
	static function IsPedPlantingBomb(ped:Number):Bool;
	static function IsPedPlayingBaseClipInScenario(ped:Number):Bool;
	static function N_0x621c6e4729388e41(ped:Number):Bool;
	static function IsPedProne(ped:Number):Bool;
	static function IsPedRagdoll(ped:Number):Bool;
	static function IsPedReloading(ped:Number):Bool;
	static function IsPedRespondingToEvent(ped:Number, event:Number):Bool;
	static function IsPedRingtonePlaying(ped:Number):Bool;
	static function IsPedRunning(ped:Number):Bool;
	static function IsPedRunningArrestTask(ped:Number):Bool;
	static function IsPedRunningMeleeTask(ped:Number):Bool;
	static function N_0xd1871251f3b5acd7(ped:Number):Bool;
	static function IsPedRunningMobilePhoneTask(ped:Number):Bool;
	static function IsPedRunningRagdollTask(ped:Number):Bool;
	static function IsPedShaderEffectValid(ped:Number):Bool;
	static function N_0x81aa517fbba05d39(ped:Number):Bool;
	static function IsPedShooting(ped:Number):Bool;
	static function IsPedShootingInArea(ped:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p7:Bool, p8:Bool):Bool;
	static function IsPedSittingInAnyVehicle(ped:Number):Bool;
	static function IsPedSittingInVehicle(ped:Number, vehicle:Number):Bool;
	static function IsPedSprinting(ped:Number):Bool;
	static function IsPedStill(ped:Number):Bool;
	static function IsPedStopped(ped:Number):Bool;
	static function IsPedStrafing(ped:Number):Bool;
	static function IsPedSwappingWeapon(Ped:Number):Bool;
	static function N_0x3795688a307e1eb6(Ped:Number):Bool;
	static function IsPedSwimming(ped:Number):Bool;
	static function IsPedSwimmingUnderWater(ped:Number):Bool;
	static function IsPedTakingOffHelmet(ped:Number):Bool;
	static function N_0x14590ddbedb1ec85(ped:Number):Bool;
	static function IsPedTracked(ped:Number):Bool;
	static function IsPedTryingToEnterALockedVehicle(ped:Number):Bool;
	static function IsPedUsingActionMode(ped:Number):Bool;
	static function IsPedUsingAnyScenario(ped:Number):Bool;
	static function IsPedUsingScenario(ped:Number, scenario:String):Bool;
	static function IsPedVaulting(ped:Number):Bool;
	static function IsPedWalking(ped:Number):Bool;
	static function IsPedWeaponComponentActive(ped:Number, weaponHash:Number, componentHash:Number):Bool;
	static function IsPedWeaponReadyToShoot(ped:Number):Bool;
	static function IsPedWearingHelmet(ped:Number):Bool;
	static function IsPedheadshotImgUploadAvailable():Bool;
	static function N_0xebb376779a760aa8():Bool;
	static function IsPedheadshotReady(id:Number):Bool;
	static function IsPedheadshotValid(id:Number):Bool;
	static function IsPickupWeaponObjectValid(object:Number):Bool;
	static function N_0x11d1e53a726891fe(object:Number):Bool;
	static function IsPlaneLandingGearIntact(plane:Number):Bool;
	static function N_0x4198ab0022b15f87(plane:Number):Bool;
	static function VehicleHasLandingGear(plane:Number):Bool;
	static function IsPlaybackGoingOnForVehicle(vehicle:Number):Bool;
	static function IsPlaybackUsingAiGoingOnForVehicle(vehicle:Number):Bool;
	static function IsPlayerBattleAware(player:Number):Bool;
	static function N_0x38d28da81e4e9bf9(player:Number):Bool;
	static function IsPlayerBeingArrested(player:Number, atArresting:Bool):Bool;
	static function IsPlayerBluetoothEnable(player:Number):Bool;
	static function N_0x65faee425de637b0(player:Number):Bool;
	static function IsPlayerCamControlDisabled():Bool;
	static function N_0x7c814d2fb49f40c0():Bool;
	static function IsPlayerClimbing(player:Number):Bool;
	static function IsPlayerControlOn(player:Number):Bool;
	static function IsPlayerDead(player:Number):Bool;
	static function IsPlayerDrivingDangerously(player:Number, _type:Number):Bool;
	static function N_0xf10b44fd479d69f3(player:Number, _type:Number):Bool;
	static function IsPlayerEntirelyInsideGarage(garageHash:Number, player:Number, p2:Number, p3:Number):Bool;
	static function N_0x024a60deb0ea69f0(garageHash:Number, player:Number, p2:Number, p3:Number):Bool;
	static function IsPlayerFreeAiming(player:Number):Bool;
	static function IsPlayerFreeAimingAtEntity(player:Number, entity:Number):Bool;
	static function IsPlayerFreeForAmbientTask(player:Number):Bool;
	static function IsPlayerInCutscene(player:Number):Bool;
	static function IsPlayerLoggingInNp():Bool;
	static function IsPlayerOnline():Bool;
	static function IsPlayerPartiallyInsideGarage(garageHash:Number, player:Number, p2:Number):Bool;
	static function N_0x1761dc5d8471cbaa(garageHash:Number, player:Number, p2:Number):Bool;
	static function IsPlayerPlaying(player:Number):Bool;
	static function IsPlayerPressingHorn(player:Number):Bool;
	static function IsPlayerReadyForCutscene(player:Number):Bool;
	static function IsPlayerRidingTrain(player:Number):Bool;
	static function IsPlayerScriptControlOn(player:Number):Bool;
	static function IsPlayerSwitchInProgress():Bool;
	static function N_0xd9d2cfff49fab35f():Bool;
	static function IsPlayerTargettingAnything(player:Number):Bool;
	static function IsPlayerTargettingEntity(player:Number, entity:Number):Bool;
	static function IsPlayerTeleportActive():Bool;
	static function IsPlayerVehRadioEnable():Bool;
	static function N_0x5f43d83fd6738741():Bool;
	static function IsPlayerVehicleRadioEnabled():Bool;
	static function IsPlayerWantedLevelGreater(player:Number, wantedLevel:Number):Bool;
	static function IsPlayingPhoneGestureAnim(ped:Number):Bool;
	static function IsPlaylistUnk(tvChannel:Number, p1:Number):Bool;
	static function IsPointInAngledArea(xPos:Number, yPos:Number, zPos:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number,
		p10:Bool, includez:Bool):Bool;
	static function IsPointObscuredByAMissionEntity(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number):Bool;
	static function IsPointOnRoad(x:Number, y:Number, z:Number, vehicle:Number):Bool;
	static function IsPopMultiplierAreaUnk(id:Number):Bool;
	static function IsPositionOccupied(x:Number, y:Number, z:Number, range:Number, p4:Bool, checkVehicles:Bool, checkPeds:Bool, p7:Bool, p8:Bool,
		ignoreEntity:Number, p10:Bool):Bool;
	...
	static function IsProjectileInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, ownedByPlayer:Bool):Bool;
	...
	static function IsProjectileTypeInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, _type:Number, ownedByPlayer:Bool):Bool;
	static function IsProjectileTypeWithinDistance(x:Number, y:Number, z:Number, projHash:Number, radius:Number, ownedByPlayer:Bool):Bool;
	static function N_0x34318593248c8fb2(x:Number, y:Number, z:Number, projHash:Number, radius:Number, ownedByPlayer:Bool):Bool;
	static function IsProjectileTypeInRadius(x:Number, y:Number, z:Number, projHash:Number, radius:Number, ownedByPlayer:Bool):Bool;
	...
	static function N_0x0626a247d2405330():Bool;
	...
	static function N_0x9135584d09a3437e():Bool;
	static function IsRockstarMessageReadyForScript():Bool;
	static function N_0xbc1cc91205ec8d6e():Bool;
	static function IsScaleformMovieMethodReturnValueReady(method_return:Number):Bool;
	static function N_0x768ff8961ba904d6(method_return:Number):Bool;
	static function GetScaleformMovieFunctionReturnBool(method_return:Number):Bool;
	static function IsScenarioGroupEnabled(scenarioGroup:String):Bool;
	static function IsScenarioOccupied(p0:Number, p1:Number, p2:Number, p3:Number, p4:Bool):Bool;
	...
	static function N_0x7b226c785a52a0a9():Bool;
	static function IsScriptGlobalShaking():Bool;
	static function N_0xc912af078af19212():Bool;
	static function IsScriptedConversationLoaded():Bool;
	static function IsScriptedConversationOngoing():Bool;
	static function IsScriptedHudComponentActive(id:Number):Bool;
	static function IsScriptedHudComponentHiddenThisFrame(id:Number):Bool;
	static function N_0x09c0403ed9a751c2(id:Number):Bool;
	static function IsScriptedScenarioPedUsingConditionalAnim(ped:Number, animDict:String, anim:String):Bool;
	static function IsScriptedSpeechPlaying(p0:Number):Bool;
	static function IsScubaGearLightEnabled(ped:Number):Bool;
	static function IsSeatWarpOnly(vehicle:Number, seatIndex:Number):Bool;
	static function N_0xf7f203e31f96f6a1(vehicle:Number, seatIndex:Number):Bool;
	static function IsShockingEventInSphere(eventType:Number, x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsSniperBulletInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):Bool;
	static function IsSniperInverted():Bool;
	static function IsSocialClubActive():Bool;
	static function N_0xc406be343fc4b9af():Bool;
	static function IsSpecialAbilityActive(player:Number):Bool;
	static function IsSpecialAbilityEnabled(player:Number):Bool;
	static function IsSpecialAbilityMeterFull(player:Number):Bool;
	static function IsSpecialAbilityUnlocked(playerModel:Number):Bool;
	static function IsSphereVisible(x:Number, y:Number, z:Number, radius:Number):Bool;
	static function IsSphereVisibleToAnotherMachine(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	static function IsSphereVisibleToPlayer(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number):Bool;
	static function IsSrlLoaded():Bool;
	static function IsStoreAvailableToUser():Bool;
	static function N_0x883d79c4071e18b3():Bool;
	static function IsStreamPlaying():Bool;
	static function IsStreamingAdditionalText(p0:Number):Bool;
	static function IsStreamingFileReady(registerAs:String):Bool;
	static function IsStreamvolActive():Bool;
	static function N_0xbc9823ab80a3dcac():Bool;
	static function IsStringNull(_string:String):Bool;
	static function IsStringNullOrEmpty(_string:String):Bool;
	static function IsStuntJumpInProgress():Bool;
	static function IsStuntJumpMessageShowing():Bool;
	static function N_0x2272b0a1343129f4():Bool;
	static function IsSubtitlePreferenceSwitchedOn():Bool;
	static function IsSwitchReadyForDescent():Bool;
	static function N_0xdfa80cb25d0a19b3():Bool;
	static function IsSwitchSkippingDescent():Bool;
	static function DestroyPlayerInPauseMenu():Bool;
	static function IsSynchronizedSceneHoldLastFrame(sceneID:Number):Bool;
	static function N_0x7f2f4f13ac5257ef(sceneID:Number):Bool;
	static function IsSynchronizedSceneLooped(sceneID:Number):Bool;
	static function IsSynchronizedSceneRunning(sceneId:Number):Bool;
	static function IsSystemUiBeingDisplayed():Bool;
	static function IsTaskMoveNetworkActive(ped:Number):Bool;
	static function N_0x921ce12c489c4c41(ped:Number):Bool;
	static function IsTaskMoveNetworkReadyForTransition(ped:Number):Bool;
	static function N_0x30ed88d5e0c56a37(ped:Number):Bool;
	static function IsTaxiLightOn(vehicle:Number):Bool;
	static function IsTennisMode(ped:Number):Bool;
	static function IsThisAMinigameScript():Bool;
	static function IsThisModelABicycle(model:Number):Bool;
	static function IsThisModelABike(model:Number):Bool;
	static function IsThisModelABoat(model:Number):Bool;
	static function IsThisModelACar(model:Number):Bool;
	static function IsThisModelAHeli(model:Number):Bool;
	static function IsThisModelAJetski(model:Number):Bool;
	static function IsThisModelASubmersible(model:Number):Bool;
	static function IsThisModelAnEmergencyBoat(model:Number):Bool;
	static function IsThisModelAPlane(model:Number):Bool;
	static function IsThisModelAQuadbike(model:Number):Bool;
	static function IsThisModelATrain(model:Number):Bool;
	static function IsThisModelAnAmphibiousCar(model:Number):Bool;
	static function IsThisModelAnAmphibiousQuadbike(model:Number):Bool;
	static function N_0xa1a9fc1c76a6730d(model:Number):Bool;
	static function IsThreadActive(threadId:Number):Bool;
	static function IsTimeEqualTo(timeA:Number, timeB:Number):Bool;
	static function AreIntegersEqual(timeA:Number, timeB:Number):Bool;
	static function IsTimeLessThan(timeA:Number, timeB:Number):Bool;
	static function SubtractBFromAAndCheckIfNegative(timeA:Number, timeB:Number):Bool;
	static function IsTimeMoreThan(timeA:Number, timeB:Number):Bool;
	static function SubtractAFromBAndCheckIfNegative(timeA:Number, timeB:Number):Bool;
	static function IsToggleModOn(vehicle:Number, modType:Number):Bool;
	static function IsTrackedPedVisible(ped:Number):Bool;
	static function IsTrackedPointVisible(point:Number):Bool;
	static function IsTurretSeat(vehicle:Number, seatIndex:Number):Bool;
	static function N_0xe33ffa906ce74880(vehicle:Number, seatIndex:Number):Bool;
	static function IsTvPlaylistItemPlaying(videoCliphash:Number):Bool;
	static function N_0x0ad973ca1e077b60(videoCliphash:Number):Bool;
	static function LoadTvChannel(videoCliphash:Number):Bool;
	static function IsUsingKeyboard(padIndex:Number):Bool;
	static function GetLastInputMethod(padIndex:Number):Bool;
	static function IsInputDisabled(padIndex:Number):Bool;
	static function IsUsingKeyboard_2(padIndex:Number):Bool;
	static function N_0x13337b38db572509(padIndex:Number):Bool;
	static function IsInputJustDisabled(padIndex:Number):Bool;
	static function IsValidInterior(interior:Number):Bool;
	static function IsValidMpGamerTagMovie(gamerTagId:Number):Bool;
	static function N_0xeb709a36958abe0d(gamerTagId:Number):Bool;
	static function HasMpGamerTag_2(gamerTagId:Number):Bool;
	static function HasMpGamerTagCrewFlagsSet(gamerTagId:Number):Bool;
	static function IsVehicleAConvertible(vehicle:Number, p1:Bool):Bool;
	static function IsVehicleAlarmActivated(vehicle:Number):Bool;
	static function IsVehicleAlarmSet(vehicle:Number):Bool;
	static function IsVehicleAttachedToCargobob(cargobob:Number, vehicleAttached:Number):Bool;
	static function IsVehicleAttachedToTowTruck(towTruck:Number, vehicle:Number):Bool;
	static function IsVehicleAttachedToTrailer(vehicle:Number):Bool;
	static function IsVehicleAudiblyDamaged(vehicle:Number):Bool;
	static function N_0x5db8010ee71fdef2(vehicle:Number):Bool;
	static function IsVehicleBeingHalted(vehicle:Number):Bool;
	static function N_0xc69bb1d832a710ef(vehicle:Number):Bool;
	static function IsVehicleBumperBouncing(vehicle:Number, frontBumper:Bool):Bool;
	static function N_0x27b926779deb502d(vehicle:Number, frontBumper:Bool):Bool;
	static function IsVehicleBumperBrokenOff(vehicle:Number, front:Bool):Bool;
	static function IsVehicleDamaged(vehicle:Number):Bool;
	static function IsVehicleDoorDamaged(veh:Number, doorID:Number):Bool;
	static function IsVehicleDoorFullyOpen(vehicle:Number, doorIndex:Number):Bool;
	static function IsVehicleDriveable(vehicle:Number, isOnFireCheck:Bool):Bool;
	static function IsVehicleEngineOnFire(vehicle:Number):Bool;
	static function N_0xec69adf931aae0c3(vehicle:Number):Bool;
	static function IsVehicleEngineStarting(vehicle:Number):Bool;
	static function IsVehicleExtraTurnedOn(vehicle:Number, extraId:Number):Bool;
	static function IsVehicleHighDetail(vehicle:Number):Bool;
	static function IsVehicleInBurnout(vehicle:Number):Bool;
	static function IsVehicleInGarageArea(garageName:String, vehicle:Number):Bool;
	static function IsVehicleInSubmarineMode(vehicle:Number):Bool;
	static function GetIsSubmarineVehicleTransformed(vehicle:Number):Bool;
	static function IsVehicleInteriorLightOn(vehicle:Number):Bool;
	static function IsVehicleModHswExclusive(vehicle:Number, modType:Number, modIndex:Number):Bool;
	static function IsVehicleModel(vehicle:Number, model:Number):Bool;
	static function IsVehicleNeedsToBeHotwired(vehicle:Number):Bool;
	static function IsVehicleNeonLightEnabled(vehicle:Number, index:Number):Bool;
	static function IsVehicleNodeIdValid(vehicleNodeId:Number):Bool;
	static function IsVehicleOnAllWheels(vehicle:Number):Bool;
	static function IsVehicleParachuteActive(vehicle:Number):Bool;
	static function N_0x3de51e9c80b116cf(vehicle:Number):Bool;
	static function IsVehiclePreviouslyOwnedByPlayer(vehicle:Number):Bool;
	static function IsVehicleRadioEnabled(vehicle:Number):Bool;
	static function N_0x0be4be946463f917(vehicle:Number):Bool;
	static function IsVehicleRadioLoud(vehicle:Number):Bool;
	static function IsVehicleRocketBoostActive(vehicle:Number):Bool;
	static function IsVehicleSearchlightOn(vehicle:Number):Bool;
	static function IsVehicleSeatAccessible(ped:Number, vehicle:Number, seatIndex:Number, side:Bool, onEnter:Bool):Bool;
	static function N_0x639431e895b9aa57(ped:Number, vehicle:Number, seatIndex:Number, side:Bool, onEnter:Bool):Bool;
	static function IsVehicleSeatFree(vehicle:Number, seatIndex:Number):Bool;
	static function IsVehicleSirenAudioOn(vehicle:Number):Bool;
	static function N_0xb5cc40fbcb586380(vehicle:Number):Bool;
	static function IsVehicleSirenSoundOn(vehicle:Number):Bool;
	static function IsVehicleSirenOn(vehicle:Number):Bool;
	static function IsVehicleSlipstreamLeader(vehicle:Number):Bool;
	static function N_0x48c633e94a8142a7(vehicle:Number):Bool;
	static function IsVehicleSprayable(vehicle:Number):Bool;
	static function N_0x8d474c8faeff6cde(vehicle:Number):Bool;
	static function IsVehicleShopResprayAllowed(vehicle:Number):Bool;
	static function IsVehicleStolen(vehicle:Number):Bool;
	static function IsVehicleStopped(vehicle:Number):Bool;
	static function IsVehicleStoppedAtTrafficLights(vehicle:Number):Bool;
	static function IsVehicleStuckOnRoof(vehicle:Number):Bool;
	static function IsVehicleStuckTimerUp(vehicle:Number, p1:Number, p2:Number):Bool;
	static function IsVehicleTyreBurst(vehicle:Number, wheelID:Number, completely:Bool):Bool;
	static function IsVehicleVisible(vehicle:Number):Bool;
	static function IsVehicleWanted(vehicle:Number):Bool;
	static function IsVehicleWeaponDisabled(weaponHash:Number, vehicle:Number, owner:Number):Bool;
	static function N_0x563b65a643ed072e(weaponHash:Number, vehicle:Number, owner:Number):Bool;
	static function IsVehicleWindowIntact(vehicle:Number, windowIndex:Number):Bool;
	static function IsWarningMessageActive():Bool;
	static function IsMedicalDisabled():Bool;
	static function IsWarningMessageActive_2():Bool;
	static function N_0xaf42195a42c63bba():Bool;
	static function IsWaypointActive():Bool;
	static function IsWaypointPlaybackGoingOnForPed(p0:Number):Bool;
	static function IsWaypointPlaybackGoingOnForVehicle(vehicle:Number):Bool;
	static function IsWeaponValid(weaponHash:Number):Bool;
	static function IsWorldPointWithinBrainActivationRange():Bool;
	static function IsXbox360Version():Bool;
	static function KnockOffPedProp(ped:Number, p1:Bool, p2:Bool, p3:Bool, p4:Bool):Void;
	static function KnockPedOffVehicle(ped:Number):Void;
	static function LandingMenuIsActive():Bool;
	static function N_0x3bbbd13e5041a79e():Bool;
	...
	static function Leaderboards2ReadFriendsByRow(p2:Number, p3:Bool, p4:Number, p5:Number):Leaderboards2ReadFriendsByRowReturnType;
	...
	static function LeaderboardsGetCacheExists(p0:Number):Bool;
	...
	static function N_0xa31fd15197b192bd():Bool;
	...
	static function LeaderboardsReadPending(p0:Number, p1:Number, p2:Number):Bool;
	static function LeaderboardsReadSuccessful(p0:Number, p1:Number, p2:Number):Bool;
	...
	static function LoadMissionCreatorPhoto(p0:String, p3:Bool):LoadMissionCreatorPhotoReturnType;
	static function N_0x4862437a486f91b0(p0:String, p3:Bool):N_0x4862437a486f91b0ReturnType;
	...
	static function LoadStreamWithStartOffset(streamName:String, startOffset:Number, soundSet:String):Bool;
	...
	static function N_0xef7d17bc6c85264c():Bool;
	static function LoadingscreenGetLoadFreemodeWithEventName():Bool;
	static function N_0x8aa464d4e0f6accd():Bool;
	static function LoadingscreenIsLoadingFreemode():Bool;
	static function N_0xc6dc823253fbb366():Bool;
	static function IsUiLoadingMultiplayer():Bool;
	static function LoadingscreenSetIsLoadingFreemode(toggle:Bool):Void;
	static function N_0xc7e7181c09f33b69(toggle:Bool):Void;
	static function LoadingscreenSetLoadFreemode(toggle:Bool):Void;
	static function GetBroadcastFinshedLosSound(toggle:Bool):Void;
	static function N_0xb0c56bd3d808d863(toggle:Bool):Void;
	static function LoadingscreenSetLoadFreemodeWithEventName(toggle:Bool):Void;
	static function N_0xfc309e94546fcdb5(toggle:Bool):Void;
	static function IsInLoadingScreen(toggle:Bool):Void;
	...
	static function N_0x94f2e83ead7e6b82(radioStationName:String, toggle:Bool):Void;
	static function SetRadioStationDisabled(radioStationName:String, toggle:Bool):Void;
	...
	static function LowerConvertibleRoof(vehicle:Number, instantlyLower:Bool):Void;
	static function LowerRetractableWheels(vehicle:Number):Void;
	static function N_0x5335be58c083e74e(vehicle:Number):Void;
	static function MakePedReload(ped:Number):Bool;
	...
	static function MumbleIsPlayerTalking(player:Number):Bool;
	...
	static function MumbleSetActive(state:Bool):Void;
	...
	static function N_0x02369d5c8a51fdcf(toggle:Bool):Void;
	static function N_0x023acab2dc9dc4a4():Number;
	static function N_0x02deaac8f8ea7fe7(p0:String):Void;
	static function N_0x02e93c796abd3a97(p0:Bool):Void;
	static function N_0x03300b57fcac6ddb(p0:Bool):Void;
	...
	static function N_0x03ea03af85a85cb7(ped:Number, p1:Bool, p2:Bool, p3:Bool, p4:Bool, p5:Bool, p6:Bool, p7:Bool, p8:Number):Bool;
	...
	static function N_0x04655f9d075d0ae5(toggle:Bool):Void;
	...
	static function N_0x06087579e7aa85a9(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number):Bool;
	static function N_0x061cb768363d6424(ped:Number, toggle:Bool):Void;
	static function N_0x062d5ead4da2fa6a():Void;
	static function N_0x063ae2b2cc273588(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x06ee9048fd080382(p0:Bool):Void;
	...
	static function N_0x08e8eeadfd0dc4a0(amount:Number):Bool;
	...
	static function N_0x0ae73d8df3a762b2(p0:Bool):Void;
	...
	static function N_0x0b568201dd99f0eb(p0:Bool):Void;
	...
	static function N_0x0e4299c549f0d1f1(toggle:Bool):Void;
	static function N_0x0ede326d47cd0f3e(ped:Number, player:Number):Bool;
	...
	static function N_0x0f6f1ebbc4e1d5e6(scriptIndex:Number, p1:String):Bool;
	static function N_0x0ffb3c758e8c07b9(ped:Number, p1:Bool):Number;
	...
	static function N_0x108be26959a9d9bb(toggle:Bool):Void;
	...
	static function N_0x1185a8087587322c(p0:Bool):Void;
	...
	static function N_0x162c23ca83ed0a62(p0:Number):Bool;
	...
	static function N_0x19bfed045c647c49(ped:Number):Bool;
	static function N_0x1a092bb0c3808b96(entity:Number, p1:Bool):Void;
	...
	static function N_0x1bbc135a4d25edde(p0:Bool):Void;
	static function N_0x1c073274e065c6d2(vehicle:Number, toggle:Bool):Void;
	static function N_0x1c57c94a6446492a(p0:Number, p1:Number):Void;
	static function N_0x1cba05ae7bd7ee05(p0:Number):Void;
	static function N_0x1d12a56fc95be92e():Bool;
	static function N_0x1d4dc17c38feaff0():Bool;
	static function N_0x1d610eb0fea716d9(p0:Number):Bool;
	...
	static function N_0x1eae0a6e978894a2(p0:Number, p1:Bool):Void;
	...
	static function N_0x2016c603d6b8987c(ped:Number, toggle:Bool):Void;
	...
	static function N_0x20746f7b1032a3c7(p0:Bool, p1:Bool, p2:Bool, p3:Bool):Void;
	static function N_0x208784099002bc30(missionNameLabel:String, p1:Number):Void;
	static function N_0x20c6c7e4eb082a7f(p0:Bool):Void;
	static function N_0x2107a3773771186d():Bool;
	static function N_0x211c4ef450086857():Void;
	static function N_0x214cd562a939246a():Bool;
	static function N_0x21c235bc64831e5a(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Bool):Vector3;
	...
	static function N_0x2311dd7159f00582(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x23f09eadc01449d6(padIndex:Number):Bool;
	static function N_0x241fca5b1aa14f75():Bool;
	static function N_0x243296a510b562b6():Void;
	static function N_0x247acbc4abbc9d1c(p0:Bool):Void;
	...
	static function N_0x2570e26be63964e3():Bool;
	...
	static function N_0x25fc3e33a31ad0c9(p0:Bool):Void;
	static function N_0x261e97ad7bcf3d40(p0:Bool):Void;
	...
	static function N_0x271017b9ba825366(p0:Number, p1:Bool):Void;
	static function N_0x271401846bd26e92(p0:Bool, p1:Bool):Void;
	static function N_0x2735233a786b1bef(ped:Number, p1:Number):Void;
	static function N_0x2790f4b17d098e26(toggle:Bool):Void;
	...
	static function N_0x27feb5254759cde3(textureDict:String, p1:Bool):Bool;
	...
	static function N_0x2a893980e96b659a(p0:Bool):Bool;
	...
	static function N_0x2b51edbefc301339(p0:Number, p1:String):Bool;
	static function N_0x2b694afcf64e6994(ped:Number, p1:Bool):Void;
	...
	static function N_0x2c4a1590abf43e8b(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x2d5dc831176d0114(p0:Number):Bool;
	...
	static function N_0x2e0bf682cc778d49(p0:Number):Bool;
	static function N_0x2e22fefa0100275e():Bool;
	static function N_0x2e4c123d1c8a710e(p2:Number, p3:Number, p4:Number, p5:Number, p6:Number):N_0x2e4c123d1c8a710eReturnType;
	static function N_0x2f057596f2bd0061():Bool;
	static function N_0x2f074c904d85129e(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number):Void;
	static function N_0x2f137b508de238f2(p0:Bool):Void;
	static function N_0x2f3c3d9f50681de4(p0:Number, p1:Bool):Void;
	static function N_0x2f41a3bae005e5fa(p0:Number, p1:Number):Void;
	static function N_0x2f7ceb6520288061(p0:Bool):Void;
	...
	static function N_0x3001bef2feca3680():Bool;
	static function N_0x30432a0118736e00():Number;
	static function N_0x3044240d2e0fa842():Bool;
	...
	static function N_0x31f924b53eaddf65(p0:Bool):Void;
	...
	static function N_0x33d47e85b476abcd(p0:Bool):Bool;
	static function N_0x33d72899e24c3365(p0:Number, p1:Number):Number;
	static function N_0x33df47cc0642061b():Bool;
	static function N_0x33e3c6c6f2f0b506(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function N_0x3441cad2f2231923(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x35e0654f4bad7971(p0:Bool):Void;
	static function N_0x36391f397731595d(p0:Number):Number;
	static function N_0x367ef5e2f439b4c6(p0:Number):Void;
	static function N_0x36ccb9be67b970fd(ropeId:Number, p1:Bool):Void;
	static function N_0x36de109527a2c0c4(toggle:Bool):Void;
	...
	static function N_0x38b7c51ab1edc7d8(entity:Number, toggle:Bool):Void;
	...
	static function N_0x39917e1b4cb0f911(p0:Bool):Void;
	static function N_0x39a5fb7eaf150840(p0:Number, p1:Number):Void;
	static function N_0x3a48ab4445d499be():Number;
	static function N_0x3b2fd68db5f8331c(object:Number, toggle:Bool, R:Number, G:Number, B:Number):Void;
	static function SetObjectColour(object:Number, toggle:Bool, R:Number, G:Number, B:Number):Void;
	static function N_0x3b458ddb57038f08(vehicle:Number, doorIndex:Number, toggle:Bool):Void;
	static function N_0x3bd770d281982db5(p0:Number, p1:Number):Number;
	static function N_0x3c5c1e2c2ff814b1(toggle:Bool):Void;
	...
	static function N_0x41350b4fc28e3941(p0:Bool):Void;
	static function N_0x419615486bbf1956(p0:Number):Void;
	static function N_0x4237e822315d8ba9():Bool;
	static function N_0x425aecf167663f48(ped:Number, p1:Bool):Void;
	...
	static function N_0x43fa0dfc5df87815(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x450819d8cf90c416():Bool;
	...
	static function N_0x469f2ecdec046337(p0:Bool):Void;
	static function N_0x46b05bcae43856b0(ped:Number, flag:Number):Bool;
	...
	static function N_0x487912fd248efddf(p0:Number, p1:Number):Bool;
	static function N_0x4879e4fe39074cdf():Bool;
	static function N_0x48f069265a0e4bec(name:String):Number;
	static function N_0x490861b88f4fd846(p0:Number):Void;
	static function N_0x49e50bdb8ba4dab2(ped:Number, toggle:Bool):Void;
	static function N_0x4a7d6e727f941747(p0:Number):N_0x4a7d6e727f941747ReturnType;
	static function N_0x4a9fde3a5a6d0437(toggle:Bool):Void;
	static function N_0x4ad280eb48b2d8e6(vehicle:Number, togle:Bool):Void;
	...
	static function N_0x4cebc1ed31e8925e(cutsceneName:String):Bool;
	static function N_0x4d02279c83be69fe():Number;
	static function N_0x4d953df78ebf8158():Void;
	static function N_0x4d9d109f63fee1d4(p0:Number, p1:Bool):Void;
	...
	static function N_0x4df7cfff471a7fb1(p0:Number):Bool;
	...
	static function N_0x50a8a36201dbf83e():Bool;
	static function N_0x511f1a683387c7e2(ped:Number):Number;
	static function N_0x51db102f4a3ba5e0(toggle:Bool):Void;
	static function N_0x51f30db60626a20e(vehicle:Number, x:Number, y:Number, z:Number, rotX:Number, rotY:Number, rotZ:Number, p7:Number, p8:Number):Bool;
	...
	static function N_0x5539c3ebf104a53a(p0:Bool):Void;
	...
	static function N_0x55fcc0c390620314(player1:Number, player2:Number, toggle:Bool):Void;
	static function N_0x560b423d73015e77(p0:Number):Number;
	static function N_0x5688585e6d563cd8(p0:Number):Void;
	static function N_0x56eb5e94318d3fb6(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x58bb377bec7cd5f4(p0:Bool, p1:Bool):Void;
	static function N_0x59328eb08c5ceb2b():Bool;
	static function N_0x593feae1f73392d4():Number;
	static function N_0x59424bd75174c9b1():Void;
	static function N_0x59c3757b3b7408e8(vehicle:Number, toggle:Bool, p2:Number):Void;
	static function N_0x59d421683d31835a(p0:Number):Void;
	static function N_0x5a34cd9c3c5bec44(p0:Number):Bool;
	static function N_0x5a43c76f7fc7ba5f():Void;
	static function N_0x5a556b229a169402():Bool;
	...
	static function N_0x5b6010b3cbc29095(p0:Number, p1:Bool):Void;
	static function N_0x5b73c77d9eb66e24(p0:Bool):Void;
	...
	static function N_0x5bbcf35bf6e456f7(toggle:Bool):Void;
	...
	static function N_0x5c48a1d6e3b33179(cam:Number):Bool;
	...
	static function N_0x5e569ec46ec21cae(vehicle:Number, toggle:Bool):Void;
	static function N_0x5ead2bf6484852e4():Bool;
	static function N_0x5ecd378ee64450ab(p0:Number):Void;
	static function N_0x5edef0cf8c1dab3c():Bool;
	...
	static function N_0x5f6df3d92271e8a1(toggle:Bool):Void;
	static function SetParticleFxBloodScale(toggle:Bool):Void;
	static function N_0x5fc472c501ccadb3(player:Number):Bool;
	static function N_0x5ff2c33b13a02a11(p0:Number):Void;
	static function N_0x600f8cb31c7aab6e(p0:Number):Void;
	static function N_0x60edd13eb3ac1ff3():Bool;
	static function N_0x60eedc12af66e846(p0:Number):Void;
	static function N_0x6100b3cefd43452e(p0:Number):Void;
	static function N_0x613f125ba3bd2eb9():Bool;
	static function N_0x615d3925e87a3b26(checkpoint:Number):Void;
	static function N_0x61631f5df50d1c34(p0:Bool):Void;
	...
	static function N_0x62e849b7eb28e770(p0:Bool):Void;
	...
	static function N_0x64e5c4cc82847b73():Bool;
	...
	static function N_0x65d2ebb47e1cec21(toggle:Bool):Void;
	static function N_0x661b5c8654add825(cam:Number, p1:Bool):Void;
	...
	static function N_0x690a61a6d13583f6(player:Number):Bool;
	static function N_0x690b76bd2763e068():Number;
	static function N_0x692d58df40657e8c(p0:Number, p1:Number, p2:Number, p4:Number, p5:Bool):N_0x692d58df40657e8cReturnType;
	static function N_0x693478acbd7f18e7():Void;
	static function N_0x694e00132f2823ed(entity:Number, toggle:Bool):Void;
	...
	static function N_0x6a51f78772175a51(toggle:Bool):Void;
	static function N_0x6a5d89d7769a40d8(toggle:Bool):Void;
	static function N_0x6a60e43998228229(p0:Number):Void;
	static function N_0x6a7f19756f1a9016():Bool;
	...
	static function N_0x6bfb12ce158e3dd4(p0:Number):Bool;
	static function N_0x6bff5f84102df80a(player:Number):Void;
	static function N_0x6cd79468a1e595c6(padIndex:Number):Bool;
	...
	static function N_0x6ebfb22d646ffc18(vehicle:Number, p1:Bool):Void;
	static function N_0x6f2135b6129620c1(toggle:Bool):Void;
	static function N_0x6f361b8889a792a3():Void;
	static function N_0x6fb7bb3607d27fa2():Number;
	static function N_0x6fcf8ddea146c45b(p0:Number):Bool;
	...
	static function N_0x6fddad856e36988a(vehicle:Number, toggle:Bool):Void;
	static function N_0x6fddf453c0c756ec():Bool;
	...
	static function N_0x705a276ebff3133d():Bool;
	static function N_0x70a382adec069dd3(coordX:Number, coordY:Number, coordZ:Number):Void;
	static function N_0x70b8ec8fc108a634(p0:Bool, p1:Number):Void;
	static function N_0x710bcda8071eded1():Bool;
	...
	static function N_0x7241ccb7d020db69(entity:Number, toggle:Bool):Void;
	...
	static function N_0x72eb7ba9b69bf6ab():Bool;
	...
	static function N_0x737e398138550fff(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0x759650634f07b6b4(p0:Number):Bool;
	static function N_0x75ba1cb3b7d40caf(ped:Number, p1:Bool):Void;
	...
	static function N_0x78321bea235fd8cd(p0:Number, p1:Bool):Bool;
	...
	static function N_0x79c0e43eb9b944e2(hash:Number):Bool;
	static function N_0x79d310a861697cc9(profileSetting:Number, settingValue:Number):Void;
	static function N_0x79edac677ca62f81(transactionId:Number):Bool;
	static function N_0x7a42b2e236e71415():Void;
	static function N_0x7ac24eab6d74118d(p0:Bool):Bool;
	...
	static function N_0x7c4fccd2e4deb394():Bool;
	static function N_0x7d36291161859389(p0:Number):Void;
	static function N_0x7d395ea61622e116(p0:Bool):Void;
	static function N_0x7d6f9a3ef26136a0(vehicle:Number, toggle:Bool, p2:Bool):Void;
	...
	static function N_0x7e2bd3ef6c205f09(p0:String, p1:Bool):Void;
	static function N_0x7e6946f68a38b74f(p0:Number):Bool;
	...
	static function N_0x7ef7649b64d7ff10(entity:Number):Bool;
	static function N_0x7f2c4cdf2e82df4c(p0:Number):Bool;
	static function N_0x7f8f6405f4777af6(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Bool):Number;
	static function N_0x7f96f23fa9b73327(modelHash:Number):Void;
	static function N_0x7fa5d82b8f58ec06():Bool;
	static function N_0x7fcc39c46c3c03bd(p0:Number):Bool;
	static function N_0x7ffcbfee44ecfabf():Number;
	static function N_0x80054d7fcc70eec6(ped:Number):Void;
	static function N_0x801879a9b4f4b2fb():Bool;
	static function N_0x80e3357fdef45c21(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0x817b86108eb94e51(p0:Bool):N_0x817b86108eb94e51ReturnType;
	static function N_0x81cbae94390f9f89():Void;
	static function N_0x820e9892a77e97cd(p0:Number, p1:Number):Void;
	static function N_0x8235f1bead557629(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0x82e0ac411e41a5b4(toggle:Bool):Void;
	...
	static function N_0x836b62713e0534ca():Bool;
	...
	static function N_0x8821196d91fa2de5(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0x88bc673ca9e0ae99(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x8c8d2739ba44af0f(p0:Number):Bool;
	...
	static function N_0x8cde909a0370bb3a(toggle:Bool):Void;
	...
	static function N_0x8ef52acaecc51d9c(toggle:Bool):Void;
	static function N_0x8f08017f9d7c47bd(p0:Number, p2:Number):N_0x8f08017f9d7c47bdReturnType;
	static function N_0x8f0d5ba1c2cc91d7(toggle:Bool):Void;
	...
	static function N_0x91ef6ee6419e5b97(p0:Bool):Void;
	...
	static function N_0x933bbeeb8c61b5f4():Bool;
	static function N_0x94538037ee44f5cf(p0:Bool):Void;
	static function N_0x9465e683b12d3f6b():Void;
	static function N_0x9489659372a81585():Bool;
	...
	static function N_0x973d76aa760a6cb6(p0:Bool):Void;
	static function N_0x977ca98939e82e4b(weaponObject:Number, p1:Number):Void;
	static function N_0x97841634ef7df1d6(vehicle:Number, toggle:Bool):Void;
	static function N_0x97e7e2c04245115b(p0:Number):Void;
	static function N_0x97ffb4adeed08066(p0:Number, p1:Number):Void;
	static function N_0x9849de24fcf23ccc(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0x9911f4a24485f653(p0:Bool):Void;
	static function N_0x998e18ceb44487fc(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function N_0x99a05839c46ce316(toggle:Bool):Void;
	...
	static function N_0x9a77dfd295e29b09(ped:Number, toggle:Bool):Void;
	static function N_0x9ac92eed5e4793ab():Void;
	static function N_0x9b079e5221d984d3(p0:Bool):Void;
	...
	static function N_0x9bddc73cc6a115d4(vehicle:Number, p1:Bool, p2:Bool):Void;
	static function N_0x9becd4b9fef3f8a6(vehicle:Number, p1:Bool):Void;
	...
	static function N_0x9d7afcbf21c51712(toggle:Bool):Void;
	static function N_0x9de5d2f723575ed0():Bool;
	static function N_0x9dfe13ecdc1ec196(p0:Bool, p1:Bool):Void;
	static function SetTimeIdleDrop(p0:Bool, p1:Bool):Void;
	static function N_0x9e30e91fb03a2caf():N_0x9e30e91fb03a2cafReturnType;
	static function N_0x9e6542f0ce8e70a3(toggle:Bool):Void;
	static function N_0x9ebd751e5787baf2(p0:Bool):Void;
	...
	static function N_0x9f3f689b814f2599(vehicle:Number, p1:Bool):Void;
	...
	static function N_0xa08fe5e49bdc39dd(p0:Number, p1:Number, p2:Bool):Void;
	...
	static function N_0xa1ae736541b0fca3(p1:Bool):Number;
	static function N_0xa213b11dff526300():Bool;
	static function N_0xa238192f33110615():N_0xa238192f33110615ReturnType;
	static function N_0xa247f9ef01d8082e(p0:Number):Void;
	static function N_0xa2767257a320fc82(p0:Number, p1:Bool):Void;
	...
	static function N_0xa2e9c1ab8a92e8cd(toggle:Bool):Void;
	static function N_0xa306f470d1660581():Number;
	static function N_0xa3c53804bdb68ed2(p0:Number, p1:Number):Void;
	static function N_0xa3f3564a5b3646c0(ped:Number):Bool;
	static function N_0xa468e0be12b12c70():Bool;
	static function N_0xa46b73faa3460ae1(p0:Bool):Void;
	...
	static function N_0xa660faf550eb37e5(p0:Number, p1:Bool):Void;
	...
	static function N_0xa7dcdf4ded40a8f4(vehicle:Number, p1:Bool):Void;
	static function N_0xa85a21582451e951(doorHash:Number, p1:Bool):Void;
	...
	static function N_0xa9b61a329bfdcbea(p0:Number, p1:Bool):Void;
	...
	static function N_0xaa653ae61924b0a0(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0xab04325045427aae(vehicle:Number, p1:Bool):Void;
	...
	static function N_0xadf084fb8f075d06(p0:Number):Bool;
	static function N_0xae3fee8709b39dcb(vehicle:Number):Bool;
	static function N_0xae51bc858f32ba66(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number):Void;
	static function N_0xaeab987727c5a8a4(p0:Number):Bool;
	...
	static function N_0xafc976fd0580c7b3(ped:Number, toggle:Bool):Void;
	static function N_0xafe24e4d29249e4a(object:Number, p1:Number, p2:Number, p3:Bool):Bool;
	...
	static function N_0xb1b6216ca2e7b55e(p0:Number, p1:Bool, p2:Bool):Void;
	static function N_0xb1d2bb1e1631f5b1():Bool;
	static function N_0xb26f670685631727(p0:Number):Void;
	static function N_0xb282749d5e028163(p0:Number, p1:Number):Void;
	static function N_0xb2d0bde54f0e8e5a(object:Number, toggle:Bool):Void;
	static function N_0xb2e0c0d6922d31f2(vehicle:Number, toggle:Bool):Void;
	static function N_0xb2ebe8cbc58b90e9():Number;
	static function N_0xb309ebea797e001f(p0:Number):Number;
	static function N_0xb3352e018d6f89df(toggle:Bool):Void;
	static function N_0xb37e4e6a2388ca7b():Bool;
	static function N_0xb3c641f3630bf6da(p0:Number):Void;
	static function N_0xb3da2606774a8e2d():Bool;
	...
	static function N_0xb51b9ab9ef81868c(toggle:Bool):Void;
	static function N_0xb542de8c3d1cb210(p0:Bool):Void;
	...
	static function N_0xb68cfaf83a02768d(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0xba8d65c1c65702e5(toggle:Bool):Void;
	...
	static function N_0xbd545d44cce70597():Bool;
	static function N_0xbdb6f89c729cf388():Bool;
	...
	static function N_0xbe5c1255a1830ff5(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0xbef34b1d9624d5dd(p0:Bool):Void;
	static function N_0xbf22e0f32968e967(player:Number, p1:Bool):Void;
	static function N_0xbf371cd2b64212fd(p0:Number):Void;
	static function N_0xbf4dc1784be94dfa(ped:Number, p1:Bool, hash:Number):Void;
	...
	static function N_0xc0416b061f2b7e5e(p0:Bool):Void;
	...
	static function N_0xc2c97ea97711d1ae():Bool;
	static function N_0xc2d2ad9eaae265b8():Bool;
	...
	static function N_0xc34bc448da29f5e9(entity:Number, toggle:Bool):Void;
	static function N_0xc35a6d07c93802b2():Void;
	static function N_0xc361aa040d6637a8(vehicle:Number, p1:Bool):Void;
	static function N_0xc42dd763159f3461():Bool;
	static function N_0xc434133d9ba52777(p0:Number, TypeOfWeapon:Number):N_0xc434133d9ba52777ReturnType;
	static function N_0xc4637a6d03c24cc3():Bool;
	static function N_0xc4b3347bd68bd609(p0:Number):Void;
	static function N_0xc50ce861b55eab8b(vehicle:Number, p1:Bool):Void;
	static function N_0xc56fbf2f228e1dac(modelHash:Number, p1:Number, p2:Number):Number;
	static function N_0xc571d0e77d8bbc29():Bool;
	static function N_0xc594b315edf2d4af(ped:Number):Void;
	static function N_0xc5a35c73b68f3c49():Bool;
	static function N_0xc5c8f970d4edff71(p0:Number):Void;
	static function N_0xc6033d32241f6fb5(object:Number, toggle:Bool):Void;
	static function N_0xc61b86c9f61eb404(toggle:Bool):Void;
	...
	static function N_0xc7f29ca00f46350e(p0:Bool):Void;
	static function N_0xc830417d630a50f9(transactionId:Number):Bool;
	...
	static function N_0xc8b1b2425604cdd0():Bool;
	...
	static function N_0xca4ae345a153d573(p0:Bool):Void;
	...
	static function N_0xcac57395b151135f(player:Number, p1:Bool):Void;
	static function N_0xcb0360efefb2580d(padIndex:Number):Void;
	static function N_0xcb645e85e97ea48b():Bool;
	...
	static function N_0xccd078c2665d2973(p0:Bool):Void;
	static function N_0xcd018c591f94cb43(ped:Number, p1:Bool):Void;
	static function N_0xcd0f5b5d932ae473():Void;
	static function N_0xcd4d66b43b1dd28d(p0:Number, p1:Number, p2:Number):Void;
	static function N_0xcd74233600c4ea6b(toggle:Bool):Void;
	...
	static function N_0xceda60a74219d064(p0:Number, p1:Bool):Void;
	static function N_0xcf9159024555488c(p0:Number):Void;
	static function N_0xcfd16f0db5a3535c(toggle:Bool):Void;
	static function N_0xcfd778e7904c255e(vehicle:Number):Void;
	static function N_0xcfeb46dcd7d8d5eb(p0:Bool):Void;
	...
	static function N_0xd313de83394af134():Bool;
	...
	static function N_0xd7b6c73cad419bcf(p0:Bool):Void;
	...
	static function N_0xdaf87174be7454ff(p0:Number):Bool;
	...
	static function N_0xdb90c6cca48940f1(p0:Bool):Void;
	static function N_0xdbc631f109350b8c(vehicle:Number, p1:Bool):Void;
	static function N_0xdbf860cf1db8e599(p0:Number):Number;
	static function N_0xdc6f8601faf2e893(entity:Number, toggle:Bool):Void;
	static function N_0xdcc07526b8ec45af(player:Number):Bool;
	static function N_0xdce97bdf8a0eabc8():Void;
	static function N_0xdd2620b7b9d16ff1(player:Number, p1:Number):Bool;
	...
	static function N_0xde45d1a1ef45ee61(player:Number, toggle:Bool):Void;
	static function SetHudAnimStopLevel(player:Number, toggle:Bool):Void;
	...
	static function N_0xe058175f8eafe79a(p0:Bool):Void;
	static function N_0xe05dd0e9707003a3(p0:Number, p1:Bool):Void;
	...
	static function N_0xe154b48b68ef72bc(p0:Number):Bool;
	static function N_0xe1615ec03b3bb4fd():Bool;
	...
	static function N_0xe36a98d8ab3d3c66(p0:Bool):Void;
	...
	static function N_0xe63d7c6eececb66b(toggle:Bool):Void;
	static function N_0xe66377cddada4810(entity:Number, p1:Bool):Void;
	static function N_0xe6717e652b8c8d8a(p0:Number, p1:Number):Void;
	static function N_0xe67c6dfd386ea5e7(p0:Bool):Void;
	static function N_0xe6d2cedd370ff98e(p0:Number, p1:Number):Void;
	static function N_0xe75a4a2e5e316d86():Bool;
	static function N_0xe791df1f73ed2c8b(p0:Number):Number;
	static function N_0xe851e480b814d4ba(vehicle:Number, p1:Bool):Void;
	static function N_0xe8718faf591fd224(vehicle:Number):Bool;
	static function N_0xe8853fbce7d8d0d6():Number;
	static function N_0xe906ec930f5fe7c8(p0:Number, p1:Number):Void;
	static function N_0xe95b0c7d5ba3b96b(ped:Number):Bool;
	...
	static function N_0xeb6f1a9b5510a5d2(p0:Number, p1:Bool):Void;
	...
	static function N_0xef398beee4ef45f9(p0:Bool):Void;
	static function N_0xef39ee20c537e98c(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number):Void;
	static function N_0xef9d388f8d377f44(vehicle:Number, p1:Bool):Void;
	...
	static function N_0xf13fe2a80c05c561():Bool;
	static function N_0xf1a1803d3476f215(value:Number):Void;
	static function N_0xf22ca0fd74b80e7a(p0:Number):Bool;
	static function N_0xf2385935bffd4d92(ped:Number):Bool;
	...
	static function N_0xf2bebcdfafdaa19e(toggle:Bool):Void;
	static function N_0xf2ca003f167e21d2():Number;
	static function ReturnZero():Number;
	static function N_0xf2e07819ef1a5289():Bool;
	static function N_0xf3365489e0dd50f9(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0xf78f94d60248c737(vehicle:Number, p1:Bool):Bool;
	...
	static function N_0xf8ad2eed7c47e8fe(ped:Number, p1:Bool, p2:Bool):Void;
	...
	static function N_0xf9acf4a08098ea25(ped:Number, p1:Bool):Void;
	...
	static function N_0xfa1e0e893d915215(toggle:Bool):Void;
	static function N_0xfa2888e3833c8e96():Void;
	static function N_0xfa3ffb0eebc288a3(p0:Bool):Void;
	...
	static function N_0xfab944d4d481accb(ped:Number, toggle:Bool):Void;
	...
	static function N_0xfb199266061f820a():Bool;
	...
	static function N_0xfb80ab299d2ee1bd(toggle:Bool):Void;
	...
	static function N_0xfd325494792302d7(ped:Number, toggle:Bool):Void;
	static function SetTimeExclusiveDisplayTexture(ped:Number, toggle:Bool):Void;
	static function N_0xfd75dabc0957bf33(p0:Bool):Void;
	static function N_0xfdc07c58e8aab715(pickupHash:Number):Void;
	static function N_0xfe4c1d0d3b9cc17e(p0:Number, p1:Bool):Bool;
	static function N_0xfec9a3b1820f3331(ped:Number):Bool;
	...
	static function N_0xa65568121df2ea26():Bool;
	static function N_0xe547e9114277098f():Bool;
	static function NetworkShopBasketEnd():Bool;
	static function NetGameserverBasketIsFull():Bool;
	static function N_0x27f76cc6c55ad30e():Bool;
	static function NetworkShopBasketIsFull():Bool;
	...
	static function N_0x3c4487461e9b0dcb():Bool;
	static function NetGameserverCatalogItemExists(name:String):Bool;
	static function N_0xbd4d7eaf8a30f637(name:String):Bool;
	static function NetworkShopIsItemUnlocked(name:String):Bool;
	static function NetworkShopDoesItemExist(name:String):Bool;
	static function NetGameserverCatalogItemExistsHash(hash:Number):Bool;
	static function N_0x247f0f73a182ea0b(hash:Number):Bool;
	static function NetworkShopIsItemUnlockedHash(hash:Number):Bool;
	static function NetworkShopDoesItemExistHash(hash:Number):Bool;
	static function NetGameserverCheckoutStart(transactionId:Number):Bool;
	static function N_0x39be7cea8d9cc8e6(transactionId:Number):Bool;
	static function NetworkShopCheckoutStart(transactionId:Number):Bool;
	static function NetGameserverDeleteCharacterSlot(slot:Number, transfer:Bool, reason:Number):Bool;
	static function N_0x51f1a8e48c3d2f6d(slot:Number, transfer:Bool, reason:Number):Bool;
	...
	static function N_0x112cef1615a1139f():Bool;
	static function NetworkShopDeleteSetTelemetryNonceSeed():Bool;
	static function NetGameserverEndService(transactionId:Number):Bool;
	static function N_0xe2a99a9b524befff(transactionId:Number):Bool;
	static function NetworkShopEndService(transactionId:Number):Bool;
	static function NetworkShopTerminateService(transactionId:Number):Bool;
	static function NetGameserverGetBalance(inventory:Bool, playerbalance:Bool):Bool;
	static function N_0x35a1b3e1d1315cfa(inventory:Bool, playerbalance:Bool):Bool;
	...
	static function NetGameserverGetPrice(itemHash:Number, categoryHash:Number, p2:Bool):Number;
	static function NetworkShopGetPrice(itemHash:Number, categoryHash:Number, p2:Bool):Number;
	...
	static function N_0x2b949a1e6aec8f6a():Bool;
	static function NetGameserverIsSessionRefreshPending():Bool;
	static function N_0x810e8431c0614bf9():Bool;
	static function NetworkShopGetTransactionsDisabled():Bool;
	static function NetGameserverIsSessionValid(charSlot:Number):Bool;
	static function N_0xb24f0944da203d9e(charSlot:Number):Bool;
	static function NetworkShopGetTransactionsEnabledForCharacter(charSlot:Number):Bool;
	static function NetGameserverSessionApplyReceivedData(charSlot:Number):Bool;
	static function N_0x2f41d51ba3bcd1f1(charSlot:Number):Bool;
	static function NetworkShopSessionApplyReceivedData(charSlot:Number):Bool;
	static function NetGameserverSetTelemetryNonceSeed(p0:Number):Bool;
	static function N_0x9507d4271988e1ae(p0:Number):Bool;
	static function NetworkShopSetTelemetryNonceSeed(p0:Number):Bool;
	static function NetGameserverStartSession(charSlot:Number):Bool;
	static function N_0xa135ac892a58fc07(charSlot:Number):Bool;
	static function NetworkShopStartSession(charSlot:Number):Bool;
	static function NetGameserverTransferBankToWallet(charSlot:Number, amount:Number):Bool;
	static function N_0xd47a2c1ba117471d(charSlot:Number, amount:Number):Bool;
	static function NetworkTransferBankToWallet(charSlot:Number, amount:Number):Bool;
	...
	static function N_0x498c1e05ce5f7877():Bool;
	static function NetworkShopCashTransferSetTelemetryNonceSeed():Bool;
	static function NetGameserverTransferWalletToBank(charSlot:Number, amount:Number):Bool;
	static function N_0xc2f7fe5309181c7d(charSlot:Number, amount:Number):Bool;
	static function NetworkTransferWalletToBank(charSlot:Number, amount:Number):Bool;
	...
	static function N_0x62a0296c1bb1ceb3():Bool;
	static function NetworkAcceptPresenceInvite(p0:Number):Bool;
	static function NetworkAccessTunableBool(tunableContext:String, tunableName:String):Bool;
	static function N_0xaa6a47a573abb75a(tunableContext:String, tunableName:String):Bool;
	static function NetworkAccessTunableBoolHash(tunableContext:Number, tunableName:Number):Bool;
	static function N_0xea16b69d93d71a45(tunableContext:Number, tunableName:Number):Bool;
	...
	static function N_0xfafc23aee23868db():Bool;
	static function NetworkAllowLocalEntityAttachment(entity:Number, toggle:Bool):Void;
	static function N_0x267c78c60e806b9a(entity:Number, toggle:Bool):Void;
	static function NetworkAmIBlockedByGamer(networkHandle:Number):NetworkAmIBlockedByGamerReturnType;
	static function NetworkAmIBlockedByPlayer(player:Number):Bool;
	static function NetworkAmIMutedByGamer(networkHandle:Number):NetworkAmIMutedByGamerReturnType;
	static function NetworkAmIMutedByPlayer(player:Number):Bool;
	static function NetworkApplyCachedPlayerHeadBlendData(ped:Number, player:Number):Bool;
	static function N_0x99b72c7abde5c910(ped:Number, player:Number):Bool;
	static function NetworkCopyPedBlendData(ped:Number, player:Number):Bool;
	...
	static function NetworkApplyTransitionParameterString(p0:Number, _string:String, p2:Bool):Void;
	static function N_0xebefc2e77084f599(p0:Number, _string:String, p2:Bool):Void;
	...
	static function N_0xba9775570db788cf():Bool;
	static function NetworkAreTransitionDetailsValid(p0:Number):Bool;
	static function N_0x2615aa2a695930c1(p0:Number):Bool;
	...
	static function N_0xcfeb8af24fc1d0bb(toggle:Bool):Void;
	static function NetworkBlockInvites_2(toggle:Bool):Void;
	static function NetworkBlockKickedPlayers(p0:Bool):Void;
	static function N_0x6b07b9ce4d390375(p0:Bool):Void;
	static function NetworkBuyAirstrike(cost:Number, p1:Bool, p2:Bool):Void;
	static function NetworkBuyBackupGang(p0:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkBuyBounty(amount:Number, victim:Number, p2:Bool, p3:Bool):Void;
	static function NetworkBuyContraband(p0:Number, p1:Number, p2:Number, p3:Bool, p4:Bool):Void;
	static function N_0x30fd873ece50e9f6(p0:Number, p1:Number, p2:Number, p3:Bool, p4:Bool):Void;
	static function NetworkBuyFairgroundRide(amountSpent:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function N_0x8a7b3952dd64d2b5(amountSpent:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkBuyHealthcare(cost:Number, p1:Bool, p2:Bool):Void;
	static function NetworkBuyHeliStrike(cost:Number, p1:Bool, p2:Bool):Void;
	static function NetworkBuyItem(amount:Number, item:Number, p2:Number, p3:Number, p4:Bool, item_name:String, p6:Number, p7:Number, p8:Number, p9:Bool):Void;
	static function NetworkBuyLotteryTicket(p0:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkBuyProperty(propertyCost:Number, propertyName:Number, p2:Bool, p3:Bool):Void;
	static function NetworkBuySmokes(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkCanBet(amount:Number):Bool;
	static function N_0x3a54e33660ded67f(amount:Number):Bool;
	static function NetworkCanBuyLotteryTicket(cost:Number):Bool;
	...
	static function NetworkCanReceivePlayerCash(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	...
	static function N_0x1c2473301b1c66ba():Bool;
	static function NetworkCanSpendMoney(p0:Number, p1:Bool, p2:Bool, p3:Bool, p4:Number):Bool;
	static function N_0xab3caa6b422164da(p0:Number, p1:Bool, p2:Bool, p3:Bool, p4:Number):Bool;
	static function NetworkCanSpendMoney_2(p0:Number, p1:Bool, p2:Bool, p3:Bool, p5:Number):NetworkCanSpendMoney_2ReturnType;
	static function N_0x7303e27cc6532080(p0:Number, p1:Bool, p2:Bool, p3:Bool, p5:Number):N_0x7303e27cc6532080ReturnType;
	...
	static function NetworkCasinoCanGamble(p0:Number):Bool;
	static function NetworkCasinoCanPurchaseChipsWithPvc():Bool;
	static function NetworkCasinoCanPurchaseChipsWithPvc_2():Bool;
	static function NetworkCasinoCanUseGamblingType(hash:Number):Bool;
	static function NetworkCasinoPurchaseChips(p0:Number, p1:Number):Bool;
	static function NetworkCasinoSellChips(p0:Number, p1:Number):Bool;
	...
	static function NetworkCheckCommunicationPrivileges(p0:Number, p1:Number, p2:Bool):Bool;
	static function N_0x83f28ce49fbbffba(p0:Number, p1:Number, p2:Bool):Bool;
	...
	static function NetworkCheckUserContentPrivileges(p0:Number, p1:Number, p2:Bool):Bool;
	static function N_0x595f028698072dd9(p0:Number, p1:Number, p2:Bool):Bool;
	static function NetworkClanAnimation(animDict:String, animName:String):Bool;
	static function N_0x729e3401f0430686(animDict:String, animName:String):Bool;
	static function NetworkClanAnyDownloadMembershipPending():Bool;
	static function N_0xb3f64a6a91432477():Bool;
	static function NetworkIsClanMembershipFinishedDownloading():Bool;
	...
	static function NetworkClanJoin(clanDesc:Number):Bool;
	...
	static function NetworkClanRequestEmblem(p0:Number):Bool;
	static function N_0x13518ff1c6b28938(p0:Number):Bool;
	static function NetworkClanServiceIsValid():Bool;
	static function NetworkPlayerIsInClan():Bool;
	...
	static function NetworkConcealEntity(entity:Number, toggle:Bool):Void;
	static function NetworkConcealPlayer(player:Number, toggle:Bool, p2:Bool):Void;
	static function NetworkCreateSynchronisedScene(x:Number, y:Number, z:Number, xRot:Number, yRot:Number, zRot:Number, rotationOrder:Number,
		holdLastFrame:Bool, looped:Bool, p9:Number, animTime:Number, animSpeed:Number):Number;
	static function NetworkDeductCash(amount:Number, p1:String, p2:String, p3:Bool, p4:Bool, p5:Bool):Void;
	static function NetworkDeleteCharacter(characterSlot:Number, p1:Bool, p2:Bool):Void;
	static function NetworkDidFindGamersSucceed():Bool;
	static function N_0xf9b83b77929d8863():Bool;
	static function NetworkDidGetGamerStatusSucceed():Bool;
	static function N_0x5ae17c6b0134b7f1():Bool;
	static function NetworkDisableInvincibleFlashing(player:Number, toggle:Bool):Void;
	static function N_0x9dd368bf06983221(player:Number, toggle:Bool):Void;
	static function NetworkDisableLeaveRemotePedBehind(toggle:Bool):Void;
	static function N_0xc505036a35afd01b(toggle:Bool):Void;
	...
	static function NetworkDoTransitionQuickmatch(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	static function N_0x71fb0ebcd4915d56(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	static function NetworkDoTransitionQuickmatchAsync(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	static function N_0xa091a5e44f0072e5(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	...
	static function NetworkDoTransitionToFreemode(p1:Number, p2:Bool, players:Number, p4:Bool):NetworkDoTransitionToFreemodeReturnType;
	static function NetworkDoTransitionToGame(p0:Bool, maxPlayers:Number):Bool;
	static function NetworkDoTransitionToNewFreemode(players:Number, p3:Bool, p4:Bool, p5:Bool):NetworkDoTransitionToNewFreemodeReturnType;
	static function NetworkDoTransitionToNewGame(p0:Bool, maxPlayers:Number, p2:Bool):Bool;
	static function NetworkDoesEntityExistWithNetworkId(netId:Number):Bool;
	static function NetworkDoesNetworkIdExist(netId:Number):Bool;
	static function NetworkDoesTunableExist(tunableContext:String, tunableName:String):Bool;
	static function NetworkDoesTunableExistHash(tunableContext:Number, tunableName:Number):Bool;
	static function N_0xe4e53e1419d81127(tunableContext:Number, tunableName:Number):Bool;
	...
	static function NetworkEarnFromChallengeWin(p0:Number, p2:Bool):Number;
	static function N_0x2b171e6b2f64d8df(p0:Number, p2:Bool):Number;
	...
	static function NetworkEntityAreaDoesExist(areaHandle:Number):Bool;
	static function N_0xe64a3ca08dfa37a9(areaHandle:Number):Bool;
	static function NetworkEntityAreaIsOccupied(areaHandle:Number):Bool;
	static function N_0x4a2d4e8bf4265b0f(areaHandle:Number):Bool;
	static function NetworkExplodeHeli(heli:Number, isAudible:Bool, isInvisible:Bool, netScriptEntityId:Number):Void;
	static function N_0x2a5e0621dd815a9a(heli:Number, isAudible:Bool, isInvisible:Bool, netScriptEntityId:Number):Void;
	static function NetworkExplodeVehicle(vehicle:Number, isAudible:Bool, isInvisible:Bool, p3:Bool):Void;
	static function NetworkFadeInEntity(entity:Number, state:Bool):Void;
	static function NetworkFadeOutEntity(entity:Number, normal:Bool, slow:Bool):Void;
	static function NetworkFindGamersInCrew(p0:Number):Bool;
	static function N_0xe532d6811b3a4d2a(p0:Number):Bool;
	static function NetworkXAffectsGamers(p0:Number):Bool;
	static function NetworkFindMatchedGamers(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	static function N_0xf7b2cfde5c9f700d(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	...
	static function NetworkGetActivityPlayerNum(p0:Bool):Number;
	...
	static function NetworkGetEntityIsLocal(entity:Number):Bool;
	static function NetworkGetEntityIsNetworked(entity:Number):Bool;
	static function N_0xc7827959479dcc78(entity:Number):Bool;
	...
	static function N_0x2cc848a861d01493():Bool;
	...
	static function NetworkGetPlayerOwnsWaypoint(player:Number):Bool;
	static function N_0x82377b65e943f72d(player:Number):Bool;
	...
	static function NetworkGetPresenceInviteFromAdmin(p0:Number):Bool;
	static function N_0x3dbf2df0aeb7d289(p0:Number):Bool;
	...
	static function NetworkGetPresenceInviteIsTournament(p0:Number):Bool;
	static function N_0x8806cebfabd3ce05(p0:Number):Bool;
	...
	static function NetworkGetRosPrivilege_24():Bool;
	static function N_0x593570c289a77688():Bool;
	static function NetworkGetRosPrivilege_25():Bool;
	static function N_0x91b87c55093de351():Bool;
	static function NetworkGetRosPrivilege_9():Bool;
	static function N_0x66b59cffd78467af():Bool;
	...
	static function NetworkGetVcBankBalanceIsNotLessThan(amount:Number):Bool;
	static function NetworkGetVcBankWalletBalanceIsNotLessThan(amount:Number, characterSlot:Number):Bool;
	static function N_0xdc18531d7019a535(amount:Number, characterSlot:Number):Bool;
	...
	static function NetworkGetVcWalletBalanceIsNotLessThan(amount:Number, characterSlot:Number):Bool;
	...
	static function N_0x1353f87e89946207():Bool;
	static function NetworkHasCachedPlayerHeadBlendData(player:Number):Bool;
	static function N_0x237d5336a9a54108(player:Number):Bool;
	static function NetworkHasControlOfDoor(doorHash:Number):Bool;
	static function NetworkHasControlOfEntity(entity:Number):Bool;
	static function NetworkHasControlOfNetworkId(netId:Number):Bool;
	static function NetworkHasControlOfPickup(pickup:Number):Bool;
	static function NetworkHasEntityBeenRegisteredWithThisThread(entity:Number):Bool;
	static function N_0xb07d3185e11657a5(entity:Number):Bool;
	static function NetworkHasFollowInvite():Bool;
	static function N_0x76d9b976c4c09fde():Bool;
	static function NetworkHasGameBeenAltered():Bool;
	static function N_0x659cf2ef7f550c4f():Bool;
	...
	static function NetworkHasPlayerStartedTransition(player:Number):Bool;
	static function NetworkHasReceivedHostBroadcastData():Bool;
	static function N_0x5d10b3795f3fc886():Bool;
	static function NetworkHasRosPrivilege(index:Number):Bool;
	static function N_0xa699957e60d80214(index:Number):Bool;
	...
	static function N_0x67a5589628e0cff6():Bool;
	static function NetworkHasSocialNetworkingSharingPriv():Bool;
	static function N_0x76bf03fadbf154f5():Bool;
	...
	static function N_0x85443ff4c328f53b():Bool;
	static function NetworkAreRosAvailable():Bool;
	static function NetworkHaveJustUploadLater():Bool;
	...
	static function NetworkHaveCommunicationPrivileges(p0:Number, player:Number):Bool;
	static function N_0xaeef48cdf5b6ce7c(p0:Number, player:Number):Bool;
	static function NetworkHaveOnlinePrivilege_2():Bool;
	static function N_0x5ea784d197556507():Bool;
	static function NetworkHaveOnlinePrivileges():Bool;
	static function NetworkHaveRosBannedPriv():Bool;
	static function IsRockstarBanned():Bool;
	static function NetworkHasPlayerBeenBanned():Bool;
	static function NetworkHaveRosCreateTicketPriv():Bool;
	static function IsSocialclubBanned():Bool;
	static function NetworkHaveSocialClubPrivilege():Bool;
	static function NetworkHaveRosLeaderboardWritePriv():Bool;
	static function N_0x422d396f80a96547():Bool;
	static function NetworkGetRosPrivilege_4():Bool;
	static function NetworkHaveRosMultiplayerPriv():Bool;
	static function IsPlayerBanned():Bool;
	static function CanPlayOnline():Bool;
	static function NetworkGetRosPrivilege_3():Bool;
	static function NetworkHaveRosSocialClubPriv():Bool;
	static function N_0x606e4d3e3cccf3eb():Bool;
	static function NetworkGetRosPrivilege_10():Bool;
	static function NetworkHaveUserContentPrivileges(p0:Number):Bool;
	static function N_0x72d918c99bcacc54(p0:Number):Bool;
	static function NetworkHostTransition(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Bool, p6:Bool, p7:Number, p8:Number, p9:Number):Bool;
	...
	static function N_0xeffb25453d8600f9():Bool;
	...
	static function N_0xd7c95d322ff57522():Bool;
	static function NetworkIsCloudAvailable():Bool;
	static function NetworkIsCloudBackgroundScriptRequestPending():Bool;
	static function N_0x8132c0eb8b2b3293():Bool;
	static function HasBgScriptBeenDownloaded():Bool;
	static function NetworkIsCloudBackgroundScriptsRequestPending():Bool;
	static function NetworkIsConnectionEndpointRelayServer(player:Number):Bool;
	static function N_0x16d3d49902f697bb(player:Number):Bool;
	static function NetworkIsDoorNetworked(doorHash:Number):Bool;
	static function N_0xc01e93fac20c3346(doorHash:Number):Bool;
	static function NetworkHasControlOfPavementStats(doorHash:Number):Bool;
	static function NetworkIsEntityConcealed(entity:Number):Bool;
	static function NetworkIsEntityFading(entity:Number):Bool;
	static function N_0x422f32cc7e56abad(entity:Number):Bool;
	...
	static function NetworkIsFriendIndexOnline(friendIndex:Number):Bool;
	static function N_0xbad8f2a42b844821(friendIndex:Number):Bool;
	...
	static function N_0x94a8394d150b013a():Bool;
	...
	static function N_0x2fc5650b0271cb57():Bool;
	static function NetworkIsInPlatformPartyChat():Bool;
	static function N_0xfd8b834a8ba05048():Bool;
	...
	static function N_0xc0d2af00bcc234ca():Bool;
	static function NetworkIsMultiplayerDisabled():Bool;
	static function N_0x9747292807126eda():Bool;
	static function NetworkIsNetworkIdAClone(netId:Number):Bool;
	static function N_0x7242f8b741ce1086(netId:Number):Bool;
	static function NetworkIsOfflineInvitePending():Bool;
	static function N_0x74698374c45701d2():Bool;
	static function NetworkIsParticipantActive(p0:Number):Bool;
	...
	static function NetworkIsPlayerAParticipant(player:Number):Bool;
	static function NetworkIsPlayerAParticipantOnScript(player1:Number, script:String, player2:Number):Bool;
	static function N_0x1ad5b71586b94820(player1:Number, script:String, player2:Number):Bool;
	static function NetworkIsPlayerActive(player:Number):Bool;
	static function NetworkIsPlayerBlockedByMe(player:Number):Bool;
	static function NetworkIsPlayerConcealed(player:Number):Bool;
	static function NetworkIsPlayerConnected(player:Number):Bool;
	static function NetworkIsPlayerEqualToIndex(player:Number, index:Number):Bool;
	static function N_0x9de986fc9a87c474(player:Number, index:Number):Bool;
	static function NetworkIsPlayerFading(player:Number):Bool;
	static function N_0x631dc5dff4b110e3(player:Number):Bool;
	static function NetworkIsPlayerInMpCutscene(player:Number):Bool;
	static function NetworkIsPlayerMutedByMe(player:Number):Bool;
	static function NetworkIsPlayerTalking(player:Number):Bool;
	static function NetworkIsPsnAvailable():Bool;
	static function N_0x8d11e61a4abf49cc():Bool;
	static function NetworkIsScriptActive(scriptName:String, player:Number, p2:Bool, p3:Number):Bool;
	static function NetworkIsScriptActiveByHash(scriptHash:Number, p1:Number, p2:Bool, p3:Number):Bool;
	...
	static function NetworkIsThisScriptMarked(p0:Number, p1:Bool, p2:Number):Bool;
	static function N_0xd1110739eeadb592(p0:Number, p1:Bool, p2:Number):Bool;
	static function NetworkSetThisScriptMarked(p0:Number, p1:Bool, p2:Number):Bool;
	static function NetworkIsTransitionBusy():Bool;
	static function NetworkIsTransitionClosedCrew():Bool;
	static function N_0x0dbd5d7e3c5bec3b():Bool;
	static function NetworkIsTransitionClosedFriends():Bool;
	static function N_0x6512765e3be78c50():Bool;
	...
	static function N_0x292564c735375edf():Bool;
	static function NetworkIsTransitionOpenToMatchmaking():Bool;
	static function N_0x37a4494483b9f5c9():Bool;
	static function NetworkIsTransitionPrivate():Bool;
	static function N_0x5a6aa44ff8e931e6():Bool;
	static function NetworkIsTransitionSolo():Bool;
	static function N_0x5dc577201723960a():Bool;
	...
	static function N_0xd0a484cb2f829fbe():Bool;
	static function NetworkIsTunableCloudRequestPending():Bool;
	static function N_0x0467c11ed88b7d28():Bool;
	static function HasTunablesBeenDownloaded():Bool;
	static function NetworkIsTutorialSessionChangePending():Bool;
	static function N_0x35f0b98a8387274d():Bool;
	...
	static function N_0x59df79317f85a7e0():Bool;
	static function NetworkJoinPreviouslyFailedTransition():Bool;
	static function N_0xffe1e5b792d92b34():Bool;
	static function NetworkJoinTransition(player:Number):Bool;
	...
	static function NetworkMoneyCanBet(amount:Number, p1:Bool, p2:Bool):Bool;
	static function N_0x81404f3dc124fe5b(amount:Number, p1:Bool, p2:Bool):Bool;
	static function NetworkOpenTransitionMatchmaking():Void;
	static function N_0x2b3a8f7ca3a38fde():Void;
	static function NetworkOverrideChatRestrictions(player:Number, toggle:Bool):Void;
	static function N_0x3039ae5ad2c9c0c4(player:Number, toggle:Bool):Void;
	...
	static function NetworkOverrideReceiveRestrictions(player:Number, toggle:Bool):Void;
	static function N_0xddf73e2b1fec5ab4(player:Number, toggle:Bool):Void;
	static function NetworkOverrideReceiveRestrictionsAll(toggle:Bool):Void;
	static function N_0x0ff2862b61a58af9(toggle:Bool):Void;
	static function NetworkOverrideSendRestrictions(player:Number, toggle:Bool):Void;
	static function N_0x97dd4c5944cc2e6a(player:Number, toggle:Bool):Void;
	static function NetworkOverrideSendRestrictionsAll(toggle:Bool):Void;
	static function N_0x57b192b4d4ad23d5(toggle:Bool):Void;
	static function NetworkChatMute(toggle:Bool):Void;
	static function NetworkOverrideTeamRestrictions(team:Number, toggle:Bool):Void;
	static function N_0x6f697a66ce78674e(team:Number, toggle:Bool):Void;
	static function NetworkOverrideTransitionChat(p0:Bool):Void;
	static function N_0xaf66059a131aa269(p0:Bool):Void;
	static function NetworkPayEmployeeWage(p0:Number, p1:Bool, p2:Bool):Void;
	static function N_0x5fd5ed82cbbe9989(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkPayMatchEntryFee(amount:Number, matchId:String, p2:Bool, p3:Bool):Void;
	static function N_0x9346e14f2af74d46(amount:Number, matchId:String, p2:Bool, p3:Bool):Void;
	static function NetworkPayUtilityBill(amount:Number, p1:Bool, p2:Bool):Void;
	static function N_0xafe08b35ec0c9eae(amount:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkPlayerGetUserId(player:Number, userID:Number):NetworkPlayerGetUserIdReturnType;
	static function NetworkPlayerHasHeadset(player:Number):Bool;
	static function NetworkPlayerIdToInt():Number;
	static function NetworkPlayerIndexIsCheater(player:Number):Bool;
	static function N_0x565e430db3b05bec(player:Number):Bool;
	static function NetworkPlayerSomething(player:Number):Bool;
	static function NetworkPlayerIsBadsport():Bool;
	static function NetworkPlayerIsCheater():Bool;
	static function NetworkPlayerIsRockstarDev(player:Number):Bool;
	...
	static function NetworkRefundCash(index:Number, context:String, reason:String, unk:Bool):Void;
	static function N_0xf9c812cd7c46e817(index:Number, context:String, reason:String, unk:Bool):Void;
	...
	static function NetworkRemoveEntityArea(p0:Number):Bool;
	static function NetworkRemovePresenceInvite(p0:Number):Bool;
	static function N_0xf0210268db0974b1(p0:Number):Bool;
	...
	static function N_0x924426bffd82e915():Bool;
	static function NetworkRequestCloudTunables():Void;
	static function N_0x42fb3b532d526e6c():Void;
	static function NetworkRequestControlOfDoor(doorID:Number):Bool;
	static function NetworkRequestControlOfEntity(entity:Number):Bool;
	static function NetworkRequestControlOfNetworkId(netId:Number):Bool;
	static function NetworkResetBodyTracker():Void;
	static function NetworkRespawnCoords(player:Number, x:Number, y:Number, z:Number, p4:Bool, p5:Bool):Void;
	static function N_0x9769f811d1785b03(player:Number, x:Number, y:Number, z:Number, p4:Bool, p5:Bool):Void;
	static function NetworkResurrectLocalPlayer(x:Number, y:Number, z:Number, heading:Number, unk:Bool, changetime:Bool):Void;
	...
	static function NetworkSendTransitionGamerInstruction(p1:String, p2:Number, p3:Number, p4:Bool):NetworkSendTransitionGamerInstructionReturnType;
	static function NetworkSessionActivityQuickmatch(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	static function N_0xbe3e347a87aceb82(p0:Number, p1:Number, p2:Number, p3:Number):Bool;
	...
	static function N_0xa73667484d7037c3(toggle:Bool):Void;
	static function NetworkSessionCancelInvite():Void;
	static function NetworkSessionChangeSlots(p0:Number, p1:Bool):Void;
	static function N_0xb4ab419e0d86acae(p0:Number, p1:Bool):Void;
	static function NetworkSessionCrewMatchmaking(p0:Number, p1:Number, p2:Number, maxPlayers:Number, p4:Bool):Bool;
	static function N_0x94bc51e9449d917f(p0:Number, p1:Number, p2:Number, maxPlayers:Number, p4:Bool):Bool;
	...
	static function NetworkSessionFriendMatchmaking(p0:Number, p1:Number, maxPlayers:Number, p3:Bool):Bool;
	static function N_0x2cfc76e0d087c994(p0:Number, p1:Number, maxPlayers:Number, p3:Bool):Bool;
	static function NetworkSessionGetInviter(networkHandle:Number):Void;
	static function NetworkSessionGetKickVote(player:Number):Bool;
	static function NetworkSessionArePlayersVotingToKick(player:Number):Bool;
	static function NetworkSessionIsPlayerVotedToKick(player:Number):Bool;
	...
	static function NetworkSessionHost(p0:Number, maxPlayers:Number, p2:Bool):Bool;
	static function NetworkSessionHostClosed(p0:Number, maxPlayers:Number):Bool;
	static function N_0xed34c0c02c098bb7(p0:Number, maxPlayers:Number):Bool;
	static function NetworkSessionHostFriendsOnly(p0:Number, maxPlayers:Number):Bool;
	static function NetworkSessionHostSinglePlayer(p0:Number):Void;
	static function NetworkSessionIsClosedCrew():Bool;
	static function N_0x74732c6ca90da2b4():Bool;
	static function NetworkSessionIsClosedFriends():Bool;
	static function N_0xfbcfa2ea2e206890():Bool;
	static function NetworkSessionIsInVoiceSession():Bool;
	static function N_0x855bc38818f6f684():Bool;
	static function NetworkSessionIsPrivate():Bool;
	static function N_0xcef70aa5b3f89ba1():Bool;
	static function NetworkSessionIsSolo():Bool;
	static function N_0xf3929c2379b60cce():Bool;
	static function NetworkSessionIsVisible():Bool;
	static function N_0xba416d68c631496a():Bool;
	static function NetworkSessionIsVoiceSessionBusy():Bool;
	static function N_0xef0912ddf7c4cb4b():Bool;
	...
	static function N_0x271cc6ab59ebf9a5(toggle:Bool):Void;
	...
	static function N_0x3f52e880aaf6c8ca(p0:Bool):Void;
	static function NetworkSessionValidateJoin(p0:Bool):Void;
	static function N_0xc19f6c8e7865a6ff(p0:Bool):Void;
	static function NetworkSessionHosted(p0:Bool):Void;
	...
	static function NetworkSessionVoiceRespondToRequest(p0:Bool, p1:Number):Void;
	static function NetworkSetKeepFocuspoint(p0:Bool, p1:Number):Void;
	...
	static function N_0x23dfb504655d0ce4():Bool;
	...
	static function NetworkSetChoiceMigrateOptions(toggle:Bool, player:Number):Void;
	static function N_0x5c707a667df8b9fa(toggle:Bool, player:Number):Void;
	...
	static function NetworkSetEntityCanBlend(entity:Number, toggle:Bool):Void;
	static function NetworkSetEntityGhostedWithOwner(entity:Number, p1:Bool):Void;
	static function N_0x4ba166079d658ed4(entity:Number, p1:Bool):Void;
	static function NetworkSetEntityInvisibleToNetwork(entity:Number, toggle:Bool):Void;
	static function N_0xf1ca12b18aef5298(entity:Number, toggle:Bool):Void;
	static function NetworkSetEntityVisibleToNetwork(entity:Number, toggle:Bool):Void;
	...
	static function N_0xfc18db55ae19e046(toggle:Bool):Void;
	static function NetworkSetInMpCutscene(p0:Bool, p1:Bool):Void;
	static function NetworkSetInSpectatorMode(toggle:Bool, playerPed:Number):Void;
	static function NetworkSetInSpectatorModeExtended(toggle:Bool, playerPed:Number, p2:Bool):Void;
	static function N_0x419594e137637120(toggle:Bool, playerPed:Number, p2:Bool):Void;
	...
	static function N_0x524ff0aeff9c3973(toggle:Bool):Void;
	static function NetworkSetMissionFinished():Void;
	static function NetworkSetNoSpectatorChat(toggle:Bool):Void;
	static function N_0xf46a1e03e8755980(toggle:Bool):Void;
	static function NetworkSetObjectForceStaticBlend(object:Number, enabled:Bool):Void;
	static function N_0x0379daf89ba09aa5(object:Number, enabled:Bool):Void;
	...
	static function N_0x1b857666604b1a74(toggle:Bool):Void;
	...
	static function N_0x7ac752103856fb20(toggle:Bool):Void;
	static function NetworkSetTalkerProximity(value:Number):Void;
	static function NetworkSetTeamOnlyChat(toggle:Bool):Void;
	static function NetworkSetThisScriptIsNetworkScript(maxNumMissionParticipants:Number, p1:Bool, instanceId:Number):Void;
	...
	static function N_0x0c978fda19692c2c(p0:Bool, p1:Bool):Void;
	static function NetworkSetVehicleTestDrive(toggle:Bool):Void;
	static function NetworkSetVehicleWheelsDestructible(vehicle:Number, toggle:Bool):Void;
	static function N_0x890e2c5abed7236d(vehicle:Number, toggle:Bool):Void;
	...
	static function N_0x82a2b386716608f1():Bool;
	static function NetworkShowProfileUi(networkHandle:Number):Void;
	static function NetworkSpentAmmoDrop(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentArenaJoinSpectator(amount:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentArenaPremium(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentArenaSpectatorBox(amount:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentArrestBail(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentBallisticEquipment(amount:Number, p1:Bool, p2:Bool):Void;
	static function N_0x5d97630a8a0ef123(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBankInterest(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBeachPartyGeneric(p0:Number):Void;
	static function NetworkSpentBetting(amount:Number, p1:Number, matchId:String, p3:Bool, p4:Bool):Void;
	static function NetworkSpentBikeShopModify(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function NetworkSpentBoatPickup(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBoss():Bool;
	static function N_0xffbe02cd385356bd():Bool;
	static function NetworkSpentBounty(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBountyHunterMission(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBullShark(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentBuyArena(amount:Number, p1:Bool, p2:Bool, p3:String):Void;
	...
	static function NetworkSpentBuyCasino(amount:Number, p1:Bool, p2:Bool, data:Number):Number;
	static function NetworkSpentBuyOfftheradar(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBuyPassiveMode(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentBuyRevealPlayers(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentBuyWantedlevel(p0:Number, p2:Bool, p3:Bool):Number;
	static function NetworkSpentCallPlayer(p0:Number, p2:Bool, p3:Bool):Number;
	static function NetworkSpentCarclub(p0:Number, p1:Bool, p2:Bool, p3:Number):Void;
	static function N_0x925227803a0eaa1b(p0:Number, p1:Bool, p2:Bool, p3:Number):Void;
	...
	static function NetworkSpentCarwash(p0:Number, p1:Number, p2:Number, p3:Bool, p4:Bool):Void;
	static function NetworkSpentCashDrop(amount:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentCasinoMembership(amount:Number, p1:Bool, p2:Bool, p3:Number):Void;
	static function NetworkSpentCinema(p0:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentEmployAssassins(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function NetworkSpentFromBank(p0:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function N_0xb9f7a469460e7a4a(p0:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function NetworkSpentFromRockstar(bank:Number, p1:Bool, p2:Bool):Void;
	static function N_0x6a445b64ed7abeb5(bank:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentGangopsStartStrand(_type:Number, amount:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentGangopsTripSkip(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentGunrunningContactService(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function NetworkSpentHangarStaffCharges(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentHangarUtilityCharges(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentHeliPickup(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentHireMercenary(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentHireMugger(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentHoldups(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentInStripclub(p0:Number, p1:Bool, p2:Number, p3:Bool):Void;
	static function N_0xee99784e4467689c(p0:Number, p1:Bool, p2:Number, p3:Bool):Void;
	static function NetworkSpentIslandHeist(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function NetworkSpentJobSkip(amount:Number, matchId:String, p2:Bool, p3:Bool):Void;
	...
	static function NetworkSpentMakeItRain(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentMoveYacht(amount:Number, p1:Bool, p2:Bool):Void;
	static function N_0xe7df4e0545dfb56e(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentNightclubBarDrink(amount:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentNightclubEntryFee(player:Number, amount:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentNoCops(p0:Number, p1:Bool, p2:Bool):Void;
	static function N_0xd5bb406f4e04019f(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function NetworkSpentPayVehicleInsurancePremium(amount:Number, vehicleModel:Number, notBankrupt:Bool, hasTheMoney:Bool):Number;
	static function NetworkSpentPlayerHealthcare(p0:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function N_0x7c99101f7fce2ee5(p0:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentProstitutes(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentPurchaseHangar(p0:Number, p1:Number, p2:Number, p3:Number):Void;
	static function NetworkSpentPurchaseWarehouse(amount:Number, data:Number, p2:Bool, p3:Bool):Void;
	static function N_0x33981d6804e62f49(amount:Number, data:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentRdrhatchetBonus(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentRehireDj(amount:Number, p1:Number, p2:Bool, p3:Bool):Void;
	...
	static function NetworkSpentRequestHeist(p0:Number, p1:Bool, p2:Bool):Void;
	static function N_0x9d26502bb97bfe62(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentRequestJob(p0:Number, p1:Bool, p2:Bool):Void;
	static function N_0x8204da7934df3155(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentRobbedByMugger(amount:Number, p1:Bool, p2:Bool):Void;
	static function N_0x995a65f15f581359(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentSalesDisplay(p0:Bool):Void;
	static function NetworkSpentSpinTheWheelPayment(amount:Number, p1:Number, p2:Bool, p3:Bool):Void;
	static function NetworkSpentSubmarine(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number):Void;
	static function NetworkSpentTaxi(amount:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentTelescope(p0:Number, p1:Bool, p2:Bool):Void;
	static function NetworkSpentUpgradeArena(amount:Number, p1:Bool, p2:Bool, p3:String):Void;
	...
	static function NetworkSpentUpgradeCasino(amount:Number, p1:Bool, p2:Bool, data:Number):Number;
	...
	static function NetworkStartRespawnSearchForPlayer(player:Number, x:Number, y:Number, z:Number, radius:Number, p5:Number, p6:Number, p7:Number,
		flags:Number):Bool;
	static function N_0x5a6ffa2433e2f14c(player:Number, x:Number, y:Number, z:Number, radius:Number, p5:Number, p6:Number, p7:Number, flags:Number):Bool;
	static function NetworkStartRespawnSearchInAngledAreaForPlayer(player:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number,
		width:Number, p8:Number, p9:Number, p10:Number, flags:Number):Bool;
	...
	static function NetworkTryAccessTunableBoolHash(tunableContext:Number, tunableName:Number, defaultValue:Bool):Bool;
	static function N_0xc7420099936ce286(tunableContext:Number, tunableName:Number, defaultValue:Bool):Bool;
	static function NetworkAccessTunableBoolHashFailVal(tunableContext:Number, tunableName:Number, defaultValue:Bool):Bool;
	...
	static function NetworkUseHighPrecisionBlending(netID:Number, toggle:Bool):Void;
	static function N_0x2b1813aba29016c5(netID:Number, toggle:Bool):Void;
	static function NetworkSetNetworkIdDynamic(netID:Number, toggle:Bool):Void;
	static function NetworkUseHighPrecisionVehicleBlending(vehicle:Number, toggle:Bool):Void;
	static function N_0xec0c1d4922af9754(vehicle:Number, toggle:Bool):Void;
	...
	static function NewLoadSceneStart(posX:Number, posY:Number, posZ:Number, offsetX:Number, offsetY:Number, offsetZ:Number, radius:Number, p7:Number):Bool;
	static function NewLoadSceneStartSphere(x:Number, y:Number, z:Number, radius:Number, p4:Number):Bool;
	static function N_0xaccfb4acf53551b0(x:Number, y:Number, z:Number, radius:Number, p4:Number):Bool;
	...
	static function OverrideMicrophoneSettings(hash:Number, toggle:Bool):Void;
	static function N_0x75773e11ba459e90(hash:Number, toggle:Bool):Void;
	...
	static function OverridePedBadgeTexture(ped:Number, txd:String, txn:String):Bool;
	static function N_0x95eb5e34f821babe(ped:Number, txd:String, txn:String):Bool;
	static function OverridePedsCanStandOnTopFlag(flag:Bool):Void;
	static function OverridePlayerGroundMaterial(hash:Number, toggle:Bool):Void;
	static function N_0xd2cc78cd3d0b50f9(hash:Number, toggle:Bool):Void;
	...
	static function OverrideSaveHouse(p0:Bool, p1:Number, p2:Number, p3:Number, p4:Number, p5:Bool):OverrideSaveHouseReturnType;
	static function OverrideTrevorRage(voiceEffect:String):Void;
	static function OverrideUnderwaterStream(p1:Bool):Number;
	static function OverrideVehHorn(vehicle:Number, _override:Bool, hornHash:Number):Void;
	static function OverrideVehiclePedsCanStandOnTopFlag(vehicle:Number, can:Bool):Void;
	static function ParticipantId():Number;
	static function ParticipantIdToInt():Number;
	static function PassKeyboardInputToScaleform(scaleformHandle:Number):Bool;
	static function N_0xd1c7cb175e012964(scaleformHandle:Number):Bool;
	...
	static function DisableAutomaticRespawn(toggle:Bool):Void;
	...
	static function N_0x9245e81072704b8a(toggle:Bool):Void;
	...
	static function PauseMenuIsContextActive(contextHash:Number):Bool;
	static function N_0x84698ab38d0c6636(contextHash:Number):Bool;
	...
	static function PauseMenuSetBusySpinner(p0:Bool, p1:Number, p2:Number):Void;
	static function N_0xc78e239ac5b2ddb9(p0:Bool, p1:Number, p2:Number):Void;
	static function PauseMenuSetWarnOnTabChange(setWarn:Bool):Void;
	static function N_0xf06ebb91a81e09e3(setWarn:Bool):Void;
	...
	static function PedHasUseScenarioTask(ped:Number):Bool;
	...
	static function PlaceObjectOnGroundProperly(object:Number):Bool;
	static function PlaceObjectOnGroundProperly_2(object:Number):Bool;
	static function N_0xd76eeef746057fd6(object:Number):Bool;
	...
	static function PlayEntityAnim(entity:Number, animName:String, animDict:String, p3:Number, loop:Bool, stayInAnim:Bool, p6:Bool, delta:Number,
		bitset:Number):Bool;
	...
	static function PlayPedAmbientSpeechWithVoiceNative(ped:Number, speechName:String, voiceName:String, speechParam:String, p4:Bool):Void;
	static function PlayAmbientSpeechWithVoice(ped:Number, speechName:String, voiceName:String, speechParam:String, p4:Bool):Void;
	static function PlayPedRingtone(ringtoneName:String, ped:Number, p2:Bool):Void;
	static function PlayPoliceReport(name:String, p1:Number):Number;
	static function PlaySound(soundId:Number, audioName:String, audioRef:String, p3:Bool, p4:Number, p5:Bool):Void;
	static function PlaySoundFromCoord(soundId:Number, audioName:String, x:Number, y:Number, z:Number, audioRef:String, isNetwork:Bool, range:Number,
		p8:Bool):Void;
	static function PlaySoundFromEntity(soundId:Number, audioName:String, entity:Number, audioRef:String, isNetwork:Bool, p5:Number):Void;
	static function PlaySoundFrontend(soundId:Number, audioName:String, audioRef:String, p3:Bool):Void;
	...
	static function PlaySynchronizedAudioEvent(p0:Number):Bool;
	static function PlaySynchronizedCamAnim(camera:Number, scene:Number, animName:String, animDictionary:String):Bool;
	...
	static function PlayTennisDiveAnim(ped:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Bool):Void;
	static function N_0x8fa9c42fc5d7c64b(ped:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Bool):Void;
	static function PlayTennisSwingAnim(ped:Number, animDict:String, animName:String, p3:Number, p4:Number, p5:Bool):Void;
	static function N_0xe266ed23311f24d4(ped:Number, animDict:String, animName:String, p3:Number, p4:Number, p5:Bool):Void;
	...
	static function PlaystatsMissionOver(p1:Number, p2:Number, p3:Bool, p4:Bool, p5:Bool):Number;
	static function PlaystatsMissionStarted(p1:Number, p2:Number, p3:Bool):Number;
	static function PlaystatsNpcInvite(p0:Number):Void;
	static function PlaystatsOddjobDone(p0:Number, p1:Number, p2:Number):Void;
	static function PlaystatsPassiveMode(p0:Bool, p1:Number, p2:Number, p3:Number):Void;
	...
	static function PointCamAtEntity(cam:Number, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number, p5:Bool):Void;
	static function PointCamAtPedBone(cam:Number, ped:Number, boneIndex:Number, x:Number, y:Number, z:Number, p6:Bool):Void;
	...
	static function PreventCollectionOfPortablePickup(object:Number, p1:Bool, p2:Bool):Void;
	static function N_0x92aefb5f6e294023(object:Number, p1:Bool, p2:Bool):Void;
	...
	static function N_0x72de52178c291cb5():Bool;
	static function QueueMissionRepeatSave():Bool;
	static function N_0x44a0bdc559b35f6e():Bool;
	...
	static function N_0x5354c5ba2ea868a4(toggle:Bool):Void;
	static function SetMapFullScreen(toggle:Bool):Void;
	static function RaceGalleryNextBlipSprite(spriteId:Number):Void;
	static function N_0x1eae6dd17b7a5efa(spriteId:Number):Void;
	static function RaiseConvertibleRoof(vehicle:Number, instantlyRaise:Bool):Void;
	...
	static function RefillAmmoInstantly(ped:Number):Bool;
	static function PedSkipNextReloading(ped:Number):Bool;
	static function RefreshInterior(interiorID:Number):Void;
	static function RefreshPlayerListStats(p0:Number):Bool;
	static function UsingNetworkWeapontype(p0:Number):Bool;
	static function N_0xe26ccff8094d8c74(p0:Number):Bool;
	...
	static function RegisterCommand(commandName:String, handler:Int, restricted:Bool):Void;
	...
	static function N_0x472841a026d26d8b():Bool;
	static function RemoveActionModeAsset(asset:String):Void;
	static function RemoveAirDefenseZone(zoneId:Number):Bool;
	static function N_0x0abf535877897560(zoneId:Number):Bool;
	...
	static function RemoveAllPedWeapons(ped:Number, p1:Bool):Void;
	static function RemoveAllPickupsOfType(pickupHash:Number):Void;
	static function RemoveAllProjectilesOfType(weaponHash:Number, explode:Bool):Void;
	...
	static function RemoveModelHide(x:Number, y:Number, z:Number, radius:Number, model:Number, p5:Bool):Void;
	static function RemoveModelSwap(x:Number, y:Number, z:Number, radius:Number, originalModel:Number, newModel:Number, p6:Bool):Void;
	...
	static function RemoveParticleFx(ptfxHandle:Number, p1:Bool):Void;
	...
	static function RemovePedDefensiveArea(ped:Number, toggle:Bool):Void;
	static function RemovePedElegantly(ped:Number):Void;
	static function RemovePedFromGroup(ped:Number):Void;
	static function RemovePedHelmet(ped:Number, instantly:Bool):Void;
	...
	static function RemovePlayerHelmet(player:Number, p2:Bool):Void;
	static function RemovePopMultiplierArea(id:Number, p1:Bool):Void;
	static function N_0xb129e447a2eda4bf(id:Number, p1:Bool):Void;
	static function RemovePopMultiplierSphere(id:Number, p1:Bool):Void;
	static function N_0xe6869becdd8f2403(id:Number, p1:Bool):Void;
	...
	static function RemoveRoadNodeSpeedZone(speedzone:Number):Bool;
	static function N_0x1033371fc8e842a7(speedzone:Number):Bool;
	static function RemoveSpeedZone(speedzone:Number):Bool;
	...
	static function RemoveScenarioBlockingArea(p0:Number, p1:Bool):Void;
	static function RemoveScenarioBlockingAreas():Void;
	static function RemoveScriptFire(fireHandle:Number):Void;
	static function RemoveShockingEvent(event:Number):Bool;
	static function RemoveShockingEventSpawnBlockingAreas():Void;
	static function RemoveStateBagChangeHandler(cookie:Number):Void;
	static function RemoveStealthKill(hash:Number, p1:Bool):Void;
	static function N_0xa6a12939f16d85be(hash:Number, p1:Bool):Void;
	...
	static function RenderScriptCams(render:Bool, ease:Bool, easeTime:Number, p3:Bool, p4:Bool):Void;
	...
	static function RequestCommerceItemImage(index:Number):Bool;
	static function N_0xa2f952104fc6dd4b(index:Number):Bool;
	...
	static function RequestPathsPreferAccurateBoundingstruct(x1:Number, y1:Number, x2:Number, y2:Number):Bool;
	static function N_0x07fb139b592fa687(x1:Number, y1:Number, x2:Number, y2:Number):Bool;
	static function RequestPedVehicleVisibilityTracking(ped:Number, p1:Bool):Void;
	static function GetPedFloodInvincibility(ped:Number, p1:Bool):Void;
	static function RequestPedVisibilityTracking(ped:Number):Void;
	static function N_0x7d7a2e43e74e2eb8(ped:Number):Void;
	static function RequestPedheadshotImgUpload(id:Number):Bool;
	static function N_0xf0daef2f545bee25(id:Number):Bool;
	...
	static function RequestTaskMoveNetworkStateTransition(ped:Number, name:String):Bool;
	static function N_0xd01015c7316ae176(ped:Number, name:String):Bool;
	...
	static function ResetMapdataEntityMatrix(mapDataHash:Number, entityInternalIdx:Number):Bool;
	...
	static function ResetVehicleWheels(vehicle:Number, toggle:Bool):Void;
	...
	static function RopeDrawShadowEnabled(toggle:Bool):Number;
	...
	static function SaveHighQualityPhoto(unused:Number):Bool;
	static function N_0x3dec726c25a11bac(unused:Number):Bool;
	static function SaveRecordingClip():Bool;
	static function N_0x644546ec5287471b():Bool;
	...
	static function N_0x8416fe4e4629d7d7(name:String):Bool;
	static function ScGetIsProfileAttributeSet(name:String):Bool;
	...
	static function ScGetHasAchievementBeenPassed(achievement:Number):Bool;
	static function N_0x418dc16fae452c1c(achievement:Number):Bool;
	...
	static function ScInboxGetMessageIsReadAtIndex(msgIndex:Number):Bool;
	static function N_0x93028f1db42bfd08(msgIndex:Number):Bool;
	static function IsScInboxValid(msgIndex:Number):Bool;
	...
	static function ScInboxMessageDoApply(p0:Number):Bool;
	static function N_0x9a2c8064b6c1e41a(p0:Number):Bool;
	static function ScInboxMessagePush(p0:Number):Bool;
	...
	static function ScInboxMessageGetDataBool(p0:Number, p1:String):Bool;
	static function N_0xffe5c16f402d851d(p0:Number, p1:String):Bool;
	static function ScInboxMessageGetDataInt(p0:Number, context:String, out:Number):ScInboxMessageGetDataIntReturnType;
	static function ScInboxMessageGetDataString(p0:Number, context:String, out:String):Bool;
	...
	static function ScInboxMessagePop(p0:Number):Bool;
	static function N_0x2c015348cf19ca1d(p0:Number):Bool;
	...
	static function N_0x6afd2cd753feef83(data:String):Bool;
	...
	static function ScLicenseplateGetAddIsPending(token:Number):Bool;
	static function N_0x07c61676e5bb52cd(token:Number):Bool;
	...
	static function ScLicenseplateGetIsvalidIsPending(token:Number):Bool;
	static function N_0xd302e99edf0449cf(token:Number):Bool;
	...
	static function N_0xd0ee05fe193646ea(oldPlateText:String, newPlateText:String, plateData:String):Bool;
	static function ScPresenceAttrSetFloat():Bool;
	static function N_0xc4c4575f62534a24():Bool;
	static function ScPresenceAttrSetInt(attrHash:Number, value:Number):Bool;
	static function N_0x1f1e9682483697c7(attrHash:Number, value:Number):Bool;
	static function ScPresenceAttrSetString(attrHash:Number, value:String):Bool;
	static function N_0x287f1f75d2803595(attrHash:Number, value:String):Bool;
	...
	static function ScProfanityGetCheckIsPending(token:Number):Bool;
	static function N_0x82e4a58babc15ae7(token:Number):Bool;
	static function ScGetCheckStringStatus(token:Number):Bool;
	static function ScProfanityGetCheckIsValid(token:Number):Bool;
	static function N_0x1753344c770358ae(token:Number):Bool;
	static function ScHasCheckStringTaskCompleted(token:Number):Bool;
	static function ScProfanityGetStringPassed(token:Number):Bool;
	static function N_0x85535acf97fc0969(token:Number):Bool;
	...
	static function PushScaleformMovieFunctionParameterBool(value:Bool):Void;
	static function PushScaleformMovieMethodParameterBool(value:Bool):Void;
	...
	static function SelectEntityAtCursor(hitFlags:Number, precise:Bool):Number;
	static function SelectEntityAtPos(fracX:Number, fracY:Number, hitFlags:Number, precise:Bool):Number;
	...
	static function SetAchievementProgress(achievement:Number, progress:Number):Bool;
	static function N_0xc2afffdabbdc2c5c(achievement:Number, progress:Number):Bool;
	static function SetAchievementProgression(achievement:Number, progress:Number):Bool;
	static function SetActivateObjectPhysicsAsSoonAsItIsUnfrozen(object:Number, toggle:Bool):Void;
	...
	static function N_0x228e5c6ad4d74bfd(toggle:Bool):Void;
	static function SetAllRandomPedsFlee(player:Number, toggle:Bool):Void;
	static function SetAllRandomPedsFleeThisFrame(player:Number):Void;
	static function SetAllVehicleGeneratorsActive():Void;
	static function SetAllVehicleGeneratorsActiveInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p6:Bool, p7:Bool):Void;
	...
	static function N_0x6b0e6172c9a4d902(p0:Bool):Void;
	...
	static function SetAmmoInClip(ped:Number, weaponHash:Number, ammo:Number):Bool;
	static function SetAnimLooped(p0:Number, p1:Bool, p2:Number, p3:Bool):Void;
	static function SetAnimPhase(entity:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function N_0xddf3cb5a0a4c0b49(entity:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function SetAnimPlaybackTime(entity:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function SetAnimRate(p0:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function SetAnimWeight(p0:Number, p1:Number, p2:Number, p3:Number, p4:Bool):Void;
	static function SetAnimalMood(animal:Number, mood:Number):Void;
	static function SetArtificialLightsState(state:Bool):Void;
	static function SetBlackout(state:Bool):Void;
	...
	static function SetAutoGiveParachuteWhenEnterPlane(player:Number, toggle:Bool):Void;
	static function SetAutoGiveScubaGearWhenExitVehicle(player:Number, toggle:Bool):Void;
	static function N_0xd2b315b6689d537d(player:Number, toggle:Bool):Void;
	static function SetBackfaceculling(toggle:Bool):Void;
	static function N_0x23ba6b0c2ad7b0d3(toggle:Bool):Void;
	...
	static function SetRadarBigmapEnabled(toggleBigMap:Bool, showFullMap:Bool):Void;
	...
	static function SetBinkMovieUnk_2(binkMovie:Number, p1:Bool):Void;
	...
	static function SetBinkShouldSkip(binkMovie:Number, shouldSkip:Bool):Void;
	static function N_0x6805d58caa427b72(binkMovie:Number, shouldSkip:Bool):Void;
	...
	static function SetBlipAsFriendly(blip:Number, toggle:Bool):Void;
	static function SetBlipAsMissionCreatorBlip(blip:Number, toggle:Bool):Void;
	static function SetBlipAsShortRange(blip:Number, toggle:Bool):Void;
	static function SetBlipBright(blip:Number, toggle:Bool):Void;
	...
	static function SetBlipDisplayIndicatorOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0xc4278f70131baa6d(blip:Number, toggle:Bool):Void;
	...
	static function SetBlipFlashes(blip:Number, toggle:Bool):Void;
	static function SetBlipFlashesAlternate(blip:Number, toggle:Bool):Void;
	static function SetBlipHiddenOnLegend(blip:Number, toggle:Bool):Void;
	static function N_0x54318c915d27e4ce(blip:Number, toggle:Bool):Void;
	static function SetBlipHighDetail(blip:Number, toggle:Bool):Void;
	...
	static function SetBlipRoute(blip:Number, enabled:Bool):Void;
	...
	static function SetBlipShowCone(blip:Number, toggle:Bool):Void;
	static function SetBlipShrink(blip:Number, toggle:Bool):Void;
	static function N_0x2b6d467dab714e8d(blip:Number, toggle:Bool):Void;
	...
	static function SetBlockingOfNonTemporaryEvents(ped:Number, toggle:Bool):Void;
	static function SetBoatAnchor(vehicle:Number, toggle:Bool):Void;
	...
	static function SetBoatDisableAvoidance(vehicle:Number, p1:Bool):Void;
	static function N_0x0a6a279f3aa4fd70(vehicle:Number, p1:Bool):Void;
	static function SetBoatFrozenWhenAnchored(vehicle:Number, toggle:Bool):Void;
	static function N_0xe3ebaae484798530(vehicle:Number, toggle:Bool):Void;
	...
	static function SetBoatSinksWhenWrecked(vehicle:Number, toggle:Bool):Void;
	static function N_0x8f719973e1445ba2(vehicle:Number, toggle:Bool):Void;
	static function SetBoatExplodesOnWreckedAction(vehicle:Number, toggle:Bool):Void;
	static function SetCalmingQuadBounds(waterQuad:Number, minX:Number, minY:Number, maxX:Number, maxY:Number):Bool;
	static function SetCalmingQuadDampening(calmingQuad:Number, dampening:Number):Bool;
	static function SetCamActive(cam:Number, active:Bool):Void;
	...
	static function SetCamAffectsAiming(cam:Number, toggle:Bool):Void;
	...
	static function SetCamInheritRollVehicle(cam:Number, p1:Bool):Void;
	...
	static function SetCamUseShallowDofMode(cam:Number, toggle:Bool):Void;
	...
	static function SetCamberedWheelsDisabled(vehicle:Number, toggle:Bool):Void;
	static function N_0x1201e8a3290a3b98(vehicle:Number, toggle:Bool):Void;
	static function SetCanAttackFriendly(ped:Number, toggle:Bool, p2:Bool):Void;
	static function SetCanAutoVaultOnEntity(entity:Number, toggle:Bool):Void;
	static function N_0xe12abe5e3a389a6c(entity:Number, toggle:Bool):Void;
	static function SetCanClimbOnEntity(entity:Number, toggle:Bool):Void;
	static function N_0xa80ae305e0a3044f(entity:Number, toggle:Bool):Void;
	static function SetCanPedEquipAllWeapons(ped:Number, toggle:Bool):Void;
	static function N_0xeff296097ff1e509(ped:Number, toggle:Bool):Void;
	static function SetCanPedEquipWeapon(ped:Number, weaponHash:Number, toggle:Bool):Void;
	static function N_0xb4771b9aaf4e68e4(ped:Number, weaponHash:Number, toggle:Bool):Void;
	static function SetCanPedSelectWeapon(ped:Number, weaponHash:Number, toggle:Bool):Void;
	static function SetCanResprayVehicle(vehicle:Number, state:Bool):Void;
	...
	static function SetCargobobForceDontDetachVehicle(cargobob:Number, toggle:Bool):Void;
	static function N_0x571feb383f629926(cargobob:Number, toggle:Bool):Void;
	static function SetCargobobHookCanDetach(cargobob:Number, toggle:Bool):Void;
	static function SetCargobobHookCanAttach(vehicle:Number, toggle:Bool):Void;
	static function N_0x94a68da412c4007d(vehicle:Number, toggle:Bool):Void;
	static function SetCargobobPickupMagnetActive(cargobob:Number, isActive:Bool):Void;
	static function CargobobMagnetGrabVehicle(cargobob:Number, isActive:Bool):Void;
	...
	static function SetControlNormal(padIndex:Number, control:Number, amount:Number):Bool;
	static function N_0xe8a25867fba3b05e(padIndex:Number, control:Number, amount:Number):Bool;
	static function SetConvertibleRoof(vehicle:Number, toggle:Bool):Void;
	static function SetConvertibleRoofLatchState(vehicle:Number, state:Bool):Void;
	static function N_0x1a78ad3d8240536f(vehicle:Number, state:Bool):Void;
	...
	static function SetCreateWeaponObjectLightSource(object:Number, toggle:Bool):Void;
	static function N_0xbce595371a5fbaaf(object:Number, toggle:Bool):Void;
	static function SetCreditsActive(toggle:Bool):Void;
	static function SetCurrentPedVehicleWeapon(ped:Number, weaponHash:Number):Bool;
	static function SetCurrentPedWeapon(ped:Number, weaponHash:Number, bForceInHand:Bool):Void;
	...
	static function SetCursorLocation(x:Number, y:Number):Bool;
	static function N_0xfc695459d4d0e219(x:Number, y:Number):Bool;
	static function SetCustomRadioTrackList(radioStation:String, trackListName:String, p2:Bool):Void;
	static function N_0x4e404a9361f75bb2(radioStation:String, trackListName:String, p2:Bool):Void;
	static function SetCutsceneAudioOverride(name:String):Void;
	static function SetCutsceneCanBeSkipped(p0:Bool):Void;
	static function N_0x41faa8fb2ece8720(p0:Bool):Void;
	...
	static function SetDeployHeliStubWings(vehicle:Number, deploy:Bool, p2:Bool):Void;
	static function N_0xb251e0b33e58b424(vehicle:Number, deploy:Bool, p2:Bool):Void;
	static function SetDirectorModeClearTriggeredFlag():Void;
	static function N_0x2632482fd6b9ab87():Void;
	static function SetDisableAmbientMeleeMove(player:Number, toggle:Bool):Void;
	static function SetDisableBreaking(object:Number, toggle:Bool):Void;
	static function SetDisableDecalRenderingThisFrame():Void;
	static function N_0x4b5cfc83122df602():Void;
	static function SetDisableFragDamage(object:Number, toggle:Bool):Void;
	static function SetDisableHoverModeFlight(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleHoverTransformActive(vehicle:Number, toggle:Bool):Void;
	static function SetDisablePretendOccupants(vehicle:Number, toggle:Bool):Void;
	static function N_0x25367de49d64cf16(vehicle:Number, toggle:Bool):Void;
	static function SetDisableRandomTrainsThisFrame(toggle:Bool):Void;
	static function N_0xd4b8e3d1917bc86b(toggle:Bool):Void;
	static function SetSomethingMultiplierThisFrame(toggle:Bool):Void;
	static function SetDisableSuperdummyMode(vehicle:Number, p1:Bool):Void;
	static function N_0xb088e9a47ae6edd5(vehicle:Number, p1:Bool):Void;
	...
	static function SetDisableVehicleEngineFires(vehicle:Number, toggle:Bool):Void;
	static function N_0x91a0bd635321f145(vehicle:Number, toggle:Bool):Void;
	static function SetDisableVehicleFlightNozzlePosition(vehicle:Number, direction:Bool):Void;
	static function SetPlaneVtolAnimationDisabled(vehicle:Number, direction:Bool):Void;
	static function SetDisableVehiclePetrolTankDamage(vehicle:Number, toggle:Bool):Void;
	static function SetDisableVehiclePetrolTankFires(vehicle:Number, toggle:Bool):Void;
	static function N_0x465bf26ab9684352(vehicle:Number, toggle:Bool):Void;
	static function SetDisableVehicleUnk(toggle:Bool):Void;
	static function SetDisableVehicleUnk_2(toggle:Bool):Void;
	static function SetDisableVehicleWindowCollisions(vehicle:Number, toggle:Bool):Void;
	static function N_0x1087bc8ec540daeb(vehicle:Number, toggle:Bool):Void;
	...
	static function SetDispatchCopsForPlayer(player:Number, toggle:Bool):Void;
	...
	static function N_0xf796359a959df65d(toggle:Bool):Void;
	static function DisplayDistantVehicles(toggle:Bool):Void;
	...
	static function SetDriftTyresEnabled(vehicle:Number, toggle:Bool):Void;
	...
	static function SetEnableArenaPropPhysics(entity:Number, toggle:Bool, p2:Number):Void;
	static function N_0x911024442f4898f0(entity:Number, toggle:Bool, p2:Number):Void;
	static function SetEnableArenaPropPhysicsOnPed(entity:Number, toggle:Bool, p2:Number, ped:Number):Void;
	static function N_0xb20834a7dd3d8896(entity:Number, toggle:Bool, p2:Number, ped:Number):Void;
	static function SetEnableBoundAnkles(ped:Number, toggle:Bool):Void;
	static function SetEnableHandcuffs(ped:Number, toggle:Bool):Void;
	static function SetEnablePedEnveffScale(ped:Number, toggle:Bool):Void;
	static function SetEnableScuba(ped:Number, toggle:Bool):Void;
	static function SetEnableScubaGearLight(ped:Number, toggle:Bool):Void;
	static function SetEnableVehicleSlipstreaming(toggle:Bool):Void;
	static function N_0xe6c0c80b8c867537(toggle:Bool):Void;
	static function SetEntityAlpha(entity:Number, alphaLevel:Number, skin:Bool):Void;
	static function SetEntityAlwaysPrerender(entity:Number, toggle:Bool):Void;
	...
	static function SetEntityAsMissionEntity(entity:Number, p1:Bool, p2:Bool):Void;
	static function SetEntityAsNoLongerNeeded(entity:Number):Void;
	static function SetEntityCanBeDamaged(entity:Number, toggle:Bool):Void;
	static function SetEntityCanBeDamagedByRelationshipGroup(entity:Number, bCanBeDamaged:Bool, relGroup:Number):Void;
	static function SetEntityCanBeTargetedWithoutLos(entity:Number, toggle:Bool):Void;
	static function SetEntityCleanupByEngine(entity:Number, toggle:Bool):Void;
	static function N_0x3910051ccecdb00c(entity:Number, toggle:Bool):Void;
	static function SetEntityRegister(entity:Number, toggle:Bool):Void;
	static function SetEntitySomething(entity:Number, toggle:Bool):Void;
	static function SetEntityCollision(entity:Number, toggle:Bool, keepPhysics:Bool):Void;
	static function SetEntityCompletelyDisableCollision(entity:Number, toggle:Bool, keepPhysics:Bool):Void;
	static function N_0x9ebc85ed0fffe51c(entity:Number, toggle:Bool, keepPhysics:Bool):Void;
	static function SetEntityCollision_2(entity:Number, toggle:Bool, keepPhysics:Bool):Void;
	static function SetEntityCoords(entity:Number, xPos:Number, yPos:Number, zPos:Number, alive:Bool, deadFlag:Bool, ragdollFlag:Bool, clearArea:Bool):Void;
	static function SetEntityCoordsNoOffset(entity:Number, xPos:Number, yPos:Number, zPos:Number, alive:Bool, deadFlag:Bool, ragdollFlag:Bool):Void;
	static function SetEntityCoordsWithoutPlantsReset(entity:Number, xPos:Number, yPos:Number, zPos:Number, alive:Bool, deadFlag:Bool, ragdollFlag:Bool,
		clearArea:Bool):Void;
	static function SetEntityCoords_2(entity:Number, xPos:Number, yPos:Number, zPos:Number, alive:Bool, deadFlag:Bool, ragdollFlag:Bool, clearArea:Bool):Void;
	static function SetEntityDecalsDisabled(entity:Number, p1:Bool):Void;
	static function N_0x2c2e3dc128f44309(entity:Number, p1:Bool):Void;
	static function SetEntityDrawOutline(entity:Number, enabled:Bool):Void;
	...
	static function SetEntityDynamic(entity:Number, toggle:Bool):Void;
	static function SetEntityHasGravity(entity:Number, toggle:Bool):Void;
	...
	static function SetEntityIconVisibility(entity:Number, toggle:Bool):Void;
	static function SetEntityInvincible(entity:Number, toggle:Bool):Void;
	static function SetEntityIsTargetPriority(entity:Number, p1:Bool, p2:Number):Void;
	static function SetEntityLights(entity:Number, toggle:Bool):Void;
	static function SetEntityLoadCollisionFlag(entity:Number, toggle:Bool):Void;
	...
	static function SetEntityMotionBlur(entity:Number, toggle:Bool):Void;
	static function SetEntityNoCollisionEntity(entity1:Number, entity2:Number, thisFrameOnly:Bool):Void;
	static function SetEntityOnlyDamagedByPlayer(entity:Number, toggle:Bool):Void;
	static function SetEntityOnlyDamagedByRelationshipGroup(entity:Number, p1:Bool, relationshipHash:Number):Void;
	static function SetEntityProofUnk(entity:Number, toggle:Bool):Void;
	static function N_0x15f944730c832252(entity:Number, toggle:Bool):Void;
	static function SetEntityProofs(entity:Number, bulletProof:Bool, fireProof:Bool, explosionProof:Bool, collisionProof:Bool, meleeProof:Bool,
		steamProof:Bool, p7:Bool, drownProof:Bool):Void;
	static function SetEntityQuaternion(entity:Number, x:Number, y:Number, z:Number, w:Number):Void;
	static function SetEntityRecordsCollisions(entity:Number, toggle:Bool):Void;
	static function SetEntityRenderScorched(entity:Number, toggle:Bool):Void;
	static function SetEntityRotation(entity:Number, pitch:Number, roll:Number, yaw:Number, rotationOrder:Number, p5:Bool):Void;
	...
	static function SetEntityVisible(entity:Number, toggle:Bool, unk:Bool):Void;
	static function SetEntityVisibleInCutscene(p0:Number, p1:Bool, p2:Bool):Void;
	static function SetEveryoneIgnorePlayer(player:Number, toggle:Bool):Void;
	...
	static function SetFlashLightEnabled(ped:Number, toggle:Bool):Void;
	static function SetFlashLightFadeDistance(distance:Number):Number;
	static function SetFlashLightKeepOnWhileMoving(state:Bool):Void;
	...
	static function SetFlyThroughWindscreenParams(vehMinSpeed:Number, unkMinSpeed:Number, unkModifier:Number, minDamage:Number):Bool;
	...
	static function SetFollowPedCamThisUpdate(camName:String, p1:Number):Bool;
	static function SetFollowPedCamCutsceneChat(camName:String, p1:Number):Bool;
	...
	static function SetForceFootstepUpdate(ped:Number, toggle:Bool):Void;
	static function N_0x129466ed55140f8d(ped:Number, toggle:Bool):Void;
	static function SetForceHdVehicle(vehicle:Number, toggle:Bool):Void;
	static function N_0x97ce68cb032583f0(vehicle:Number, toggle:Bool):Void;
	...
	static function SetForceStepType(ped:Number, p1:Bool, _type:Number, p3:Number):Void;
	static function N_0xcb968b53fc7f916d(ped:Number, p1:Bool, _type:Number, p3:Number):Void;
	static function SetForceVehicleTrails(toggle:Bool):Void;
	static function SetForcedBoatLocationWhenAnchored(vehicle:Number, toggle:Bool):Void;
	static function N_0xb28b1fe5bfadd7f5(vehicle:Number, toggle:Bool):Void;
	...
	static function SetGameplayEntityHint(entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, p4:Bool, p5:Number, p6:Number, p7:Number,
		p8:Number):Void;
	static function SetGameplayHintAnimCloseup(toggle:Bool):Void;
	static function GetIsMultiplayerBrief(toggle:Bool):Void;
	static function N_0xe3433eadaaf7ee40(toggle:Bool):Void;
	...
	static function SetGameplayObjectHint(p0:Number, p1:Number, p2:Number, p3:Number, p4:Bool, p5:Number, p6:Number, p7:Number):Void;
	static function SetGameplayPedHint(p0:Number, x1:Number, y1:Number, z1:Number, p4:Bool, duration:Number, blendOutDuration:Number,
		blendInDuration:Number):Void;
	static function SetGameplayVehicleHint(vehicle:Number, offsetX:Number, offsetY:Number, offsetZ:Number, p4:Bool, time:Number, easeInTime:Number,
	...
	static function SetGpsCustomRouteRender(toggle:Bool, radarThickness:Number, mapThickness:Number):Void;
	static function N_0x900086f371220b6f(toggle:Bool, radarThickness:Number, mapThickness:Number):Void;
	...
	static function N_0x3dda37128dd1aca8(toggle:Bool):Void;
	...
	static function N_0xbfa0a56a817c6c7d(toggle:Bool):Void;
	...
	static function SetHealthHudDisplayValues(health:Number, capacity:Number, wasAdded:Bool):Void;
	static function N_0x3f5cc444dcaaa8f2(health:Number, capacity:Number, wasAdded:Bool):Void;
	...
	static function SetHeliTailExplodeThrowDashboard(vehicle:Number, p1:Bool):Void;
	static function WasCounterActivated(vehicle:Number, p1:Bool):Void;
	static function N_0x3ec8bf18aa453fe9(vehicle:Number, p1:Bool):Void;
	...
	static function SetHidofOverride(p0:Bool, p1:Bool, nearplaneOut:Number, nearplaneIn:Number, farplaneOut:Number, farplaneIn:Number):Void;
	static function N_0xba3d65906822bed5(p0:Bool, p1:Bool, nearplaneOut:Number, nearplaneIn:Number, farplaneOut:Number, farplaneIn:Number):Void;
	static function SetHidofEnvBlurParams(p0:Bool, p1:Bool, nearplaneOut:Number, nearplaneIn:Number, farplaneOut:Number, farplaneIn:Number):Void;
	static function SetHighFallTask(ped:Number, duration:Number, p2:Number, p3:Number):Void;
	static function SetHornEnabled(vehicle:Number, toggle:Bool):Void;
	...
	static function SetHydraulicRaised(vehicle:Number, toggle:Bool):Void;
	static function N_0x28b18377eb6e25f6(vehicle:Number, toggle:Bool):Void;
	...
	static function SetIgnoreLowPriorityShockingEvents(player:Number, toggle:Bool):Void;
	static function SetIgnoreNoGpsFlag(toggle:Bool):Void;
	static function SetIgnoreSecondaryRouteNodes(toggle:Bool):Void;
	static function N_0x1fc289a0c3ff470f(toggle:Bool):Void;
	...
	static function SetInteriorActive(interiorID:Number, toggle:Bool):Void;
	...
	static function N_0x7ec8aba5e74b3d7a(toggle:Bool):Void;
	static function SetInteriorZoomLevelIncreased(toggle:Bool):Void;
	static function N_0x504dfe62a1692296(toggle:Bool):Void;
	static function SetIslandEnabled(islandName:String, toggle:Bool):Void;
	static function SetIslandHopperEnabled(islandName:String, toggle:Bool):Void;
	...
	static function N_0xaa6a6098851c396f(toggle:Bool):Void;
	...
	static function N_0x78857fc65cadb909(p0:Bool):Void;
	static function SetLocalPlayerCanUsePickupsWithThisModel(modelHash:Number, toggle:Bool):Void;
	static function N_0x88eaec617cd26926(modelHash:Number, toggle:Bool):Void;
	...
	static function SetManualShutdownLoadingScreenNui(manualShutdown:Bool):Void;
	...
	static function N_0xaf12610c644a35c9(name:String, toggle:Bool):Void;
	...
	static function SetMicrophonePosition(p0:Bool, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, x3:Number, y3:Number, z3:Number):Void;
	static function SetMillisecondsPerGameMinute(value:Number):Void;
	static function SetMinigameInProgress(toggle:Bool):Void;
	static function SetMinimapAltitudeIndicatorLevel(altitude:Number, p1:Bool):Void;
	static function SetMinimapAttitudeIndicatorLevel(altitude:Number, p1:Bool):Void;
	static function SetMinimapBlockWaypoint(toggle:Bool):Void;
	static function SetMinimapClipType(_type:Number):Void;
	static function SetMinimapComponent(componentID:Number, toggle:Bool, hudColor:Number):Number;
	...
	static function N_0xf8dee0a5600cbb93(toggle:Bool):Void;
	static function SetMinimapRevealed(toggle:Bool):Void;
	static function SetMinimapInPrologue(toggle:Bool):Void;
	static function SetDrawMapVisible(toggle:Bool):Void;
	static function SetNorthYanktonMap(toggle:Bool):Void;
	static function SetMinimapInSpectatorMode(toggle:Bool, ped:Number):Void;
	static function KeyHudColour(toggle:Bool, ped:Number):Void;
	...
	static function SetMinimapSonarEnabled(toggle:Bool):Void;
	static function SetMissionFlag(toggle:Bool):Void;
	static function SetMissionName(p0:Bool, name:String):Void;
	static function SetMissionName_2(p0:Bool, name:String):Void;
	static function N_0xe45087d85f468bc2(p0:Bool, name:String):Void;
	static function SetMissionTrainAsNoLongerNeeded(p1:Bool):Number;
	...
	static function N_0x375a706a5c2fd084(toggle:Bool):Void;
	...
	static function SetModelHeadlightConfiguration(modelHash:Number, ratePerSecond:Number, headlightRotation:Number, invertRotation:Bool):Void;
	...
	static function N_0x98215325a695e78a(enable:Bool):Void;
	...
	static function SetMpGamerTagDisablePlayerHealthSync(gamerTagId:Number, toggle:Bool):Void;
	static function N_0xd29ec58c2f6b5014(gamerTagId:Number, toggle:Bool):Void;
	static function SetMpGamerHealthBarDisplay(gamerTagId:Number, toggle:Bool):Void;
	...
	static function SetMpGamerTagUseVehicleHealth(gamerTagId:Number, toggle:Bool):Void;
	static function N_0xa67f9c46d612b6f1(gamerTagId:Number, toggle:Bool):Void;
	static function SetMpGamerTagIcons(gamerTagId:Number, toggle:Bool):Void;
	static function SetMpGamerTagVisibility(gamerTagId:Number, component:Number, toggle:Bool):Void;
	static function N_0x63bb75abedc1f6a0(gamerTagId:Number, component:Number, toggle:Bool):Void;
	static function SetMpGamerTagVisibilityAll(gamerTagId:Number, toggle:Bool):Void;
	static function N_0xee76ff7e6a0166b0(gamerTagId:Number, toggle:Bool):Void;
	static function SetMpGamerTag_(gamerTagId:Number, toggle:Bool):Void;
	static function SetMpGamerTag(gamerTagId:Number, toggle:Bool):Void;
	static function SetMpGamerTagEnabled(gamerTagId:Number, toggle:Bool):Void;
	...
	static function SetMpGamerTagsUseVehicleBehavior(enabled:Bool):Void;
	...
	static function N_0xaaa553e7dd28a457(toggle:Bool):Void;
	static function SetNetworkEnableVehiclePositionCorrection(vehicle:Number, toggle:Bool):Void;
	static function N_0x838da0936a24ed4d(vehicle:Number, toggle:Bool):Void;
	static function SetNetworkIdAlwaysExistsForPlayer(netId:Number, player:Number, toggle:Bool):Void;
	static function N_0xa8a024587329f36a(netId:Number, player:Number, toggle:Bool):Void;
	static function SetNetworkIdSyncToPlayer(netId:Number, player:Number, toggle:Bool):Void;
	static function SetNetworkIdCanMigrate(netId:Number, toggle:Bool):Void;
	static function SetNetworkIdExistsOnAllMachines(netId:Number, toggle:Bool):Void;
	static function SetNetworkIdVisibleInCutscene(netId:Number, p1:Bool, p2:Bool):Void;
	static function SetNetworkVehicleAsGhost(vehicle:Number, toggle:Bool):Void;
	static function N_0x6274c4712850841e(vehicle:Number, toggle:Bool):Void;
	static function SetNetworkObjectNonContact(vehicle:Number, toggle:Bool):Void;
	...
	static function SetObjectAllowLowLodBuoyancy(object:Number, toggle:Bool):Void;
	static function N_0x4d89d607cb3dd1d2(object:Number, toggle:Bool):Void;
	static function SetObjectCanClimbOn(object:Number, toggle:Bool):Void;
	static function SetObjectAsNoLongerNeeded(object:Number):Void;
	static function SetObjectForceVehiclesToAvoid(object:Number, toggle:Bool):Void;
	static function N_0x77f33f2ccf64b3aa(object:Number, toggle:Bool):Void;
	static function SetObjectSomething(object:Number, toggle:Bool):Void;
	static function SetObjectLightColor(object:Number, p1:Bool, r:Number, g:Number, b:Number):Number;
	...
	static function SetObjectTargettable(object:Number, targettable:Bool):Void;
	...
	static function SetOpenRearDoorsOnExplosion(vehicle:Number, toggle:Bool):Void;
	static function N_0x1b212b26dd3c04df(vehicle:Number, toggle:Bool):Void;
	static function SetOppressorTransformState(vehicle:Number, extend:Bool):Void;
	static function N_0x544996c0081abdeb(vehicle:Number, extend:Bool):Void;
	...
	static function SetParticleFxCamInsideNonplayerVehicle(vehicle:Number, p1:Bool):Void;
	...
	static function SetParticleFxLoopedColour(ptfxHandle:Number, r:Number, g:Number, b:Number, p4:Bool):Void;
	static function SetParticleFxLoopedEvolution(ptfxHandle:Number, propertyName:String, amount:Number, noNetwork:Bool):Void;
	...
	static function N_0x3ca6050692bc61b0(state:Bool):Void;
	static function SetPauseMenuPedSleepState(state:Bool):Void;
	static function N_0xecf128344e9ff9f1(state:Bool):Void;
	static function SetPedAccuracy(ped:Number, accuracy:Number):Void;
	static function SetPedAiBlipForcedOn(ped:Number, toggle:Bool):Void;
	static function N_0x0c4bbf625ca98c4e(ped:Number, toggle:Bool):Void;
	static function IsAiBlipAlwaysShown(ped:Number, toggle:Bool):Void;
	...
	static function SetPedAiBlipHasCone(ped:Number, toggle:Bool):Void;
	static function HideSpecialAbilityLockonOperation(ped:Number, toggle:Bool):Void;
	...
	static function SetPedAllowVehiclesOverride(ped:Number, toggle:Bool):Void;
	static function SetPedAllowedToDuck(ped:Number, toggle:Bool):Void;
	static function SetPedAlternateMovementAnim(ped:Number, stance:Number, animDictionary:String, animationName:String, p4:Number, p5:Bool):Void;
	static function SetPedAlternateWalkAnim(ped:Number, animDict:String, animName:String, p3:Number, p4:Bool):Void;
	...
	static function SetPedAngledDefensiveArea(ped:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Bool, p9:Bool):Void;
	static function SetPedAoBlobRendering(ped:Number, toggle:Bool):Void;
	static function N_0x2b5aa717a181fb4c(ped:Number, toggle:Bool):Void;
	static function SetPedArmour(ped:Number, amount:Number):Void;
	static function SetPedAsCop(ped:Number, toggle:Bool):Void;
	static function SetPedAsEnemy(ped:Number, toggle:Bool):Void;
	...
	static function SetPedAudioFootstepLoud(ped:Number, toggle:Bool):Void;
	static function N_0x0653b735bfbdfe87(ped:Number, toggle:Bool):Void;
	static function SetPedAudioFootstepQuiet(ped:Number, toggle:Bool):Void;
	static function N_0x29da3ca8d8b2692d(ped:Number, toggle:Bool):Void;
	static function SetPedAudioGender(ped:Number, p1:Bool):Void;
	static function N_0xa5342d390cda41d6(ped:Number, p1:Bool):Void;
	static function SetPedBlendFromParents(ped:Number, father:Number, mother:Number, fathersSide:Number, mothersSide:Number):Void;
	static function SetPedBlocksPathingWhenDead(ped:Number, toggle:Bool):Void;
	static function N_0x576594e8d64375e2(ped:Number, toggle:Bool):Void;
	static function SetPedBoundsOrientation(ped:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number):Void;
	static function SetPedCanArmIk(ped:Number, toggle:Bool):Void;
	static function SetPedCanBeDraggedOut(ped:Number, toggle:Bool):Void;
	static function SetPedCanBeKnockedOffVehicle(ped:Number, state:Number):Void;
	static function SetPedCanBeShotInVehicle(ped:Number, toggle:Bool):Void;
	static function SetPedCanBeTargetedWhenInjured(ped:Number, toggle:Bool):Void;
	static function SetPedCanBeTargetedWithoutLos(ped:Number, toggle:Bool):Void;
	static function SetPedCanBeTargetted(ped:Number, toggle:Bool):Void;
	static function SetPedCanBeTargettedByPlayer(ped:Number, player:Number, toggle:Bool):Void;
	static function SetPedCanBeTargettedByTeam(ped:Number, team:Number, toggle:Bool):Void;
	static function SetPedCanCowerInCover(ped:Number, toggle:Bool):Void;
	static function SetPedCanEvasiveDive(ped:Number, toggle:Bool):Void;
	static function SetPedCanHeadIk(ped:Number, toggle:Bool):Void;
	static function SetPedCanLegIk(ped:Number, toggle:Bool):Void;
	static function SetPedCanLosePropsOnDamage(ped:Number, loseProps:Bool, p2:Number):Void;
	static function N_0xe861d0b05c7662b8(ped:Number, loseProps:Bool, p2:Number):Void;
	static function SetPedCanPeekInCover(ped:Number, toggle:Bool):Void;
	static function SetPedCanPlayAmbientAnims(ped:Number, toggle:Bool):Void;
	static function SetPedCanPlayAmbientBaseAnims(ped:Number, toggle:Bool):Void;
	static function SetPedCanPlayAmbientIdles(ped:Number, p1:Bool, p2:Bool):Void;
	static function N_0x8fd89a6240813fd0(ped:Number, p1:Bool, p2:Bool):Void;
	static function SetPedCanPlayGestureAnims(ped:Number, toggle:Bool):Void;
	static function SetPedCanPlayInjuredAnims(ped:Number, p1:Bool):Void;
	static function N_0x33a60d8bdd6e508c(ped:Number, p1:Bool):Void;
	static function SetPedCanPlayVisemeAnims(ped:Number, toggle:Bool, p2:Bool):Void;
	static function SetPedCanRagdoll(ped:Number, toggle:Bool):Void;
	static function SetPedCanRagdollFromPlayerImpact(ped:Number, toggle:Bool):Void;
	static function SetPedCanSmashGlass(ped:Number, p1:Bool, p2:Bool):Void;
	static function SetPedCanSwitchWeapon(ped:Number, toggle:Bool):Void;
	static function SetPedCanTeleportToGroupLeader(pedHandle:Number, groupHandle:Number, toggle:Bool):Void;
	static function SetPedCanTorsoIk(ped:Number, toggle:Bool):Void;
	static function SetPedCanTorsoReactIk(ped:Number, p1:Bool):Void;
	static function N_0xf5846edb26a98a24(ped:Number, p1:Bool):Void;
	static function SetPedCanTorsoVehicleIk(ped:Number, p1:Bool):Void;
	static function N_0x6647c5f6f5792496(ped:Number, p1:Bool):Void;
	static function SetPedCanUseAutoConversationLookat(ped:Number, toggle:Bool):Void;
	...
	static function SetPedCombatAttributes(ped:Number, attributeIndex:Number, enabled:Bool):Void;
	...
	static function SetPedConfigFlag(ped:Number, flagId:Number, value:Bool):Void;
	...
	static function SetPedCurrentWeaponVisible(ped:Number, visible:Bool, deselectWeapon:Bool, p3:Bool, p4:Bool):Void;
	...
	static function SetPedDefensiveAreaAttachedToPed(ped:Number, attachPed:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number,
		p8:Number, p9:Bool, p10:Bool):Void;
	static function SetPedDefensiveAreaDirection(ped:Number, p1:Number, p2:Number, p3:Number, p4:Bool):Void;
	static function SetPedDefensiveSphereAttachedToPed(ped:Number, target:Number, xOffset:Number, yOffset:Number, zOffset:Number, radius:Number, p6:Bool):Void;
	static function N_0xf9b8f91aad3b953e(ped:Number, target:Number, xOffset:Number, yOffset:Number, zOffset:Number, radius:Number, p6:Bool):Void;
	static function SetPedDefensiveSphereAttachedToVehicle(ped:Number, target:Number, xOffset:Number, yOffset:Number, zOffset:Number, radius:Number,
		p6:Bool):Void;
	static function N_0xe4723db6e736ccff(ped:Number, target:Number, xOffset:Number, yOffset:Number, zOffset:Number, radius:Number, p6:Bool):Void;
	...
	static function SetPedDiesInSinkingVehicle(ped:Number, toggle:Bool):Void;
	static function SetPedDiesInVehicle(ped:Number, toggle:Bool):Void;
	static function SetPedDiesInWater(ped:Number, toggle:Bool):Void;
	static function SetPedDiesInstantlyInWater(ped:Number, toggle:Bool):Void;
	static function SetPedDiesWhenInjured(ped:Number, toggle:Bool):Void;
	...
	static function SetPedDropsWeaponsWhenDead(ped:Number, toggle:Bool):Void;
	static function SetPedDucking(ped:Number, toggle:Bool):Void;
	...
	static function SetPedEnableWeaponBlocking(ped:Number, toggle:Bool):Void;
	...
	static function SetPedFleeAttributes(ped:Number, attributeFlags:Number, enable:Bool):Void;
	static function SetPedGadget(ped:Number, gadgetHash:Number, p2:Bool):Void;
	static function SetPedGeneratesDeadBodyEvents(ped:Number, toggle:Bool):Void;
	static function SetPedGestureGroup(ped:Number, animGroupGesture:String):Void;
	static function SetPedGetOutUpsideDownVehicle(ped:Number, toggle:Bool):Void;
	static function SetPedGravity(ped:Number, toggle:Bool):Void;
	...
	static function SetPedHasAiBlip(ped:Number, hasCone:Bool):Void;
	static function N_0xd30c50df888d58b5(ped:Number, hasCone:Bool):Void;
	static function SetPedEnemyAiBlip(ped:Number, hasCone:Bool):Void;
	static function SetPedAiBlip(ped:Number, hasCone:Bool):Void;
	static function SetPedHasAiBlipWithColor(ped:Number, hasCone:Bool, color:Number):Void;
	static function N_0xb13dcb4c6faad238(ped:Number, hasCone:Bool, color:Number):Void;
	static function SetPedHeadBlendData(ped:Number, shapeFirstID:Number, shapeSecondID:Number, shapeThirdID:Number, skinFirstID:Number, skinSecondID:Number,
		skinThirdID:Number, shapeMix:Number, skinMix:Number, thirdMix:Number, isParent:Bool):Void;
	...
	static function SetPedHelmet(ped:Number, canWearHelmet:Bool):Void;
	...
	static function SetPedHelmetUnk(ped:Number, p1:Bool, p2:Number, p3:Number):Void;
	static function N_0x3f7325574e41b44d(ped:Number, p1:Bool, p2:Number, p3:Number):Void;
	static function SetPedHighlyPerceptive(ped:Number, toggle:Bool):Void;
	static function N_0x52d59ab61ddc05dd(ped:Number, toggle:Bool):Void;
	...
	static function SetPedInfiniteAmmo(ped:Number, toggle:Bool, weaponHash:Number):Void;
	static function SetPedInfiniteAmmoClip(ped:Number, toggle:Bool):Void;
	static function SetPedIntoVehicle(ped:Number, vehicle:Number, seatIndex:Number):Void;
	static function SetPedIsDrunk(ped:Number, toggle:Bool):Void;
	static function SetPedKeepTask(ped:Number, toggle:Bool):Void;
	...
	static function SetPedModelIsSuppressed(model:Number, toggle:Bool):Void;
	...
	static function SetPedMotionBlur(ped:Number, toggle:Bool):Void;
	...
	static function SetPedNeverLeavesGroup(ped:Number, toggle:Bool):Void;
	...
	static function SetPedPathAvoidFire(ped:Number, avoidFire:Bool):Void;
	static function SetPedPathCanDropFromHeight(ped:Number, Toggle:Bool):Void;
	static function SetPedPathCanUseClimbovers(ped:Number, Toggle:Bool):Void;
	static function SetPedPathCanUseLadders(ped:Number, Toggle:Bool):Void;
	...
	static function SetPedPathMayEnterWater(ped:Number, mayEnterWater:Bool):Void;
	static function SetPedPathsWidthPlant(ped:Number, mayEnterWater:Bool):Void;
	static function SetPedPathPreferToAvoidWater(ped:Number, avoidWater:Bool):Void;
	static function SetPedPathsBackToOriginal(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number):Void;
	static function SetPedPathsInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, unknown:Bool):Void;
	static function SetPedPinnedDown(ped:Number, pinned:Bool, i:Number):Number;
	static function SetPedPlaysHeadOnHornAnimWhenDiesInVehicle(ped:Number, toggle:Bool):Void;
	...
	static function SetPedPreloadPropData(ped:Number, componentId:Number, drawableId:Number, textureId:Number):Bool;
	static function N_0x2b16a3bff1fbce49(ped:Number, componentId:Number, drawableId:Number, textureId:Number):Bool;
	static function IsPedPropValid(ped:Number, componentId:Number, drawableId:Number, textureId:Number):Bool;
	...
	static function SetPedPropIndex(ped:Number, componentId:Number, drawableId:Number, textureId:Number, attach:Bool):Void;
	static function SetPedRagdollForceFall(ped:Number):Void;
	static function SetPedRagdollOnCollision(ped:Number, toggle:Bool):Void;
	...
	static function SetPedResetFlag(ped:Number, flagId:Number, doReset:Bool):Void;
	...
	static function SetPedShootsAtCoord(ped:Number, x:Number, y:Number, z:Number, toggle:Bool):Void;
	...
	static function SetPedSphereDefensiveArea(ped:Number, x:Number, y:Number, z:Number, radius:Number, p5:Bool, p6:Bool):Void;
	static function SetPedStayInVehicleWhenJacked(ped:Number, toggle:Bool):Void;
	static function SetPedStealthMovement(ped:Number, p1:Bool, action:String):Void;
	static function SetPedSteersAroundObjects(ped:Number, toggle:Bool):Void;
	static function SetPedSteersAroundPeds(ped:Number, toggle:Bool):Void;
	static function SetPedSteersAroundVehicles(ped:Number, toggle:Bool):Void;
	static function SetPedStrafeClipset(ped:Number, clipSet:String):Void;
	static function SetPedSuffersCriticalHits(ped:Number, toggle:Bool):Void;
	...
	static function SetPedToLoadCover(ped:Number, toggle:Bool):Void;
	static function SetPedToRagdoll(ped:Number, time1:Number, time2:Number, ragdollType:Number, p4:Bool, p5:Bool, p6:Bool):Bool;
	static function SetPedToRagdollWithFall(ped:Number, time:Number, p2:Number, ragdollType:Number, x:Number, y:Number, z:Number, p7:Number, p8:Number,
		p9:Number, p10:Number, p11:Number, p12:Number, p13:Number):Bool;
	static function SetPedTurningThresholds(min:Number, max:Number):Void;
	static function SetPedUsingActionMode(ped:Number, p1:Bool, p2:Number, action:String):Void;
	...
	static function SetPickupRopeLengthForCargobob(cargobob:Number, length1:Number, length2:Number, state:Bool):Void;
	static function N_0x877c1eaeac531023(cargobob:Number, length1:Number, length2:Number, state:Bool):Void;
	static function SetCargobobHookPosition(cargobob:Number, length1:Number, length2:Number, state:Bool):Void;
	...
	static function SetPlaneResistToExplosion(vehicle:Number, toggle:Bool):Void;
	static function N_0xe16142b94664defd(vehicle:Number, toggle:Bool):Void;
	...
	static function SetPlaybackToUseAiTryToRevertBackLater(vehicle:Number, time:Number, drivingStyle:Number, p3:Bool):Void;
	static function SetPlayerAirDefenseZoneFlag(player:Number, zoneId:Number, enable:Bool):Void;
	static function N_0xecdc202b25e5cf48(player:Number, zoneId:Number, enable:Bool):Void;
	static function SetPlayerAngry(ped:Number, toggle:Bool):Void;
	static function SetPlayerBlipPositionThisFrame(x:Number, y:Number):Void;
	static function SetPlayerBluetoothState(player:Number, state:Bool):Void;
	static function N_0x5dc40a8869c22141(player:Number, state:Bool):Void;
	static function SetPlayerCanBeHassledByGangs(player:Number, toggle:Bool):Void;
	static function SetPlayerCanDoDriveBy(player:Number, toggle:Bool):Void;
	static function SetPlayerCanLeaveParachuteSmokeTrail(player:Number, enabled:Bool):Void;
	static function SetPlayerCanUseCover(player:Number, toggle:Bool):Void;
	...
	static function SetPlayerControl(player:Number, bHasControl:Bool, flags:Number):Void;
	...
	static function SetPlayerForceSkipAimIntro(player:Number, toggle:Bool):Void;
	static function SetPlayerForcedAim(player:Number, toggle:Bool):Void;
	static function SetPlayerForcedZoom(player:Number, toggle:Bool):Void;
	...
	static function SetPlayerHomingRocketDisabled(player:Number, p1:Bool):Void;
	static function N_0xee4ebdd2593ba844(player:Number, p1:Bool):Void;
	static function SetPlayerInvincible(player:Number, toggle:Bool):Void;
	static function SetPlayerInvincibleKeepRagdollEnabled(player:Number, toggle:Bool):Void;
	static function N_0x6bc97f4f4bb3c04b(player:Number, toggle:Bool):Void;
	static function SetPlayerInvisibleLocally(player:Number, toggle:Bool):Void;
	static function SetPlayerIsInAnimalForm(toggle:Bool):Void;
	static function N_0x4ebb7e87aa0dbed4(toggle:Bool):Void;
	static function ShowPedInPauseMenu(toggle:Bool):Void;
	static function SetPlayerIsInDirectorMode(toggle:Bool):Void;
	static function N_0x808519373fd336a3(toggle:Bool):Void;
	static function SetDirectorMode(toggle:Bool):Void;
	static function SetPlayerLeavePedBehind(player:Number, toggle:Bool):Void;
	static function N_0xff300c7649724a0b(player:Number, toggle:Bool):Void;
	static function SetPlayerLockon(player:Number, toggle:Bool):Void;
	...
	static function SetPlayerMaxStamina(playerId:Number, maxStamina:Number):Bool;
	...
	static function SetPlayerParachuteVariationOverride(player:Number, p1:Number, p2:Number, p3:Number, p4:Bool):Void;
	...
	static function N_0x9d8d44adbba61ef2(toggle:Bool):Void;
	static function SetPlayerShortSwitchStyle(style:Number):Void;
	static function N_0x5f2013f8bc24ee69(style:Number):Void;
	static function SetPlayerSimulateAiming(player:Number, toggle:Bool):Void;
	static function SetPlayerSneakingNoiseMultiplier(player:Number, multiplier:Number):Void;
	static function SetPlayerSprint(player:Number, toggle:Bool):Void;
	static function SetPlayerStamina(playerId:Number, stamina:Number):Bool;
	...
	static function N_0xc208b673ce446b61(cameraCoordX:Number, cameraCoordY:Number, cameraCoordZ:Number, camRotationX:Number, camRotationY:Number,
		camRotationZ:Number, camFov:Number, camFarClip:Number, rotationOrder:Number):Void;
	static function SetPlayerTalkingOverride(player:Number, state:Bool):Void;
	...
	static function SetPlayerVisibleLocally(player:Number, toggle:Bool):Void;
	static function SetPlayerWantedCentrePosition(player:Number, p2:Bool, p3:Bool):Vector3;
	static function SetPlayerWantedLevel(player:Number, wantedLevel:Number, delayedResponse:Bool):Void;
	static function SetPlayerWantedLevelNoDrop(player:Number, wantedLevel:Number, delayedResponse:Bool):Void;
	static function SetPlayerWantedLevelNow(player:Number, p1:Bool):Void;
	...
	static function SetPoliceFocusWillTrackVehicle(vehicle:Number, p1:Bool):Void;
	static function N_0x4e74e62e0a97e901(vehicle:Number, p1:Bool):Void;
	static function SetPoliceIgnorePlayer(player:Number, toggle:Bool):Void;
	...
	static function N_0x1eac5f91bcbc5073(toggle:Bool):Void;
	...
	static function N_0x774bd811f656a122(radioStation:String, toggle:Bool):Void;
	...
	static function SetRadiusBlipEdge(blip:Number, toggle:Bool):Void;
	static function N_0x25615540d894b814(blip:Number, toggle:Bool):Void;
	...
	static function SetReduceDriftVehicleSuspension(vehicle:Number, enable:Bool):Void;
	...
	static function SetRelationshipGroupDontAffectWantedLevel(group:Number, p1:Bool):Void;
	static function N_0x5615e0c5eb2bc6e2(group:Number, p1:Bool):Void;
	static function SetRelationshipToPlayer(player:Number, p1:Bool):Void;
	static function N_0xa7c511fa1c5bda38(player:Number, p1:Bool):Void;
	static function SetRenderHdOnly(toggle:Bool):Void;
	static function N_0x40aefd1a244741f2(toggle:Bool):Void;
	static function SetRenderTrainAsDerailed(train:Number, toggle:Bool):Void;
	...
	static function N_0x2587a48bc88dfadf(toggle:Bool):Void;
	...
	static function SetRoadsInAngledArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number, unknown1:Bool, unknown2:Bool,
		unknown3:Bool):Void;
	static function SetRoadsInArea(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, nodeEnabled:Bool, unknown2:Bool):Void;
	static function SetRopeLengthChangeRate(rope:Number, lengthChangeRate:Number):Void;
	static function SetRopesCreateNetworkWorldState(shouldCreate:Bool):Void;
	static function SetRunSprintMultiplierForPlayer(player:Number, multiplier:Number):Void;
	static function SetRuntimeTextureArgbData(tex:Number, buffer:String, length:Number):Bool;
	static function SetRuntimeTextureImage(tex:Number, fileName:String):Bool;
	static function SetRuntimeTexturePixel(tex:Number, x:Number, y:Number, r:Number, g:Number, b:Number, a:Number):Void;
	static function SetSaveHouse(p0:Number, p1:Bool, p2:Bool):Void;
	...
	static function SetScaleformFitRendertarget(scaleformHandle:Number, toggle:Bool):Void;
	static function N_0xe6a9f00d4240b519(scaleformHandle:Number, toggle:Bool):Void;
	static function SetScaleformMovieAsNoLongerNeeded(scaleformHandle:Number):Void;
	static function SetScaleformMovieToUseSystemTime(scaleform:Number, toggle:Bool):Void;
	...
	static function N_0xc6372ecd45d73bcd(flag:Bool):Void;
	...
	static function SetScriptUpdateDoorAudio(doorHash:Number, toggle:Bool):Void;
	static function N_0x06c0023bed16dd6b(doorHash:Number, toggle:Bool):Void;
	...
	static function SetScriptVehicleGenerator(vehicleGenerator:Number, enabled:Bool):Void;
	...
	static function SetSequenceToRepeat(taskSequenceId:Number, repeat:Bool):Void;
	static function SetSirenKeepOn(vehicle:Number, toggle:Bool):Void;
	static function N_0xf584cf8529b51434(vehicle:Number, toggle:Bool):Void;
	static function SetSirenWithNoDriver(vehicle:Number, toggle:Bool):Void;
	...
	static function SetSpecialFlightModeAllowed(vehicle:Number, toggle:Bool):Void;
	static function N_0xf1211889df15a763(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleHoverTransformEnabled(vehicle:Number, toggle:Bool):Void;
	...
	static function SetStateBagValue(bagName:String, keyName:String, valueData:String, valueLength:Number, replicated:Bool):Void;
	static function SetStateOfClosestDoorOfType(_type:Number, x:Number, y:Number, z:Number, locked:Bool, heading:Number, p6:Bool):Void;
	...
	static function N_0xd79185689f8fd5df(toggle:Bool):Void;
	static function SetSubmarineCrushDepths(vehicle:Number, toggle:Bool, depth1:Number, depth2:Number, depth3:Number):Void;
	static function JitterVehicle(vehicle:Number, toggle:Bool, depth1:Number, depth2:Number, depth3:Number):Void;
	...
	static function SetSynchronizedSceneHoldLastFrame(sceneID:Number, toggle:Bool):Void;
	static function N_0x394b9cd12435c981(sceneID:Number, toggle:Bool):Void;
	static function SetSynchronizedSceneOcclusionPortal(sceneID:Number, toggle:Bool):Void;
	static function SetSynchronizedSceneLooped(sceneID:Number, toggle:Bool):Void;
	static function SetSynchronizedSceneOrigin(sceneID:Number, x:Number, y:Number, z:Number, roll:Number, pitch:Number, yaw:Number, p7:Bool):Void;
	...
	static function SetTaskMoveNetworkSignalBool(ped:Number, signalName:String, value:Bool):Void;
	static function N_0xb0a6cfd2c69c1088(ped:Number, signalName:String, value:Bool):Void;
	static function SetTaskPropertyBool(ped:Number, signalName:String, value:Bool):Void;
	...
	static function SetTaskVehicleChaseBehaviorFlag(ped:Number, flag:Number, _set:Bool):Void;
	...
	static function SetTaxiLights(vehicle:Number, state:Bool):Void;
	static function SetTeamPickupObject(object:Number, p1:Number, p2:Bool):Void;
	...
	static function SetTextureVariationOfClosestObjectOfType(x:Number, y:Number, z:Number, radius:Number, modelHash:Number, textureVariation:Number):Bool;
	static function N_0xf12e33034d887f66(x:Number, y:Number, z:Number, radius:Number, modelHash:Number, textureVariation:Number):Bool;
	...
	static function SetTrainsForceDoorsOpen(forceOpen:Bool):Void;
	...
	static function SetTvChannelPlaylist(tvChannel:Number, playlistName:String, restart:Bool):Void;
	static function N_0xf7b38b8305f1fe8b(tvChannel:Number, playlistName:String, restart:Bool):Void;
	static function LoadTvChannelSequence(tvChannel:Number, playlistName:String, restart:Bool):Void;
	...
	static function SetUnkBoolN_0x102ForSubmarineVehicleTask(vehicle:Number, value:Bool):Void;
	...
	static function SetUseHigherVehicleJumpForce(vehicle:Number, toggle:Bool):Void;
	static function N_0xf06a16ca55d138d8(vehicle:Number, toggle:Bool):Void;
	static function SetUseIslandMap(toggle:Bool):Void;
	static function SetToggleMinimapHeistIsland(toggle:Bool):Void;
	static function SetUseWaypointAsDestination(toggle:Bool):Void;
	static function N_0x6cdd58146a436083(toggle:Bool):Void;
	...
	static function SetVehicleActAsIfHighSpeedForFragSmashing(vehicle:Number, actHighSpeed:Bool):Void;
	static function N_0x1f9fb66f3a3842d2(vehicle:Number, actHighSpeed:Bool):Void;
	static function SetVehicleActiveDuringPlayback(vehicle:Number, toggle:Bool):Void;
	static function N_0xdffcef48e511db48(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleActiveForPedNavigation(vehicle:Number, toggle:Bool):Void;
	static function N_0x21115bcd6e44656a(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCloseDoorDeferedAction(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleAlarm(vehicle:Number, state:Bool):Void;
	static function SetVehicleAlarmTimeLeft(vehicle:Number, time:Number):Void;
	static function SetVehicleAllowNoPassengersLockon(veh:Number, toggle:Bool):Void;
	...
	static function SetVehicleAutoRepairDisabled(vehicle:Number, value:Bool):Void;
	static function SetVehicleAutomaticallyAttaches(vehicle:Number, p1:Bool, p2:Number):Number;
	...
	static function SetVehicleBoostActive(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleBrake(vehicle:Number, toggle:Bool):Void;
	static function N_0xe4e2fd323574965c(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleBrakeLights(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleBulldozerArmPosition(vehicle:Number, position:Number, p2:Bool):Void;
	static function N_0xf8ebccc96adb9fb7(vehicle:Number, position:Number, p2:Bool):Void;
	static function SetVehicleBurnout(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanBeLockedOn(vehicle:Number, canBeLockedOn:Bool, unk:Bool):Void;
	static function N_0x1dda078d12879eee(vehicle:Number, canBeLockedOn:Bool, unk:Bool):Void;
	static function SetVehicleCanBeTargetted(vehicle:Number, state:Bool):Void;
	static function SetVehicleCanBeUsedByFleeingPeds(vehicle:Number, toggle:Bool):Void;
	static function N_0x300504b23bd3b711(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanBeVisiblyDamaged(vehicle:Number, state:Bool):Void;
	static function SetVehicleCanBreak(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanDeformWheels(vehicle:Number, toggle:Bool):Void;
	static function N_0x0cdda42f9e360ca6(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanEngineOperateOnFire(vehicle:Number, toggle:Bool):Void;
	static function N_0x206bc5dc9d1ac70a(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanLeakOil(vehicle:Number, toggle:Bool):Void;
	static function N_0x51bb2d88d31a914b(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanLeakPetrol(vehicle:Number, toggle:Bool):Void;
	static function N_0x192547247864dfdd(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCanSaveInGarage(vehicle:Number, toggle:Bool):Void;
	static function N_0x428baccdf5e26ead(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleControlsInverted(vehicle:Number, state:Bool):Void;
	static function N_0x5b91b229243351a8(vehicle:Number, state:Bool):Void;
	...
	static function SetVehicleDamage(vehicle:Number, xOffset:Number, yOffset:Number, zOffset:Number, damage:Number, radius:Number, focusOnModel:Bool):Void;
	...
	static function SetVehicleDisableTowing(vehicle:Number, toggle:Bool):Void;
	static function N_0x2b6747faa9db9d6b(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleDoorBroken(vehicle:Number, doorIndex:Number, deleteDoor:Bool):Void;
	static function SetVehicleDoorCanBreak(vehicle:Number, doorIndex:Number, isBreakable:Bool):Void;
	static function SetVehicleDoorBreakable(vehicle:Number, doorIndex:Number, isBreakable:Bool):Void;
	static function SetVehicleDoorControl(vehicle:Number, doorIndex:Number, speed:Number, angle:Number):Void;
	static function SetVehicleDoorLatched(vehicle:Number, doorIndex:Number, forceClose:Bool, lock:Bool, p4:Bool):Void;
	static function SetVehicleDoorOpen(vehicle:Number, doorIndex:Number, loose:Bool, openInstantly:Bool):Void;
	static function SetVehicleDoorShut(vehicle:Number, doorIndex:Number, closeInstantly:Bool):Void;
	static function SetVehicleDoorsLocked(vehicle:Number, doorLockStatus:Number):Void;
	static function SetVehicleDoorsLockedForAllPlayers(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleDoorsLockedForNonScriptPlayers(vehicle:Number, toggle:Bool):Void;
	static function N_0x9737a37136f07e75(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleDoorsLockedForPlayer(vehicle:Number, player:Number, toggle:Bool):Void;
	static function SetVehicleDoorsLockedForTeam(vehicle:Number, team:Number, toggle:Bool):Void;
	static function SetVehicleDoorsLockedForUnk(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleDoorsShut(vehicle:Number, closeInstantly:Bool):Void;
	static function SetVehicleDropsMoneyWhenBlownUp(vehicle:Number, toggle:Bool):Void;
	static function N_0x068f64f2470f9656(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleCreatesMoneyPickupsWhenExploded(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleEngineCanDegrade(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleEngineHealth(vehicle:Number, health:Number):Void;
	static function SetVehicleEngineOn(vehicle:Number, value:Bool, instantly:Bool, disableAutoStart:Bool):Void;
	...
	static function SetVehicleExclusiveDriver(vehicle:Number, toggle:Bool):Void;
	static function N_0x41062318f23ed854(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleExplodesOnHighExplosionDamage(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleExtra(vehicle:Number, extraId:Number, disable:Bool):Void;
	...
	static function SetVehicleForceAfterburner(vehicle:Number, toggle:Bool):Void;
	static function N_0xb055a34527cb8fd7(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleFullbeam(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleGeneratesEngineShockingEvents(vehicle:Number, toggle:Bool):Void;
	static function N_0x279d50de5652d935(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleGravity(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleGravityAmount(vehicle:Number, gravity:Number):Void;
	static function SetVehicleHandbrake(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleHasBeenDrivenFlag(vehicle:Number, toggle:Bool):Void;
	static function N_0x02398b627547189c(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleHasBeenOwnedByPlayer(vehicle:Number, owned:Bool):Void;
	static function SetVehicleHasMutedSirens(vehicle:Number, toggle:Bool):Void;
	static function DisableVehicleImpactExplosionActivation(vehicle:Number, toggle:Bool):Void;
	static function SetDisableVehicleSirenSound(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleHasStrongAxles(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleHasUnbreakableLights(vehicle:Number, p1:Bool):Void;
	static function N_0x1aa8a837d2169d94(vehicle:Number, p1:Bool):Void;
	static function SetVehicleLightsCanBeVisiblyDamaged(vehicle:Number, p1:Bool):Void;
	...
	static function SetVehicleInactiveDuringPlayback(vehicle:Number, toggle:Bool):Void;
	static function N_0x06582aff74894c75(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleIndicatorLights(vehicle:Number, turnSignal:Number, toggle:Bool):Void;
	...
	static function SetVehicleInfluencesWantedLevel(vehicle:Number, influenceWantedLevel:Bool):Void;
	static function N_0x0ad9e8f87ff7c16f(vehicle:Number, influenceWantedLevel:Bool):Void;
	...
	static function SetVehicleInteriorlight(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleIsConsideredByPlayer(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleIsRacing(vehicle:Number, toggle:Bool):Void;
	static function SteerUnlockBias(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleIsStolen(vehicle:Number, isStolen:Bool):Void;
	static function SetVehicleIsWanted(vehicle:Number, state:Bool):Void;
	static function SetVehicleJetEngineOn(vehicle:Number, toggle:Bool):Void;
	static function N_0xb8fbc8b1330ca9b4(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleKersAllowed(vehicle:Number, toggle:Bool):Void;
	static function N_0x99c82f8a139f3e4e(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleHudSpecialAbilityBarActive(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleMod(vehicle:Number, modType:Number, modIndex:Number, customTires:Bool):Void;
	...
	static function SetVehicleModelIsSuppressed(model:Number, suppressed:Bool):Void;
	static function SetVehicleNameDebug(vehicle:Number, name:String):Void;
	static function SetVehicleNeedsToBeHotwired(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleNeonLightEnabled(vehicle:Number, index:Number, toggle:Bool):Void;
	...
	static function SetVehicleNitroEnabled(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleOnGroundProperly(vehicle:Number):Bool;
	static function SetVehicleOutOfControl(vehicle:Number, killDriver:Bool, explodeOnImpact:Bool):Void;
	static function SetVehicleParachuteActive(vehicle:Number, active:Bool):Void;
	...
	static function SetVehicleProvidesCover(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleRadioEnabled(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleRadioLoud(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleRampSidewaysLaunchMotion(vehicle:Number, toggle:Bool):Void;
	static function N_0x1bbac99c0bc53656(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleRampUpwardsLaunchMotion(vehicle:Number, toggle:Bool):Void;
	static function N_0x756ae6e962168a04(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleReceivesRampDamage(vehicle:Number, toggle:Bool):Void;
	static function SetRampVehicleReceivesRampDamage(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleReduceGrip(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleRocketBoostActive(vehicle:Number, active:Bool):Void;
	...
	static function SetVehicleRudderBroken(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleSearchlight(heli:Number, toggle:Bool, canBeUsedByAI:Bool):Void;
	...
	static function SetVehicleSilent(vehicle:Number, toggle:Bool):Void;
	static function N_0x9d44fcce98450843(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleSiren(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleSt(vehicle:Number, toggle:Bool):Void;
	static function N_0x1cf38d529d7441d9(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleStrong(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleSuspensionHeight(vehicle:Number, newHeight:Number):Void;
	static function SetVehicleTankTurretPosition(vehicle:Number, position:Number, p2:Bool):Void;
	static function N_0x56b94c6d7127dfba(vehicle:Number, position:Number, p2:Bool):Void;
	static function SetVehicleTimedExplosion(vehicle:Number, ped:Number, toggle:Bool):Void;
	...
	static function SetVehicleTurretUnk(vehicle:Number, index:Number, toggle:Bool):Void;
	static function N_0xc60060eb0d8ac7b1(vehicle:Number, index:Number, toggle:Bool):Void;
	static function SetVehicleTyreBurst(vehicle:Number, index:Number, onRim:Bool, p3:Number):Void;
	...
	static function SetVehicleTyresCanBurst(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleUndriveable(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleUseAlternateHandling(vehicle:Number, toggle:Bool):Void;
	static function N_0x1d97d1e3a70a649f(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleUseCutsceneWheelCompression(p0:Number, p1:Bool, p2:Bool, p3:Bool):Number;
	static function SetAllVehiclesSpawn(p0:Number, p1:Bool, p2:Bool, p3:Bool):Number;
	static function N_0xe023e8ac4ef7c117(p0:Number, p1:Bool, p2:Bool, p3:Bool):Number;
	static function SetVehicleUsePlayerLightSettings(vehicle:Number, toggle:Bool):Void;
	static function N_0xc45c27ef50f36adc(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleUsesLargeRearRamp(vehicle:Number, toggle:Bool):Void;
	static function N_0xcac66558b944da67(vehicle:Number, toggle:Bool):Void;
	...
	static function SetVehicleWheelIsPowered(vehicle:Number, wheelIndex:Number, powered:Bool):Void;
	...
	static function SetVehicleWheelSize(vehicle:Number, size:Number):Bool;
	...
	static function SetVehicleWheelWidth(vehicle:Number, width:Number):Bool;
	...
	static function SetVehicleWheelsCanBreak(vehicle:Number, enabled:Bool):Void;
	static function SetVehicleWheelsCanBreakOffWhenBlowUp(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleMaxStrTrap(vehicle:Number, toggle:Bool):Void;
	static function SetVehicleWheelsDealDamage(vehicle:Number, toggle:Bool):Void;
	static function N_0x2970eaa18fd5e42f(vehicle:Number, toggle:Bool):Void;
	...
	static function SetWarningMessage(entryLine1:String, instructionalKey:Number, entryLine2:String, p3:Bool, p4:Number, background:String, p6:String,
		showBg:Bool, errorCode:Number):Void;
	static function SetWarningMessageListRow(index:Number, name:String, cash:Number, rp:Number, lvl:Number, colour:Number):Bool;
	static function N_0x0c5a80a9e096d529(index:Number, name:String, cash:Number, rp:Number, lvl:Number, colour:Number):Bool;
	static function SetWarningMessageWithAlert(labelTitle:String, labelMsg:String, p2:Number, p3:Number, labelMsg2:String, p5:Bool, p6:Number, p7:Number,
		p8:String, p9:String, background:Bool, errorCode:Number):Void;
	static function N_0x15803fec3b9a872b(labelTitle:String, labelMsg:String, p2:Number, p3:Number, labelMsg2:String, p5:Bool, p6:Number, p7:Number, p8:String,
		p9:String, background:Bool, errorCode:Number):Void;
	static function DrawFrontendAlert(labelTitle:String, labelMsg:String, p2:Number, p3:Number, labelMsg2:String, p5:Bool, p6:Number, p7:Number, p8:String,
		p9:String, background:Bool, errorCode:Number):Void;
	static function SetWarningMessageWithHeader(titleMsg:String, entryLine1:String, flags:Number, promptMsg:String, p4:Bool, p5:Number, background:Bool,
		showBg:Bool):Number;
	static function SetWarningMessage_2(titleMsg:String, entryLine1:String, flags:Number, promptMsg:String, p4:Bool, p5:Number, background:Bool,
		showBg:Bool):Number;
	static function SetWarningMessageWithHeaderAndSubstringFlags(entryHeader:String, entryLine1:String, instructionalKey:Number, entryLine2:String, p4:Bool,
		p5:Number, p6:Number, p9:Bool):SetWarningMessageWithHeaderAndSubstringFlagsReturnType;
	static function SetWarningMessage_3(entryHeader:String, entryLine1:String, instructionalKey:Number, entryLine2:String, p4:Bool, p5:Number, p6:Number,
		p9:Bool):SetWarningMessage_3ReturnType;
	static function SetWarningMessageWithHeaderUnk(entryHeader:String, entryLine1:String, flags:Number, entryLine2:String, p4:Bool, p5:Number, showBg:Bool,
	...
	static function SetWaterQuadAlpha(waterQuad:Number, a0:Number, a1:Number, a2:Number, a3:Number):Bool;
	static function SetWaterQuadBounds(waterQuad:Number, minX:Number, minY:Number, maxX:Number, maxY:Number):Bool;
	static function SetWaterQuadHasLimitedDepth(waterQuad:Number, hasLimitedDepth:Bool):Bool;
	static function SetWaterQuadIsInvisible(waterQuad:Number, isInvisible:Bool):Bool;
	static function SetWaterQuadLevel(waterQuad:Number, level:Number):Bool;
	static function SetWaterQuadNoStencil(waterQuad:Number, noStencil:Bool):Bool;
	static function SetWaterQuadType(waterQuad:Number, _type:Number):Bool;
	static function SetWaveQuadAmplitude(waveQuad:Number, amplitude:Number):Bool;
	static function SetWaveQuadBounds(waveQuad:Number, minX:Number, minY:Number, maxX:Number, maxY:Number):Bool;
	static function SetWaveQuadDirection(waveQuad:Number, directionX:Number, directionY:Number):Bool;
	...
	static function SetWeaponsNoAimBlocking(state:Bool):Void;
	static function SetWeaponsNoAutoreload(state:Bool):Void;
	static function SetWeaponsNoAutoswap(state:Bool):Void;
	static function SetWeatherOwnedByNetwork(network:Bool):Void;
	...
	static function SetWidescreenBorders(p0:Bool, p1:Number):Void;
	...
	static function SetZoneEnabled(zoneId:Number, toggle:Bool):Void;
	...
	static function SetupShopPedApparelQueryTu(character:Number, p1:Number, p2:Number, p3:Bool, p4:Number, componentId:Number):Number;
	static function GetNumPropsFromOutfit(character:Number, p1:Number, p2:Number, p3:Bool, p4:Number, componentId:Number):Number;
	static function SetupShopPedOutfitQuery(character:Number, p1:Bool):Number;
	static function N_0xf3fbe2d50a6a8c28(character:Number, p1:Bool):Number;
	...
	static function ShootSingleBulletBetweenCoords(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, pureAccuracy:Bool,
		weaponHash:Number, ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number):Void;
	static function ShootSingleBulletBetweenCoordsIgnoreEntity(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, p7:Bool,
		weaponHash:Number, ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number, entity:Number):Void;
	static function N_0xe3a7742e0b7a2f8b(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, p7:Bool, weaponHash:Number,
		ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number, entity:Number):Void;
	static function ShootSingleBulletBetweenCoordsPresetParams(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, p7:Bool,
		weaponHash:Number, ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number, entity:Number):Void;
	static function ShootSingleBulletBetweenCoordsIgnoreEntityNew(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, p7:Bool,
		weaponHash:Number, ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number, entity:Number, p14:Bool, p15:Bool, p16:Bool, p17:Bool):Void;
	static function N_0xbfe5756e7407064a(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, p7:Bool, weaponHash:Number,
		ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number, entity:Number, p14:Bool, p15:Bool, p16:Bool, p17:Bool):Void;
	static function ShootSingleBulletBetweenCoordsWithExtraParams(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, damage:Number, p7:Bool,
		weaponHash:Number, ownerPed:Number, isAudible:Bool, isInvisible:Bool, speed:Number, entity:Number, p14:Bool, p15:Bool, p16:Bool, p17:Bool):Void;
	static function ShouldUseMetricMeasurements():Bool;
	static function N_0xd3d15555431ab793():Bool;
	static function IsGameUsingMetricMeasurementSystem():Bool;
	static function ShowCrewIndicatorOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0xdcfb5d4db8bf367e(blip:Number, toggle:Bool):Void;
	static function SetBlipCrew(blip:Number, toggle:Bool):Void;
	static function ShowFriendIndicatorOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0x23c3eb807312f01a(blip:Number, toggle:Bool):Void;
	static function SetBlipFriend(blip:Number, toggle:Bool):Void;
	static function ShowHasCompletedIndicatorOnBlip(blip:Number, toggle:Bool):Void;
	static function ShowHeadingIndicatorOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0x5fbca48327b914df(blip:Number, toggle:Bool):Void;
	static function ShowHeightOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0x75a16c3da34f1245(blip:Number, toggle:Bool):Void;
	static function ShowHudComponentThisFrame(id:Number):Void;
	static function ShowNumberOnBlip(blip:Number, _number:Number):Void;
	static function ShowOutlineIndicatorOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0xb81656bc81fe24d1(blip:Number, toggle:Bool):Void;
	static function SetBlipFriendly(blip:Number, toggle:Bool):Void;
	...
	static function N_0xf1a6c18b35bcade6(p0:Bool):Void;
	static function ShowTickOnBlip(blip:Number, toggle:Bool):Void;
	static function N_0x74513ea3e505181e(blip:Number, toggle:Bool):Void;
	static function SetBlipChecked(blip:Number, toggle:Bool):Void;
	static function ShutdownAndLaunchSinglePlayerGame():Void;
	static function ShutdownAndLoadMostRecentSave():Bool;
	static function N_0x9eca15adfe141431():Bool;
	...
	static function SimulatePlayerInputGait(player:Number, amount:Number, gaitType:Number, rotationSpeed:Number, p4:Bool, p5:Bool):Void;
	...
	static function SlideObject(object:Number, toX:Number, toY:Number, toZ:Number, speedX:Number, speedY:Number, speedZ:Number, collision:Bool):Bool;
	...
	static function N_0x3c67506996001f5e():Bool;
	static function SpawnpointsIsSearchComplete():Bool;
	static function N_0xa586fbeb32a53dbb():Bool;
	static function SpawnpointsIsSearchFailed():Bool;
	static function N_0xf445de8da80a1792():Bool;
	...
	static function SpecialAbilityChargeAbsolute(player:Number, p1:Number, p2:Bool):Void;
	static function SpecialAbilityChargeContinuous(player:Number, p2:Number):Void;
	static function SpecialAbilityChargeLarge(player:Number, p1:Bool, p2:Bool):Void;
	static function SpecialAbilityChargeMedium(player:Number, p1:Bool, p2:Bool):Void;
	static function SpecialAbilityChargeNormalized(player:Number, normalizedValue:Number, p2:Bool):Void;
	static function ResetSpecialAbilityControlsCinematic(player:Number, normalizedValue:Number, p2:Bool):Void;
	...
	static function SpecialAbilityChargeSmall(player:Number, p1:Bool, p2:Bool):Void;
	...
	static function SpecialAbilityDepleteMeter(player:Number, p1:Bool):Void;
	static function SpecialAbilityFillMeter(player:Number, p1:Bool):Void;
	...
	static function StartGpsCustomRoute(hudColor:Number, displayOnFoot:Bool, followPlayer:Bool):Void;
	static function N_0xdb34e8d56fc13b08(hudColor:Number, displayOnFoot:Bool, followPlayer:Bool):Void;
	static function StartGpsMultiRoute(hudColor:Number, routeFromPlayer:Bool, displayOnFoot:Bool):Void;
	static function N_0x3d3d15af7bcaaf83(hudColor:Number, routeFromPlayer:Bool, displayOnFoot:Bool):Void;
	static function StartNetworkedParticleFxLoopedOnEntity(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number,
		yRot:Number, zRot:Number, scale:Number, xAxis:Bool, yAxis:Bool, zAxis:Bool):Number;
	static function N_0x6f60e89a7b64ee1d(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number, yRot:Number,
		zRot:Number, scale:Number, xAxis:Bool, yAxis:Bool, zAxis:Bool):Number;
	...
	static function StartNetworkedParticleFxLoopedOnEntityBone(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number,
		yRot:Number, zRot:Number, boneIndex:Number, scale:Number, xAxis:Bool, yAxis:Bool, zAxis:Bool):Number;
	static function N_0xdde23f30cc5a0f03(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number, yRot:Number,
		zRot:Number, boneIndex:Number, scale:Number, xAxis:Bool, yAxis:Bool, zAxis:Bool):Number;
	...
	static function StartNetworkedParticleFxNonLoopedAtCoord(effectName:String, xPos:Number, yPos:Number, zPos:Number, xRot:Number, yRot:Number, zRot:Number,
		scale:Number, xAxis:Bool, yAxis:Bool, zAxis:Bool):Bool;
	...
	static function StartNetworkedParticleFxNonLoopedOnEntity(effectName:String, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number, rotX:Number,
		rotY:Number, rotZ:Number, scale:Number, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	...
	static function StartNetworkedParticleFxNonLoopedOnEntityBone(effectName:String, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number,
		rotX:Number, rotY:Number, rotZ:Number, boneIndex:Number, scale:Number, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	static function StartNetworkedParticleFxNonLoopedOnPedBone(effectName:String, ped:Number, offsetX:Number, offsetY:Number, offsetZ:Number, rotX:Number,
		rotY:Number, rotZ:Number, boneIndex:Number, scale:Number, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	...
	static function StartParticleFxLoopedAtCoord(effectName:String, x:Number, y:Number, z:Number, xRot:Number, yRot:Number, zRot:Number, scale:Number,
		xAxis:Bool, yAxis:Bool, zAxis:Bool, p11:Bool):Number;
	...
	static function StartParticleFxNonLoopedAtCoord(effectName:String, xPos:Number, yPos:Number, zPos:Number, xRot:Number, yRot:Number, zRot:Number,
		scale:Number, xAxis:Bool, yAxis:Bool, zAxis:Bool):Number;
	...
	static function StartParticleFxNonLoopedOnPedBone(effectName:String, ped:Number, offsetX:Number, offsetY:Number, offsetZ:Number, rotX:Number, rotY:Number,
		rotZ:Number, boneIndex:Number, scale:Number, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	static function StartPetrolTrailDecals(p0:Number):Void;
	static function N_0x99ac7f0d8b9c893d(p0:Number):Void;
	static function StartPlaybackRecordedVehicle(vehicle:Number, recording:Number, script:String, p3:Bool):Void;
	...
	static function StartPlayerTeleport(player:Number, x:Number, y:Number, z:Number, heading:Number, teleportWithVehicle:Bool, findCollisionLand:Bool,
		p7:Bool):Void;
	...
	static function StartSaveData(p1:Number, p2:Bool):Number;
	...
	static function StartScriptFire(X:Number, Y:Number, Z:Number, maxChildren:Number, isGasFire:Bool):Number;
	...
	static function StartVehicleHorn(vehicle:Number, duration:Number, mode:Number, forever:Bool):Void;
	...
	static function StatGetBoolMasked(statName:Number, mask:Number, p2:Number):Bool;
	...
	static function StatLoad(p0:Number):Bool;
	static function StatLoadPending(p0:Number):Bool;
	static function StatMigrateSave(platformName:String):Bool;
	static function N_0xa5c80d8e768a9e66(platformName:String):Bool;
	static function StatSave(p0:Number, p1:Bool, p2:Number):Bool;
	static function StatSaveMigrationCancel():Bool;
	static function N_0x4fef53183c3c6414():Bool;
	static function StatSaveMigrationConsumeContentUnlock(contentId:Number, srcPlatform:String, srcGamerHandle:String):Bool;
	static function N_0x3270f67eed31fbc1(contentId:Number, srcPlatform:String, srcGamerHandle:String):Bool;
	static function StatSaveMigrationStatusStart():Bool;
	static function N_0xc70ddce56d0d3a99():Bool;
	...
	static function N_0xf434a10ba01c37d0(toggle:Bool):Void;
	static function StatSetBool(statName:Number, value:Bool, save:Bool):Bool;
	static function StatSetBoolMasked(statName:Number, value:Bool, mask:Number, save:Bool):Bool;
	static function StatSetCheatIsActive():Void;
	static function N_0x047cbed6f6f8b63c():Void;
	static function StatSetCurrentPosixTime(statName:Number, p1:Bool):Bool;
	static function StatSetDate(statName:Number, numFields:Number, save:Bool):StatSetDateReturnType;
	static function StatSetFloat(statName:Number, value:Number, save:Bool):Bool;
	static function StatSetGxtLabel(statName:Number, value:String, save:Bool):Bool;
	static function StatSetInt(statName:Number, value:Number, save:Bool):Bool;
	static function StatSetLicensePlate(statName:Number, str:String):Bool;
	static function StatSetMaskedInt(statName:Number, p1:Number, p2:Number, p3:Number, save:Bool):Bool;
	static function StatSetPos(statName:Number, x:Number, y:Number, z:Number, save:Bool):Bool;
	...
	static function StatSetString(statName:Number, value:String, save:Bool):Bool;
	static function StatSetUserId(statName:Number, value:String, save:Bool):Bool;
	static function StatSlotIsLoaded(p0:Number):Bool;
	...
	static function StopAnimPlayback(ped:Number, p1:Number, p2:Bool):Void;
	...
	static function StopCamShaking(cam:Number, p1:Bool):Void;
	...
	static function StopParticleFxLooped(ptfxHandle:Number, p1:Bool):Void;
	static function StopPedRingtone(ped:Number):Void;
	static function StopPedSpeaking(ped:Number, shaking:Bool):Void;
	...
	static function StopRenderingScriptCamsUsingCatchUp(render:Bool, p1:Number, p2:Number):Void;
	static function N_0xc819f3cbb62bf692(render:Bool, p1:Number, p2:Number):Void;
	static function RenderFirstPersonCam(render:Bool, p1:Number, p2:Number):Void;
	...
	static function N_0x1c9d7949fa533490(p0:Bool):Void;
	static function StopScriptedConversation(p0:Bool):Number;
	static function StopSound(soundId:Number):Void;
	static function StopStream():Void;
	static function StopSynchronizedAudioEvent(p0:Number):Bool;
	static function StopSynchronizedEntityAnim(entity:Number, p1:Number, p2:Bool):Bool;
	static function StopSynchronizedMapEntityAnim(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number):Bool;
	...
	static function StreamvolHasLoaded(unused:Number):Bool;
	static function N_0x7d41e9d2d17c5b2d(unused:Number):Bool;
	static function StreamvolIsValid(unused:Number):Bool;
	static function N_0x07c313f94746702c(unused:Number):Bool;
	...
	static function N_0x3d42b92563939375(name:String):Bool;
	static function SwitchToInputMappingScheme_2(name:String):Bool;
	static function N_0x4683149ed1dde7a1(name:String):Bool;
	...
	static function SwitchTrainTrack(trackId:Number, state:Bool):Void;
	...
	static function TaskAimGunAtCoord(ped:Number, x:Number, y:Number, z:Number, time:Number, p5:Bool, p6:Bool):Void;
	static function TaskAimGunAtEntity(ped:Number, entity:Number, duration:Number, p3:Bool):Void;
	static function TaskAimGunScripted(ped:Number, scriptTask:Number, p2:Bool, p3:Bool):Void;
	static function TaskAimGunScriptedWithTarget(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Bool):Void;
	...
	static function TaskClimb(ped:Number, unused:Bool):Void;
	...
	static function TaskDriveBy(driverPed:Number, targetPed:Number, targetVehicle:Number, targetX:Number, targetY:Number, targetZ:Number,
		distanceToShoot:Number, pedAccuracy:Number, p8:Bool, firingPattern:Number):Void;
	...
	static function TaskFollowNavMeshToCoord(ped:Number, x:Number, y:Number, z:Number, speed:Number, timeout:Number, stoppingRange:Number,
		persistFollowing:Bool, unk:Number):Void;
	...
	static function TaskFollowToOffsetOfEntity(ped:Number, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number, movementSpeed:Number,
		timeout:Number, stoppingRange:Number, persistFollowing:Bool):Void;
	static function TaskFollowWaypointRecording(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number):Void;
	static function TaskForceMotionState(ped:Number, state:Number, p2:Bool):Void;
	...
	static function TaskGoToCoordAndAimAtHatedEntitiesNearCoord(pedHandle:Number, goToLocationX:Number, goToLocationY:Number, goToLocationZ:Number,
		focusLocationX:Number, focusLocationY:Number, focusLocationZ:Number, speed:Number, shootAtEnemies:Bool, distanceToStopAt:Number,
		noRoadsDistance:Number, unkTrue:Bool, unkFlag:Number, aimingFlag:Number, firingPattern:Number):Void;
	static function TaskGoToCoordAnyMeans(ped:Number, x:Number, y:Number, z:Number, speed:Number, p5:Number, p6:Bool, walkingStyle:Number, p8:Number):Void;
	static function TaskGoToCoordAnyMeansExtraParams(ped:Number, x:Number, y:Number, z:Number, speed:Number, p5:Number, p6:Bool, walkingStyle:Number,
		p8:Number, p9:Number, p10:Number, p11:Number):Void;
	static function TaskGoToCoordAnyMeansExtraParamsWithCruiseSpeed(ped:Number, x:Number, y:Number, z:Number, speed:Number, p5:Number, p6:Bool,
	...
	static function TaskGoToCoordWhileAimingAtCoord(ped:Number, x:Number, y:Number, z:Number, aimAtX:Number, aimAtY:Number, aimAtZ:Number, moveSpeed:Number,
		shoot:Bool, p9:Number, p10:Number, p11:Bool, flags:Number, p13:Bool, firingPattern:Number):Void;
	static function TaskGoToCoordWhileAimingAtEntity(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Number, p8:Number, p9:Bool,
		p10:Number, p11:Bool, p12:Number, p13:Number):Void;
	...
	static function TaskGoToEntityWhileAimingAtCoord(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool, p7:Number, p8:Number, p9:Bool,
		p10:Bool, p11:Number):Void;
	static function TaskGoToEntityWhileAimingAtEntity(ped:Number, entityToWalkTo:Number, entityToAimAt:Number, speed:Number, shootatEntity:Bool, p5:Number,
		p6:Number, p7:Bool, p8:Bool, firingPattern:Number):Void;
	...
	static function TaskGuardCurrentPosition(p0:Number, p1:Number, p2:Number, p3:Bool):Void;
	static function TaskGuardSphereDefensiveArea(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Number):Void;
	static function TaskHandsUp(ped:Number, duration:Number, facingPed:Number, p3:Number, p4:Bool):Void;
	...
	static function TaskJump(ped:Number, unused:Bool):Void;
	...
	static function TaskMoveNetworkAdvancedByName(ped:Number, p1:String, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number,
		p9:Number, p10:Bool, animDict:String, flags:Number):Void;
	static function N_0xd5b35bea41919acb(ped:Number, p1:String, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Bool, animDict:String, flags:Number):Void;
	static function TaskMoveNetworkAdvanced(ped:Number, p1:String, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Bool, animDict:String, flags:Number):Void;
	static function TaskMoveNetworkByName(ped:Number, task:String, multiplier:Number, p3:Bool, animDict:String, flags:Number):Void;
	static function N_0x2d537ba194896636(ped:Number, task:String, multiplier:Number, p3:Bool, animDict:String, flags:Number):Void;
	static function TaskMoveNetwork(ped:Number, task:String, multiplier:Number, p3:Bool, animDict:String, flags:Number):Void;
	static function TaskMoveNetworkByNameWithInitParams(ped:Number, p1:String, p3:Number, p4:Bool, animDict:String, flags:Number):Number;
	static function TaskMoveNetworkScripted(ped:Number, p1:String, p3:Number, p4:Bool, animDict:String, flags:Number):Number;
	static function TaskOpenVehicleDoor(ped:Number, vehicle:Number, timeOut:Number, seat:Number, speed:Number):Void;
	static function TaskParachute(ped:Number, p1:Bool):Void;
	static function TaskParachuteToTarget(ped:Number, x:Number, y:Number, z:Number):Void;
	static function TaskPatrol(ped:Number, p1:String, p2:Number, p3:Bool, p4:Bool):Void;
	...
	static function TaskPlayAnim(ped:Number, animDictionary:String, animationName:String, blendInSpeed:Number, blendOutSpeed:Number, duration:Number,
		flag:Number, playbackRate:Number, lockX:Bool, lockY:Bool, lockZ:Bool):Void;
	...
	static function TaskPlayPhoneGestureAnimation(ped:Number, animDict:String, animation:String, boneMaskType:String, p4:Number, p5:Number, p6:Bool,
		p7:Bool):Void;
	static function TaskPutPedDirectlyIntoCover(ped:Number, x:Number, y:Number, z:Number, timeout:Number, p5:Bool, p6:Number, p7:Bool, p8:Bool, p9:Number,
		p10:Bool):Void;
	static function TaskPutPedDirectlyIntoMelee(ped:Number, meleeTarget:Number, p2:Number, p3:Number, p4:Number, p5:Bool):Void;
	...
	static function TaskReloadWeapon(ped:Number, unused:Bool):Void;
	static function TaskScriptedAnimation(ped:Number, p4:Number, p5:Number):TaskScriptedAnimationReturnType;
	static function TaskSeekCoverFromPed(ped:Number, target:Number, duration:Number, p3:Bool):Void;
	static function TaskSeekCoverFromPos(ped:Number, x:Number, y:Number, z:Number, duration:Number, p5:Bool):Void;
	static function TaskSeekCoverToCoords(ped:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, p7:Number, p8:Bool):Void;
	static function TaskSeekCoverToCoverPoint(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Bool):Void;
	static function TaskSetBlockingOfNonTemporaryEvents(ped:Number, toggle:Bool):Void;
	...
	static function TaskSmartFleeCoord(ped:Number, x:Number, y:Number, z:Number, distance:Number, time:Number, p6:Bool, p7:Bool):Void;
	static function TaskSmartFleePed(ped:Number, fleeTarget:Number, distance:Number, fleeTime:Number, p4:Bool, p5:Bool):Void;
	...
	static function TaskStartScenarioAtPosition(ped:Number, scenarioName:String, x:Number, y:Number, z:Number, heading:Number, duration:Number,
		sittingScenario:Bool, teleport:Bool):Void;
	static function TaskStartScenarioInPlace(ped:Number, scenarioName:String, unkDelay:Number, playEnterAnim:Bool):Void;
	...
	static function TaskSwapWeapon(ped:Number, p1:Bool):Void;
	...
	static function TaskVehicleMissionCoorsTarget(ped:Number, vehicle:Number, x:Number, y:Number, z:Number, p5:Number, p6:Number, p7:Number, p8:Number,
		p9:Number, DriveAgainstTraffic:Bool):Void;
	static function TaskVehicleMissionPedTarget(ped:Number, vehicle:Number, pedTarget:Number, missionType:Number, maxSpeed:Number, drivingStyle:Number,
		minDistance:Number, p7:Number, DriveAgainstTraffic:Bool):Void;
	...
	static function N_0xa356990e161c9e65(toggle:Bool):Void;
	...
	static function TextureDownloadHasFailed(p0:Number):Bool;
	static function N_0x5776ed562c134687(p0:Number):Bool;
	static function TextureDownloadRelease(p0:Number):Void;
	static function TextureDownloadRequest(FilePath:String, Name:String, p3:Bool):TextureDownloadRequestReturnType;
	...
	static function N_0xa9cbfd40b3fa3010():Bool;
	static function ThefeedOnlyShowTooltips(toggle:Bool):Void;
	static function N_0x6f1554b0cc2089fa(toggle:Bool):Void;
	...
	static function N_0x4a0c7c9bb10abb36(toggle:Bool):Void;
	static function ThefeedSetFlushAnimpostfx(toggle:Bool):Void;
	static function N_0xbae4f9b97cd43b30(toggle:Bool):Void;
	...
	static function TitleTextureDownloadRequest(FilePath:String, Name:String, p2:Bool):Number;
	static function N_0x0b203b4afde53a4f(FilePath:String, Name:String, p2:Bool):Number;
	static function ToFloat(value:Number):Number;
	static function TogglePausedRenderphases(toggle:Bool):Void;
	static function EnableGameplayCam(toggle:Bool):Void;
	static function SetFrozenRenderingDisabled(toggle:Bool):Void;
	static function ToggleStealthRadar(toggle:Bool):Void;
	static function ToggleUsePickupsForPlayer(player:Number, pickupHash:Number, toggle:Bool):Void;
	static function N_0x616093ec6b139dd9(player:Number, pickupHash:Number, toggle:Bool):Void;
	static function ToggleVehicleMod(vehicle:Number, modType:Number, toggle:Bool):Void;
	static function TrackObjectVisibility(object:Number):Void;
	static function TrackVehicleVisibility(vehicle:Number):Void;
	static function TransformToCar(vehicle:Number, instantly:Bool):Void;
	static function N_0x2a69ffd1b42bff9e(vehicle:Number, instantly:Bool):Void;
	static function TransformStormbergToRoadVehicle(vehicle:Number, instantly:Bool):Void;
	static function TransformSubmarineToVehicle(vehicle:Number, instantly:Bool):Void;
	static function TransformToSubmarine(vehicle:Number, instantly:Bool):Void;
	static function N_0xbe4c854ffdb6eebe(vehicle:Number, instantly:Bool):Void;
	static function TransformStormbergToWaterVehicle(vehicle:Number, instantly:Bool):Void;
	static function TransformVehicleToSubmarine(vehicle:Number, instantly:Bool):Void;
	...
	static function TriggerScreenblurFadeIn(transitionTime:Number):Bool;
	static function TransitionToBlurred(transitionTime:Number):Bool;
	static function TriggerScreenblurFadeOut(transitionTime:Number):Bool;
	static function TransitionFromBlurred(transitionTime:Number):Bool;
	static function TriggerScriptCrcCheckOnPlayer(player:Number, p1:Number, scriptHash:Number):Bool;
	static function N_0x46fb3ed415c7641c(player:Number, p1:Number, scriptHash:Number):Bool;
	static function NetworkIsPlayerInScript(player:Number, p1:Number, scriptHash:Number):Bool;
	...
	static function N_0xa5efc3e847d60507(contentName:String, description:String, tagsCsv:String, contentTypeName:String, publish:Bool):Bool;
	...
	static function UgcGetContentHasPlayerBookmarked(p0:Number):Bool;
	static function N_0x993cbe59d350d225(p0:Number):Bool;
	static function UgcGetContentHasPlayerRecord(p0:Number):Bool;
	static function N_0x70ea8da57840f9be(p0:Number):Bool;
	...
	static function UgcGetContentIsPublished(p0:Number):Bool;
	static function N_0x3054f114121c21ea(p0:Number):Bool;
	static function UgcGetContentIsVerified(p0:Number):Bool;
	static function N_0xa9240a96c74cca13(p0:Number):Bool;
	...
	static function N_0x5e24341a7f92a74b():Bool;
	static function UgcHasGetFinished():Bool;
	static function N_0x02ada21ea2f6918f():Bool;
	static function UgcHasModifyFinished():Bool;
	static function N_0x299ef3c576773506():Bool;
	static function UgcIsGetting():Bool;
	static function N_0xd53acdbef24a46e8():Bool;
	static function UgcIsLanguageSupported(p0:Number):Bool;
	static function N_0xf53e48461b71eecb(p0:Number):Bool;
	static function UgcPoliciesMakePrivate(p0:Number):Bool;
	static function N_0x5cae833b0ee0c500(p0:Number):Bool;
	static function UgcPublish(contentId:String, baseContentId:String, contentTypeName:String):Bool;
	static function N_0x1de0f5f50d723caa(contentId:String, baseContentId:String, contentTypeName:String):Bool;
	static function UgcQueryByContentId(contentId:String, latestVersion:Bool, contentTypeName:String):Bool;
	static function N_0x158ec424f35ec469(contentId:String, latestVersion:Bool, contentTypeName:String):Bool;
	static function UgcQueryByContentIds(count:Number, latestVersion:Bool, contentTypeName:String):UgcQueryByContentIdsReturnType;
	static function N_0xc7397a83f7a2a462(count:Number, latestVersion:Bool, contentTypeName:String):N_0xc7397a83f7a2a462ReturnType;
	...
	static function UgcQueryRecentlyCreatedContent(offset:Number, count:Number, contentTypeName:String, p3:Number):Bool;
	static function N_0x6d4cb481fac835e8(offset:Number, count:Number, contentTypeName:String, p3:Number):Bool;
	...
	static function N_0x274a1519dfc1094f(contentId:String, bookmarked:Bool, contentTypeName:String):Bool;
	static function UgcSetDeleted(p1:Bool):UgcSetDeletedReturnType;
	static function N_0xd05d1a6c74da3498(p1:Bool):N_0xd05d1a6c74da3498ReturnType;
	static function UgcSetPlayerData(contentId:String, rating:Number, contentTypeName:String):Bool;
	static function N_0x692d808c34a82143(contentId:String, rating:Number, contentTypeName:String):Bool;
	static function UgcSetQueryDataFromOffline(p0:Bool):Void;
	static function N_0xf98dde0a8ed09323(p0:Bool):Void;
	static function UgcTextureDownloadRequest(p1:Number, p2:Number, p3:Number, p5:Bool):UgcTextureDownloadRequestReturnType;
	static function N_0x308f96458b7087cc(p1:Number, p2:Number, p3:Number, p5:Bool):N_0x308f96458b7087ccReturnType;
	...
	static function N_0x4645de9980999e93(contentId:String, contentName:String, description:String, tagsCsv:String, contentTypeName:String):Bool;
	static function Ui3dsceneIsAvailable():Bool;
	static function N_0xd3a10fc7fd8d98cd():Bool;
	static function Ui3dscenePushPreset(presetName:String):Bool;
	static function N_0xf1cea8a4198d8e9a(presetName:String):Bool;
	static function UiIsSingleplayerPauseMenuActive():Bool;
	static function N_0xea2f2061875eed90():Bool;
	...
	static function UpdatePlayerTeleport(player:Number):Bool;
	static function N_0xe23d5873c2394c61(player:Number):Bool;
	static function HasPlayerTeleportFinished(player:Number):Bool;
	static function UpdateTaskAimGunScriptedTarget(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Bool):Void;
	...
	static function N_0x170f541e1cadd1de(p0:Bool):Void;
	...
	static function UseSirenAsHorn(vehicle:Number, toggle:Bool):Void;
	static function UseStuntCameraThisFrame():Void;
	static function N_0x6493cf69859b116a():Void;
	static function UseWaypointRecordingAsAssistedMovementRoute(name:String, p1:Bool, p2:Number, p3:Number):Void;
	...
	static function WasPedKilledByStealth(ped:Number):Bool;
	static function WasPedKilledByTakedown(ped:Number):Bool;
	static function WasPedKnockedOut(ped:Number):Bool;
	static function N_0x61767f73eaceed21(ped:Number):Bool;
	static function WasPedSkeletonUpdated(ped:Number):Bool;
	...
	static function WaypointPlaybackGetIsPaused(p0:Number):Bool;
	static function WaypointPlaybackOverrideSpeed(p0:Number, p1:Number, p2:Bool):Void;
	static function WaypointPlaybackPause(p0:Number, p1:Bool, p2:Bool):Void;
	static function WaypointPlaybackResume(p0:Number, p1:Bool, p2:Number, p3:Number):Void;
	static function WaypointPlaybackStartAimingAtCoord(p0:Number, p1:Number, p2:Number, p3:Number, p4:Bool):Void;
	static function WaypointPlaybackStartAimingAtPed(p0:Number, p1:Number, p2:Bool):Void;
	static function WaypointPlaybackStartShootingAtCoord(p0:Number, p1:Number, p2:Number, p3:Number, p4:Bool, p5:Number):Void;
	static function WaypointPlaybackStartShootingAtPed(p0:Number, p1:Number, p2:Bool, p3:Number):Void;
	static function N_0xe70ba7b90f8390dc(p0:Number, p1:Number, p2:Bool, p3:Number):Void;
	...
	static function WouldEntityBeOccluded(entityModelHash:Number, x:Number, y:Number, z:Number, p4:Bool):Bool;
	static function vector3(x:Number, y:Number, z:Number):Vector3;
}
