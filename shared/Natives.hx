...
extern class Natives {
	...
	static function AppGetInt(property:Int):Int;
	static function AppGetDeletedFileStatus():Int;
	static function AppDeleteAppData(appName:Int):Bool;
	static function AppGetFloat(property:Int):Float;
	static function AppSaveData():Void;
	static function AppHasLinkedSocialClubAccount():Bool;
	static function AppGetString(property:Int):Int;
	static function AppHasSyncedData(appName:Int):Bool;
	static function AppSetInt(property:Int, value:Int):Void;
	static function AppSetBlock(blockName:Int):Void;
	static function AppSetApp(appName:Int):Void;
	static function AppSetFloat(property:Int, value:Float):Void;
	static function AppSetString(property:Int, value:Int):Void;
	static function AddScriptToRandomPed(name:Int, model:Int, p2:Float, p3:Float):Void;
	...
	static function RegisterObjectScriptBrain(scriptName:Int, modelHash:Int, p2:Int, activationRange:Float, p4:Int, p5:Int):Void;
	static function RegisterWorldPointScriptBrain(scriptName:Int, activationRange:Float, p2:Int):Void;
	static function AddEntityToAudioMixGroup(entity:Int, groupName:Int, p2:Float):Void;
	static function AddPedToConversation(index:Int, ped:Int, p2:Int):Void;
	static function ActivateAudioSlowmoMode(p0:Int):Void;
	static function AddLineToConversation(index:Int, p1:Int, p2:Int, p3:Int, p4:Int, p5:Bool, p6:Bool, p7:Bool, p8:Bool, p9:Int, p10:Bool, p11:Bool,
		p12:Bool):Void;
	static function BlipSiren(vehicle:Int):Void;
	static function CanPedSpeak(ped:Int, speechName:Int, unk:Bool):Bool;
	static function BlockDeathJingle(toggle:Bool):Void;
	static function AudioIsScriptedMusicPlaying():Bool;
	static function CancelMusicEvent(eventName:Int):Bool;
	...
	static function ClearAmbientZoneState(zoneName:Int, p1:Bool):Void;
	static function DeactivateAudioSlowmoMode(p0:Int):Void;
	static function ClearCustomRadioTrackList(radioStation:Int):Void;
	...
	static function ForceRadioTrackListPosition(radioStation:Int, trackListName:Int, milliseconds:Int):Void;
	...
	static function ForceVehicleEngineAudio(vehicle:Int, audioName:Int):Void;
	static function FreezeMicrophone():Void;
	static function GetAmbientVoiceNameHash(ped:Int):Int;
	static function FreezeRadioStation(radioStation:Int):Void;
	...
	static function GetCurrentRadioTrackName(radioStationName:Int):Int;
	static function GetPlayerRadioStationGenre():Int;
	static function GetCurrentRadioTrackPlaybackTime(radioStationName:Int):Int;
	...
	static function GetPlayerRadioStationName():Int;
	...
	static function GetRadioStationName(radioStation:Int):Int;
	...
	static function InterruptConversationAndPause(ped:Int, p1:Int, p2:Int):Void;
	static function IsAmbientZoneEnabled(ambientZone:Int):Bool;
	static function IsAlarmPlaying(alarmName:Int):Bool;
	...
	static function IsAudioSceneActive(scene:Int):Bool;
	...
	static function IsRadioStationVisible(radioStation:Int):Bool;
	...
	static function LinkStaticEmitterToEntity(emitterName:Int, entity:Int):Void;
	static function LoadStreamWithStartOffset(streamName:Int, startOffset:Int, soundSet:Int):Bool;
	static function LockRadioStation(radioStationName:Int, toggle:Bool):Void;
	static function LoadStream(streamName:Int, soundSet:Int):Bool;
	static function LockRadioStationTrackList(radioStation:Int, trackListName:Int):Void;
	...
	static function OverrideTrevorRage(voiceEffect:Int):Void;
	...
	static function PlayAmbientSpeechFromPositionNative(speechName:Int, voiceName:Int, x:Float, y:Float, z:Float, speechParam:Int):Void;
	static function PlayAnimalVocalization(pedHandle:Int, p1:Int, speechName:Int):Void;
	static function PlayPedAmbientSpeechAndCloneNative(ped:Int, speechName:Int, speechParam:Int):Void;
	static function PlayDeferredSoundFrontend(soundName:Int, soundsetName:Int):Void;
	static function PlayMissionCompleteAudio(audioName:Int):Void;
	static function PlayPedAmbientSpeechWithVoiceNative(ped:Int, speechName:Int, voiceName:Int, speechParam:Int, p4:Bool):Void;
	static function PlayPedAmbientSpeechNative(ped:Int, speechName:Int, speechParam:Int):Void;
	static function PlaySoundFrontend(soundId:Int, audioName:Int, audioRef:Int, p3:Bool):Void;
	static function PlayPedRingtone(ringtoneName:Int, ped:Int, p2:Bool):Void;
	static function PlayPain(ped:Int, painID:Int, p1:Int):Void;
	static function PlaySound(soundId:Int, audioName:Int, audioRef:Int, p3:Bool, p4:Int, p5:Bool):Void;
	static function PlayStreamFromVehicle(vehicle:Int):Void;
	static function PlaySoundFromCoord(soundId:Int, audioName:Int, x:Float, y:Float, z:Float, audioRef:Int, isNetwork:Bool, range:Int, p8:Bool):Void;
	static function PlayPoliceReport(name:Int, p1:Float):Int;
	...
	static function PlaySoundFromEntity(soundId:Int, audioName:Int, entity:Int, audioRef:Int, isNetwork:Bool, p5:Int):Void;
	static function PlayStreamFrontend():Void;
	static function PlayVehicleDoorCloseSound(vehicle:Int, doorIndex:Int):Void;
	static function PrepareAlarm(alarmName:Int):Bool;
	...
	static function PrepareMusicEvent(eventName:Int):Bool;
	static function PreloadVehicleAudio(model:Int):Void;
	static function PrepareSynchronizedAudioEvent(p0:Int, p1:Int):Int;
	...
	static function ReleaseNamedScriptAudioBank(audioBank:Int):Void;
	static function RequestAmbientAudioBank(p0:Int, p1:Bool):Bool;
	static function RemovePortalSettingsOverride(p0:Int):Void;
	static function RequestMissionAudioBank(p0:Int, p1:Bool):Bool;
	static function RemoveEntityFromAudioMixGroup(entity:Int, p1:Float):Void;
	static function ResetPedAudioFlags(ped:Int):Void;
	static function RequestScriptAudioBank(p0:Int, p1:Bool):Bool;
	...
	static function SetAmbientZoneListStatePersistent(ambientZone:Int, p1:Bool, p2:Bool):Void;
	static function SetAmbientVoiceName(ped:Int, name:Int):Void;
	static function SetAudioFlag(flagName:Int, toggle:Bool):Void;
	static function SetAmbientZoneListState(p0:Int, p1:Bool, p2:Bool):Void;
	static function SetAmbientVoiceNameHash(ped:Int, hash:Int):Void;
	static function SetAmbientZoneState(zoneName:Int, p1:Bool, p2:Bool):Void;
	static function SetAnimalMood(animal:Int, mood:Int):Void;
	static function SetAmbientZoneStatePersistent(ambientZone:Int, p1:Bool, p2:Bool):Void;
	static function SetAudioVehiclePriority(vehicle:Int, p1:Int):Void;
	static function SetAudioSceneVariable(scene:Int, variable:Int, value:Float):Void;
	...
	static function SetCustomRadioTrackList(radioStation:Int, trackListName:Int, p2:Bool):Void;
	static function SetEmitterRadioStation(emitterName:Int, radioStation:Int):Void;
	static function SetCutsceneAudioOverride(name:Int):Void;
	static function SetGpsActive(active:Bool):Void;
	static function SetHornEnabled(vehicle:Int, toggle:Bool):Void;
	static function SetInitialPlayerStation(radioStation:Int):Void;
	...
	static function SetPortalSettingsOverride(p0:Int, p1:Int):Void;
	static function SetPedVoiceGroupRace(ped:Int, voiceGroupHash:Int):Void;
	static function SetRadioStationIsVisible(radioStation:Int, toggle:Bool):Void;
	static function SetRadioAutoUnfreeze(toggle:Bool):Void;
	static function SetRadioStationMusicOnly(radioStation:Int, toggle:Bool):Void;
	static function SetRadioFrontendFadeTime(fadeTime:Float):Void;
	static function SetRadioToStationIndex(radioStation:Int):Void;
	static function SetRadioToStationName(stationName:Int):Void;
	static function SetRadioTrack(radioStation:Int, radioTrack:Int):Void;
	static function SetRadioTrackMix(radioStationName:Int, mixName:Int, p2:Int):Void;
	static function SetScriptUpdateDoorAudio(doorHash:Int, toggle:Bool):Void;
	static function SetSynchronizedAudioEventPositionThisFrame(p0:Int, p1:Int):Void;
	static function SetSirenKeepOn(vehicle:Int, toggle:Bool):Void;
	static function SetStaticEmitterEnabled(emitterName:Int, toggle:Bool):Void;
	static function SetSirenWithNoDriver(vehicle:Int, toggle:Bool):Void;
	static function SetVariableOnSound(soundId:Int, variableName:Int, value:Float):Void;
	static function SetUserRadioControlEnabled(toggle:Bool):Void;
	static function SetVariableOnCutsceneAudio(variableName:Int, value:Float):Void;
	static function SetVariableOnStream(p0:Int, p1:Float):Void;
	static function SetVehHasRadioOverride(vehicle:Int):Void;
	static function SetVariableOnUnderWaterStream(variableName:Int, value:Float):Void;
	static function SetVehicleAudioBodyDamageFactor(vehicle:Int, intensity:Float):Void;
	static function SetVehRadioStation(vehicle:Int, radioStation:Int):Void;
	...
	static function SetVehicleStartupRevSound(vehicle:Int, p1:Int, p2:Int):Void;
	...
	static function StopAlarm(alarmName:Int, toggle:Bool):Void;
	static function StopAllAlarms(stop:Bool):Void;
	static function StopAudioScenes():Void;
	static function StopAudioScene(scene:Int):Void;
	...
	static function TriggerMusicEvent(eventName:Int):Bool;
	static function StopSound(soundId:Int):Void;
	static function TriggerSiren(vehicle:Int):Void;
	static function UnfreezeRadioStation(radioStation:Int):Void;
	static function UnlockMissionNewsStory(newsStory:Int):Void;
	static function UnregisterScriptWithAudio():Void;
	static function UnlockRadioStationTrackList(radioStation:Int, trackListName:Int):Void;
	...
	static function CanSetEnterStateForRegisteredEntity(cutsceneEntName:Int, modelHash:Int):Bool;
	static function GetCutFileNumSections(cutsceneName:Int):Int;
	static function CanSetExitStateForCamera(p0:Bool):Bool;
	static function DoesCutsceneEntityExist(cutsceneEntName:Int, modelHash:Int):Bool;
	static function CanSetExitStateForRegisteredEntity(cutsceneEntName:Int, modelHash:Int):Bool;
	...
	static function GetEntityIndexOfCutsceneEntity(cutsceneEntName:Int, modelHash:Int):Int;
	static function GetEntityIndexOfRegisteredEntity(cutsceneEntName:Int, modelHash:Int):Int;
	static function HasCutFileLoaded(cutsceneName:Int):Bool;
	static function HasCutsceneFinished():Bool;
	static function HasCutsceneLoaded():Bool;
	static function HasThisCutsceneLoaded(cutsceneName:Int):Bool;
	...
	static function RemoveCutFile(cutsceneName:Int):Void;
	static function RegisterEntityForCutscene(cutsceneEntity:Int, cutsceneEntName:Int, p2:Int, modelHash:Int, p4:Int):Void;
	static function RemoveCutscene():Void;
	static function RequestCutsceneWithPlaybackList(cutsceneName:Int, playbackFlags:Int, flags:Int):Void;
	static function RequestCutFile(cutsceneName:Int):Void;
	static function RequestCutscene(cutsceneName:Int, flags:Int):Void;
	static function SetCutsceneCanBeSkipped(p0:Bool):Void;
	static function SetCutscenePedComponentVariation(cutsceneEntName:Int, componentId:Int, drawableId:Int, textureId:Int, modelHash:Int):Void;
	static function SetCutsceneOrigin(x:Float, y:Float, z:Float, heading:Float, p4:Int):Void;
	static function SetCutsceneEntityStreamingFlags(cutsceneEntName:Int, p1:Int, p2:Int):Void;
	static function SetCutscenePedComponentVariationFromPed(cutsceneEntName:Int, ped:Int, modelHash:Int):Void;
	static function StartCutscene(flags:Int):Void;
	static function SetCutsceneFadeValues(p0:Bool, p1:Bool, p2:Bool, p3:Bool):Void;
	static function SetCutscenePedPropVariation(cutsceneEntName:Int, componentId:Int, drawableId:Int, textureId:Int, modelHash:Int):Void;
	...
	static function AnimatedShakeCam(cam:Int, p1:Int, p2:Int, p3:Int, amplitude:Float):Void;
	static function AnimateGameplayCamZoom(p0:Float, distance:Float):Void;
	static function AnimatedShakeScriptGlobal(p0:Int, p1:Int, p2:Int, p3:Float):Void;
	...
	static function CreateCam(camName:Int, active:Bool):Int;
	...
	static function CreateCamWithParams(camName:Int, posX:Float, posY:Float, posZ:Float, rotX:Float, rotY:Float, rotZ:Float, fov:Float, active:Bool,
		rotationOrder:Int):Int;
	...
	static function IsCamPlayingAnim(cam:Int, animName:Int, animDictionary:Int):Bool;
	...
	static function PlayCamAnim(cam:Int, animName:Int, animDictionary:Int, x:Float, y:Float, z:Float, xRot:Float, yRot:Float, zRot:Float, p9:Bool,
		p10:Int):Bool;
	static function PlaySynchronizedCamAnim(camera:Int, scene:Int, animName:Int, animDictionary:Int):Bool;
	...
	static function SetCamDebugName(camera:Int, name:Int):Void;
	...
	static function SetFollowPedCamThisUpdate(camName:Int, p1:Int):Bool;
	...
	static function SetGameplayCamHash(camName:Int):Void;
	...
	static function SetGameplayCamVehicleCamera(vehicleName:Int):Void;
	...
	static function ShakeCam(cam:Int, type:Int, amplitude:Float):Void;
	static function ShakeCinematicCam(p0:Int, p1:Float):Void;
	static function ShakeScriptGlobal(p0:Int, p1:Float):Void;
	static function StopCamShaking(cam:Int, p1:Bool):Void;
	static function ShakeGameplayCam(shakeName:Int, intensity:Float):Void;
	...
	static function DataarrayAddString(arrayData:Int, value:Int):Void;
	...
	static function DataarrayGetString(arrayData:Int, arrayIndex:Int):Int;
	static function DatadictCreateArray(objectData:Int, key:Int):Int;
	static function DatadictGetArray(objectData:Int, key:Int):Int;
	static function DataarrayGetVector(arrayData:Int, arrayIndex:Int):Vector3;
	static function DatadictCreateDict(objectData:Int, key:Int):Int;
	static function DatadictGetInt(objectData:Int, key:Int):Int;
	static function DatadictGetBool(objectData:Int, key:Int):Bool;
	static function DatadictGetDict(objectData:Int, key:Int):Int;
	static function DatadictGetVector(objectData:Int, key:Int):Vector3;
	static function DatadictGetString(objectData:Int, key:Int):Int;
	static function DatadictGetFloat(objectData:Int, key:Int):Float;
	static function DatadictGetType(objectData:Int, key:Int):Int;
	static function DatadictSetBool(objectData:Int, key:Int, value:Bool):Void;
	static function DatadictSetFloat(objectData:Int, key:Int, value:Float):Void;
	static function DatadictSetString(objectData:Int, key:Int, value:Int):Void;
	static function DatadictSetInt(objectData:Int, key:Int, value:Int):Void;
	static function DatafileDelete():Void;
	static function DatadictSetVector(objectData:Int, key:Int, valueX:Float, valueY:Float, valueZ:Float):Void;
	...
	static function DatafileGetFileDict():Int;
	static function DatafileSelectUgcData(p0:Int):Bool;
	static function DatafileLoadOfflineUgc(filename:Int):Bool;
	...
	static function DatafileStartSaveToCloud(filename:Int):Bool;
	static function DatafileSelectUgcPlayerData(p0:Int):Bool;
	static function DatafileWatchRequestId(id:Int):Void;
	static function UgcCreateMission(contentName:Int, description:Int, tagsCsv:Int, contentTypeName:Int, publish:Bool):Bool;
	static function UgcCreateContent(data:Int, dataCount:Int, contentName:Int, description:Int, tagsCsv:Int, contentTypeName:Int, publish:Bool):Bool;
	static function UgcSetPlayerData(contentId:Int, rating:Float, contentTypeName:Int):Bool;
	static function UgcUpdateContent(contentId:Int, data:Int, dataCount:Int, contentName:Int, description:Int, tagsCsv:Int, contentTypeName:Int):Bool;
	static function UgcUpdateMission(contentId:Int, contentName:Int, description:Int, tagsCsv:Int, contentTypeName:Int):Bool;
	static function DecorExistOn(entity:Int, propertyName:Int):Bool;
	static function DecorGetBool(entity:Int, propertyName:Int):Bool;
	static function DecorGetFloat(entity:Int, propertyName:Int):Float;
	static function DecorRegister(propertyName:Int, type:Int):Void;
	static function DecorRegisterLock():Void;
	static function DecorIsRegisteredAsType(propertyName:Int, type:Int):Bool;
	static function DecorGetInt(entity:Int, propertyName:Int):Int;
	static function DecorRemove(entity:Int, propertyName:Int):Bool;
	static function DecorSetBool(entity:Int, propertyName:Int, value:Bool):Bool;
	static function DecorSetFloat(entity:Int, propertyName:Int, value:Float):Bool;
	static function DecorSetInt(entity:Int, propertyName:Int, value:Int):Bool;
	static function DecorSetTime(entity:Int, propertyName:Int, timestamp:Int):Bool;
	...
	static function FindAnimEventPhase(animDictionary:Int, animName:Int, p2:Int, p3:Int, p4:Int):Bool;
	...
	static function GetEntityAnimTotalTime(entity:Int, animDict:Int, animName:Int):Float;
	static function GetEntityAnimCurrentTime(entity:Int, animDict:Int, animName:Int):Float;
	static function GetAnimDuration(animDict:Int, animName:Int):Float;
	static function GetEntityBoneIndexByName(entity:Int, boneName:Int):Int;
	...
	static function GetEntityScript(entity:Int, script:Int):Int;
	...
	static function HasEntityAnimFinished(entity:Int, animDict:Int, animName:Int, p3:Int):Bool;
	...
	static function IsEntityInZone(entity:Int, zone:Int):Bool;
	...
	static function IsEntityPlayingAnim(entity:Int, animDict:Int, animName:Int, taskFlag:Int):Bool;
	...
	static function PlayEntityAnim(entity:Int, animName:Int, animDict:Int, p3:Float, loop:Bool, stayInAnim:Bool, p6:Bool, delta:Float, bitset:Int):Bool;
	static function PlaySynchronizedEntityAnim(entity:Int, syncedScene:Int, animation:Int, propName:Int, p4:Float, p5:Float, p6:Int, p7:Float):Bool;
	...
	static function SetEntityAnimSpeed(entity:Int, animDictionary:Int, animName:Int, speedMultiplier:Float):Void;
	static function SetEntityAnimCurrentTime(entity:Int, animDictionary:Int, animName:Int, time:Float):Void;
	...
	static function StopEntityAnim(entity:Int, animation:Int, animGroup:Int, p3:Float):Int;
	...
	static function AddEntityIcon(entity:Int, icon:Int):Int;
	...
	static function AddTcmodifierOverride(modifierName1:Int, modifierName2:Int):Void;
	static function AnimpostfxIsRunning(effectName:Int):Bool;
	static function AnimpostfxPlay(effectName:Int, duration:Int, looped:Bool):Void;
	static function AnimpostfxStop(effectName:Int):Void;
	...
	static function BeginScaleformMovieMethodOnFrontendHeader(functionName:Int):Bool;
	static function BeginScaleformMovieMethod(scaleform:Int, methodName:Int):Bool;
	...
	static function BeginScaleformScriptHudMovieMethod(hudComponent:Int, methodName:Int):Bool;
	static function AnimpostfxGetUnk(effectName:Int):Float;
	static function CallScaleformMovieMethod(scaleform:Int, method:Int):Void;
	static function AnimpostfxStopAndDoUnk(effectName:Int):Void;
	static function CallScaleformMovieMethodWithString(scaleform:Int, methodName:Int, param1:Int, param2:Int, param3:Int, param4:Int, param5:Int):Void;
	static function CallScaleformMovieMethodWithNumberAndString(scaleform:Int, methodName:Int, floatParam1:Float, floatParam2:Float, floatParam3:Float,
		floatParam4:Float, floatParam5:Float, stringParam1:Int, stringParam2:Int, stringParam3:Int, stringParam4:Int, stringParam5:Int):Void;
	static function CascadeShadowsInitSession():Void;
	static function BeginScaleformMovieMethodOnFrontend(functionName:Int):Bool;
	...
	static function BeginTextCommandScaleformString(textLabel:Int):Void;
	static function CascadeShadowsEnableEntityTracker(toggle:Bool):Void;
	static function CallScaleformMovieMethodWithNumber(scaleform:Int, methodName:Int, param1:Float, param2:Float, param3:Float, param4:Float,
		param5:Float):Void;
	static function CascadeShadowsSetShadowSampleType(type:Int):Void;
	...
	static function DrawDebugText2d(text:Int, x:Float, y:Float, z:Float, red:Int, green:Int, blue:Int, alpha:Int):Void;
	...
	static function DrawInteractiveSprite(textureDict:Int, textureName:Int, screenX:Float, screenY:Float, width:Float, height:Float, heading:Float, red:Int,
	...
	static function DrawDebugText(text:Int, x:Float, y:Float, z:Float, red:Int, green:Int, blue:Int, alpha:Int):Void;
	...
	static function DrawMarker2(type:Int, posX:Float, posY:Float, posZ:Float, dirX:Float, dirY:Float, dirZ:Float, rotX:Float, rotY:Float, rotZ:Float,
		...
		textureDict:Int, textureName:Int, drawOnEnts:Bool, p24:Bool):Void;
	...
	static function DrawMarker(type:Int, posX:Float, posY:Float, posZ:Float, dirX:Float, dirY:Float, dirZ:Float, rotX:Float, rotY:Float, rotZ:Float,
		scaleX:Float, scaleY:Float, scaleZ:Float, red:Int, green:Int, blue:Int, alpha:Int, bobUpAndDown:Bool, faceCamera:Bool, p19:Int, rotate:Bool,
		textureDict:Int, textureName:Int, drawOnEnts:Bool):Void;
	static function DrawRect(x:Float, y:Float, width:Float, height:Float, r:Int, g:Int, b:Int, a:Int):Void;
	static function DrawShowroom(p0:Int, ped:Int, p2:Int, posX:Float, posY:Float, posZ:Float):Bool;
	...
	static function DrawSprite(textureDict:Int, textureName:Int, screenX:Float, screenY:Float, width:Float, height:Float, heading:Float, red:Int, green:Int,
		blue:Int, alpha:Int):Void;
	...
	static function DrawSpriteUv(textureDict:Int, textureName:Int, x:Float, y:Float, width:Float, height:Float, u1:Float, v1:Float, u2:Float, v2:Float,
	...
	static function DrawSpritePoly2(x1:Float, y1:Float, z1:Float, x2:Float, y2:Float, z2:Float, x3:Float, y3:Float, z3:Float, red1:Float, green1:Float,
		blue1:Float, alpha1:Int, red2:Float, green2:Float, blue2:Float, alpha2:Int, red3:Float, green3:Float, blue3:Float, alpha3:Int, textureDict:Int,
		textureName:Int, u1:Float, v1:Float, w1:Float, u2:Float, v2:Float, w2:Float, u3:Float, v3:Float, w3:Float):Void;
	static function DrawSpritePoly(x1:Float, y1:Float, z1:Float, x2:Float, y2:Float, z2:Float, x3:Float, y3:Float, z3:Float, red:Int, green:Int, blue:Int,
		alpha:Int, textureDict:Int, textureName:Int, u1:Float, v1:Float, w1:Float, u2:Float, v2:Float, w2:Float, u3:Float, v3:Float, w3:Float):Void;
	...
	static function GetScaleformMovieMethodReturnValueString(method_return:Int):Int;
	static function GetScreenResolution(x:Int, y:Int):Void;
	static function GetStatusOfLoadMissionCreatorPhoto(p0:Int):Int;
	static function GetStatusOfSaveHighQualityPhoto():Int;
	static function GetTextureResolution(textureDict:Int, textureName:Int):Vector3;
	...
	static function HasStreamedTextureDictLoaded(textureDict:Int):Bool;
	...
	static function LoadMissionCreatorPhoto(p0:Int, p1:Int, p2:Int, p3:Bool):Bool;
	static function HasScaleformContainerMovieLoadedIntoParent(scaleformHandle:Int):Bool;
	static function HasScaleformMovieFilenameLoaded(scaleformName:Int):Bool;
	static function MoveVehicleDecals(p0:Int, p1:Int):Void;
	static function IsScreenblurFadeRunning():Bool;
	static function LoadMovieMeshSet(movieMeshSetName:Int):Int;
	static function OverridePedBadgeTexture(ped:Int, txd:Int, txn:Int):Bool;
	...
	static function OverrideInteriorSmokeName(name:Int):Void;
	static function ReleaseMovieMeshSet(movieMeshSet:Int):Void;
	static function PatchDecalDiffuseMap(decalType:Int, textureDict:Int, textureName:Int):Void;
	...
	static function PresetInteriorAmbientCache(timecycleModifierName:Int):Void;
	...
	static function RemoveTcmodifierOverride(p0:Int):Void;
	...
	static function RequestStreamedTextureDict(textureDict:Int, p1:Bool):Void;
	static function RequestScaleformMovie2(scaleformName:Int):Int;
	static function ReturnTwo(p0:Int):Int;
	static function ScaleformMovieMethodAddParamFloat(value:Float):Void;
	static function ResetParticleFxOverride(name:Int):Void;
	static function ScaleformMovieMethodAddParamPlayerNameString(string:Int):Void;
	...
	static function ScaleformMovieMethodAddParamTextureNameString(string:Int):Void;
	static function ScaleformMovieMethodAddParamTextureNameString2(string:Int):Void;
	...
	static function SetBinkMovie(name:Int):Int;
	...
	static function SetExtraTimecycleModifier(modifierName:Int):Void;
	static function SetCurrentPlayerTcmodifier(modifierName:Int):Void;
	...
	static function SetNextPlayerTcmodifier(modifierName:Int):Void;
	...
	static function SetParticleFxLoopedEvolution(ptfxHandle:Int, propertyName:Int, amount:Float, noNetwork:Bool):Void;
	...
	static function SetParticleFxOverride(oldAsset:Int, newAsset:Int):Void;
	...
	static function SetTimecycleModifier(modifierName:Int):Void;
	...
	static function SetStreamedTextureDictAsNoLongerNeeded(textureDict:Int):Void;
	...
	static function SetTvChannelPlaylist(tvChannel:Int, playlistName:Int, restart:Bool):Void;
	static function SetTransitionTimecycleModifier(modifierName:Int, transition:Float):Void;
	static function SetTrackedPointInfo(point:Int, x:Float, y:Float, z:Float, radius:Float):Void;
	static function SetTvChannelPlaylistAtHour(tvChannel:Int, playlistName:Int, hour:Int):Void;
	static function StartNetworkedParticleFxLoopedOnEntity(effectName:Int, entity:Int, xOffset:Float, yOffset:Float, zOffset:Float, xRot:Float, yRot:Float,
	...
	static function StartNetworkedParticleFxNonLoopedOnEntityBone(effectName:Int, entity:Int, offsetX:Float, offsetY:Float, offsetZ:Float, rotX:Float,
	...
	static function StartNetworkedParticleFxNonLoopedOnPedBone(effectName:Int, ped:Int, offsetX:Float, offsetY:Float, offsetZ:Float, rotX:Float, rotY:Float,
		rotZ:Float, boneIndex:Int, scale:Float, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	static function StartParticleFxLoopedAtCoord(effectName:Int, x:Float, y:Float, z:Float, xRot:Float, yRot:Float, zRot:Float, scale:Float, xAxis:Bool,
		yAxis:Bool, zAxis:Bool, p11:Bool):Int;
	static function StartNetworkedParticleFxLoopedOnEntityBone(effectName:Int, entity:Int, xOffset:Float, yOffset:Float, zOffset:Float, xRot:Float,
		yRot:Float, zRot:Float, boneIndex:Int, scale:Float, xAxis:Bool, yAxis:Bool, zAxis:Bool):Int;
	static function StartNetworkedParticleFxNonLoopedAtCoord(effectName:Int, xPos:Float, yPos:Float, zPos:Float, xRot:Float, yRot:Float, zRot:Float,
		scale:Float, xAxis:Bool, yAxis:Bool, zAxis:Bool):Bool;
	static function StartParticleFxLoopedOnPedBone(effectName:Int, ped:Int, xOffset:Float, yOffset:Float, zOffset:Float, xRot:Float, yRot:Float, zRot:Float,
		boneIndex:Int, scale:Float, xAxis:Bool, yAxis:Bool, zAxis:Bool):Int;
	static function StartNetworkedParticleFxNonLoopedOnEntity(effectName:Int, entity:Int, offsetX:Float, offsetY:Float, offsetZ:Float, rotX:Float, rotY:Float,
		rotZ:Float, scale:Float, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	static function StartParticleFxLoopedOnEntityBone(effectName:Int, entity:Int, xOffset:Float, yOffset:Float, zOffset:Float, xRot:Float, yRot:Float,
		zRot:Float, boneIndex:Int, scale:Float, xAxis:Bool, yAxis:Bool, zAxis:Bool):Int;
	static function StartParticleFxNonLoopedAtCoord(effectName:Int, xPos:Float, yPos:Float, zPos:Float, xRot:Float, yRot:Float, zRot:Float, scale:Float,
		xAxis:Bool, yAxis:Bool, zAxis:Bool):Int;
	static function StartParticleFxLoopedOnEntity(effectName:Int, entity:Int, xOffset:Float, yOffset:Float, zOffset:Float, xRot:Float, yRot:Float, zRot:Float,
		scale:Float, xAxis:Bool, yAxis:Bool, zAxis:Bool):Int;
	static function StartParticleFxNonLoopedOnEntity(effectName:Int, entity:Int, offsetX:Float, offsetY:Float, offsetZ:Float, rotX:Float, rotY:Float,
		rotZ:Float, scale:Float, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	static function StartPetrolTrailDecals(p0:Float):Void;
	static function StopBinkMovie(binkMovie:Int):Void;
	static function StartParticleFxNonLoopedOnPedBone(effectName:Int, ped:Int, offsetX:Float, offsetY:Float, offsetZ:Float, rotX:Float, rotY:Float,
		rotZ:Float, boneIndex:Int, scale:Float, axisX:Bool, axisY:Bool, axisZ:Bool):Bool;
	...
	static function UseParticleFxAsset(name:Int):Void;
	static function Ui3dscenePushPreset(presetName:Int):Bool;
	...
	static function ActivateInteriorEntitySet(interior:Int, entitySetName:Int):Void;
	...
	static function AddPickupToInteriorRoomByName(pickup:Int, roomName:Int):Void;
	...
	static function DeactivateInteriorEntitySet(interior:Int, entitySetName:Int):Void;
	static function GetInteriorAtCoordsWithType(x:Float, y:Float, z:Float, interiorType:Int):Int;
	...
	static function IsInteriorEntitySetActive(interior:Int, entitySetName:Int):Bool;
	...
	static function SetInteriorEntitySetColor(interior:Int, entitySetName:Int, color:Int):Void;
	...
	static function AddTextComponentSubstringPhoneNumber(p0:Int, p1:Int):Void;
	...
	static function AddTextComponentSubstringKeyboardDisplay(string:Int):Void;
	static function AddTextComponentSubstringPlayerName(text:Int):Void;
	...
	static function AddTextComponentSubstringTextLabel(labelName:Int):Void;
	static function BeginTextCommandGetWidth(text:Int):Void;
	static function AllowSonarBlips(toggle:Bool):Void;
	static function BeginTextCommandBusyspinnerOn(string:Int):Void;
	static function BeginTextCommandClearPrint(text:Int):Void;
	static function BeginTextCommandOverrideButtonText(gxtEntry:Int):Void;
	static function AddTextComponentSubstringWebsite(website:Int):Void;
	static function BeginTextCommandLineCount(entry:Int):Void;
	static function BusyspinnerIsDisplaying():Bool;
	static function BeginTextCommandDisplayText(text:Int):Void;
	static function BusyspinnerOff():Void;
	static function BeginTextCommandSetBlipName(textLabel:Int):Void;
	static function BeginTextCommandDisplayHelp(inputType:Int):Void;
	static function BeginTextCommandIsMessageDisplayed(text:Int):Void;
	static function BeginTextCommandIsThisHelpMessageBeingDisplayed(labelName:Int):Void;
	static function BeginTextCommandObjective(p0:Int):Void;
	static function BeginTextCommandThefeedPost(text:Int):Void;
	static function BeginTextCommandPrint(GxtEntry:Int):Void;
	...
	static function ClearThisPrint(p0:Int):Void;
	static function ClearSmallPrints():Void;
	static function ClearReminderMessage():Void;
	static function CreateFakeMpGamerTag(ped:Int, username:Int, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:Int, crewRank:Int):Int;
	...
	static function CreateMpGamerTagWithCrewColor(player:Int, username:Int, crewIsPrivate:Bool, crewIsRockstar:Bool, crewName:Int, crewRank:Int, crewR:Int,
		crewG:Int, crewB:Int):Void;
	...
	static function DisplayHelpTextThisFrame(message:Int, p1:Bool):Void;
	...
	static function DoesTextBlockExist(gxt:Int):Bool;
	...
	static function DoesTextLabelExist(gxt:Int):Bool;
	...
	static function EndTextCommandThefeedPostAward(textureDict:Int, textureName:Int, rpBonus:Int, colorOverlay:Int, titleLabel:Int):Int;
	...
	static function EndTextCommandThefeedPostCrewtagWithGameName(crewTypeIsPrivate:Bool, crewTagContainsRockstar:Bool, crewTag:Int, rank:Int, isLeader:Bool,
		isImportant:Bool, clanHandle:Int, gamerStr:Int, r:Int, g:Int, b:Int):Int;
	static function EndTextCommandThefeedPostCrewRankup(chTitle:Int, clanTxd:Int, clanTxn:Int, isImportant:Bool, showSubtitle:Bool):Int;
	static function EndTextCommandThefeedPostMessagetextTu(picTxd:Int, picTxn:Int, flash:Bool, iconType:Int, nameStr:Int, subtitleStr:Int,
		durationMultiplier:Float):Int;
	static function EndTextCommandThefeedPostStats(statTitle:Int, iconEnum:Int, stepVal:Bool, barValue:Int, isImportant:Bool, picTxd:Int, picTxn:Int):Int;
	static function EndTextCommandThefeedPostMessagetext(textureDict:Int, textureName:Int, flash:Bool, iconType:Int, sender:Int, subject:Int):Int;
	...
	static function EndTextCommandThefeedPostReplayInput(type:Int, button:Int, text:Int):Int;
	static function EndTextCommandThefeedPostMessagetextWithCrewTag(picTxd:Int, picTxn:Int, flash:Bool, iconType:Int, nameStr:Int, subtitleStr:Int,
		duration:Float, crewPackedStr:Int):Int;
	static function EndTextCommandThefeedPostTicker(isImportant:Bool, bHasTokens:Bool):Int;
	static function EndTextCommandThefeedPostMessagetextGxtEntry(txdName:Int, textureName:Int, flash:Bool, iconType:Int, sender:Int, subject:Int):Int;
	static function EndTextCommandThefeedPostTickerWithTokens(isImportant:Bool, bHasTokens:Bool):Int;
	static function EndTextCommandThefeedPostReplayIcon(eType:Int, iIcon:Int, sTitle:Int):Int;
	static function EndTextCommandThefeedPostUnlockTu(chTitle:Int, iconType:Int, chSubtitle:Int, isImportant:Bool):Int;
	static function EndTextCommandThefeedPostMessagetextWithCrewTagAndAdditionalIcon(picTxd:Int, picTxn:Int, flash:Bool, iconType1:Int, nameStr:Int,
		subtitleStr:Int, duration:Float, crewPackedStr:Int, iconType2:Int, textColor:Int):Int;
	static function FlagPlayerContextInTournament(toggle:Bool):Void;
	static function EndTextCommandThefeedPostVersusTu(ch1TXD:Int, ch1TXN:Int, val1:Int, ch2TXD:Int, ch2TXN:Int, val2:Int):Int;
	...
	static function EndTextCommandThefeedPostUnlock(chTitle:Int, iconType:Int, chSubtitle:Int):Int;
	static function FlashWantedDisplay(p0:Bool):Void;
	static function ForceSonarBlipsThisFrame():Int;
	static function EndTextCommandThefeedPostUnlockTuWithColor(chTitle:Int, iconType:Int, chSubtitle:Int, isImportant:Bool, titleColor:Int, p5:Bool):Int;
	...
	static function GetLengthOfLiteralStringInBytes(string:Int):Int;
	static function GetLabelText(labelName:Int):Int;
	static function GetFirstBlipInfoId(blipSprite:Int):Int;
	static function GetLengthOfLiteralString(string:Int):Int;
	static function GetLengthOfStringWithThisTextLabel(gxt:Int):Int;
	...
	static function GetNamedRendertargetRenderId(name:Int):Int;
	...
	static function GetStreetNameFromHashKey(hash:Int):Int;
	...
	static function GetTextSubstringSafe(text:Int, position:Int, length:Int, maxLength:Int):Int;
	static function GetTextSubstring(text:Int, position:Int, length:Int):Int;
	...
	static function GetTextSubstringSlice(text:Int, startPosition:Int, endPosition:Int):Int;
	static function HideAreaAndVehicleNameThisFrame():Void;
	static function HasThisAdditionalTextLoaded(gxt:Int, slot:Int):Bool;
	...
	static function IsNamedRendertargetRegistered(name:Int):Bool;
	...
	static function LogDebugInfo(p0:Int):Void;
	...
	static function RegisterNamedRendertarget(name:Int, p1:Bool):Bool;
	...
	static function ReleaseNamedRendertarget(name:Int):Bool;
	...
	static function RequestAdditionalText(gxt:Int, slot:Int):Void;
	...
	static function RequestAdditionalTextForDlc(gxt:Int, slot:Int):Void;
	...
	static function SetBlipNameFromTextFile(blip:Int, gxtEntry:Int):Void;
	...
	static function SetMissionName(p0:Bool, name:Int):Void;
	...
	static function SetMissionName2(p0:Bool, name:Int):Void;
	static function SetMpGamerTagBigText(gamerTagId:Int, string:Int):Void;
	...
	static function SetMpGamerTagName(gamerTagId:Int, string:Int):Void;
	...
	static function SetSocialClubTour(name:Int):Void;
	...
	static function SetWarningMessageWithAlert(labelTitle:Int, labelMsg:Int, p2:Int, p3:Int, labelMsg2:Int, p5:Bool, p6:Int, p7:Int, p8:Int, p9:Int,
		background:Bool, errorCode:Int):Void;
	static function SetWarningMessage(entryLine1:Int, instructionalKey:Int, entryLine2:Int, p3:Bool, p4:Int, background:Int, p6:Int, showBg:Bool,
		errorCode:Int):Void;
	static function SetWarningMessageListRow(index:Int, name:Int, cash:Int, rp:Int, lvl:Int, colour:Int):Bool;
	static function SetWarningMessageWithHeader(titleMsg:Int, entryLine1:Int, flags:Int, promptMsg:Int, p4:Bool, p5:Int, background:Bool, p7:Int,
		showBg:Bool):Void;
	static function SetWarningMessageWithHeaderUnk(entryHeader:Int, entryLine1:Int, flags:Int, entryLine2:Int, p4:Bool, p5:Int, p6:Int, p7:Int, showBg:Bool,
		p9:Int, p10:Int):Void;
	...
	static function SetWarningMessageWithHeaderAndSubstringFlags(entryHeader:Int, entryLine1:Int, instructionalKey:Int, entryLine2:Int, p4:Bool, p5:Int,
		p6:Int, p7:Int, p8:Int, p9:Bool):Void;
	...
	static function ThefeedUpdateItemTexture(txdString1:Int, txnString1:Int, txdString2:Int, txnString2:Int):Void;
	...
	static function AreStringsEqual(string1:Int, string2:Int):Bool;
	...
	static function CompareStrings(str1:Int, str2:Int, matchCase:Bool, maxLength:Int):Int;
	...
	static function DisplayOnscreenKeyboard(p0:Int, windowTitle:Int, p2:Int, defaultText:Int, defaultConcat1:Int, defaultConcat2:Int, defaultConcat3:Int,
	...
	static function DisplayOnscreenKeyboardWithLongerInitialString(p0:Int, windowTitle:Int, p2:Int, defaultText:Int, defaultConcat1:Int, defaultConcat2:Int,
		defaultConcat3:Int, defaultConcat4:Int, defaultConcat5:Int, defaultConcat6:Int, defaultConcat7:Int, maxInputLength:Int):Void;
	...
	static function GetOnscreenKeyboardResult():Int;
	...
	static function IsNextWeatherType(weatherType:Int):Bool;
	static function IsMinigameInProgress():Bool;
	static function IsPcVersion():Bool;
	static function IsOrbisVersion():Bool;
	static function IsPrevWeatherType(weatherType:Int):Bool;
	...
	static function PlayTennisSwingAnim(ped:Int, animDict:Int, animName:Int, p3:Float, p4:Float, p5:Bool):Void;
	...
	static function RegisterBoolToSave(p0:Int, name:Int):Void;
	static function QueueMissionRepeatSave():Bool;
	static function QueueMissionRepeatLoad():Bool;
	static function PreloadCloudHat(name:Int):Void;
	static function RegisterInt64ToSave(p0:Int, name:Int):Void;
	static function RegisterFloatToSave(p0:Int, name:Int):Void;
	static function RegisterEnumToSave(p0:Int, name:Int):Void;
	static function RegisterIntToSave(p0:Int, name:Int):Void;
	...
	static function RegisterTextLabelToSave(p0:Int, name:Int):Void;
	static function RemovePopMultiplierArea(id:Int, p1:Bool):Void;
	static function ResetDispatchSpawnLocation():Void;
	static function RegisterTextLabelToSave2(p0:Int, name:Int):Void;
	...
	static function SetOverrideWeather(weatherType:Int):Void;
	...
	static function SetWeatherTypeNow(weatherType:Int):Void;
	...
	static function SetWeatherTypePersist(weatherType:Int):Void;
	...
	static function SetWeatherTypeNowPersist(weatherType:Int):Void;
	...
	static function SetWeatherTypeOvertimePersist(weatherType:Int, time:Float):Void;
	...
	static function StartSaveArrayWithSize(p0:Int, size:Int, arrayName:Int):Void;
	...
	static function StringToInt(string:Int, outInteger:Int):Bool;
	...
	static function TerminateAllScriptsWithThisName(scriptName:Int):Void;
	static function StartBenchmarkRecording():Void;
	static function StartSaveStructWithSize(p0:Int, size:Int, structName:Int):Void;
	...
	static function UnloadCloudHat(name:Int, p1:Float):Void;
	...
	static function NetGameserverCatalogItemExists(name:Int):Bool;
	...
	static function NetworkBuyItem(amount:Int, item:Int, p2:Int, p3:Int, p4:Bool, item_name:Int, p6:Int, p7:Int, p8:Int, p9:Bool):Void;
	...
	static function NetworkDeductCash(amount:Int, p1:Int, p2:Int, p3:Bool, p4:Bool, p5:Bool):Void;
	...
	static function NetworkEarnFromAmbientJob(p0:Int, p1:Int, p2:Int):Void;
	...
	static function NetworkEarnFromBetting(amount:Int, p1:Int):Void;
	...
	static function NetworkEarnFromBendJob(amount:Int, heistHash:Int):Void;
	...
	static function NetworkEarnFromDailyObjectives(p0:Int, p1:Int, p2:Int):Void;
	...
	static function NetworkEarnFromGangopsJobsFinale(amount:Int, unk:Int):Void;
	static function NetworkEarnFromGangopsElite(amount:Int, unk:Int, actIndex:Int):Void;
	...
	static function NetworkEarnFromGangopsJobsSetup(amount:Int, unk:Int):Void;
	...
	static function NetworkEarnFromGangopsAwards(amount:Int, unk:Int, p2:Int):Void;
	static function NetworkEarnFromJob(amount:Int, p1:Int):Void;
	...
	static function NetworkEarnFromPremiumJob(amount:Int, p1:Int):Void;
	...
	static function NetworkEarnFromJobX2(amount:Int, p1:Int):Void;
	...
	static function NetworkGetStringBankBalance():Int;
	static function NetworkEarnJobBonusHeistAward(p0:Int, p1:Int, p2:Int):Void;
	static function NetworkGetPvcBalance():Int;
	static function NetworkGetStringWalletBalance(characterSlot:Int):Int;
	...
	static function NetworkGetStringBankWalletBalance():Int;
	...
	static function NetworkRefundCash(index:Int, context:Int, reason:Int, unk:Bool):Void;
	...
	static function NetworkPayMatchEntryFee(amount:Int, matchId:Int, p2:Bool, p3:Bool):Void;
	...
	static function NetworkSpentBetting(amount:Int, p1:Int, matchId:Int, p3:Bool, p4:Bool):Void;
	...
	static function NetworkSpentBuyArena(amount:Int, p1:Bool, p2:Bool, p3:Int):Void;
	...
	static function NetworkSpentJobSkip(amount:Int, matchId:Int, p2:Bool, p3:Bool):Void;
	...
	static function NetworkSpentUpgradeArena(amount:Int, p1:Bool, p2:Bool, p3:Int):Void;
	...
	static function ProcessCashGift(p0:Int, p1:Int, p2:Int):Int;
	...
	static function GetControlInstructionalButton(padIndex:Int, control:Int, p2:Bool):Int;
	static function DisableControlAction(padIndex:Int, control:Int, disable:Bool):Void;
	static function GetControlGroupInstructionalButton(padIndex:Int, controlGroup:Int, p2:Bool):Int;
	...
	static function SwitchToInputMappingScheme2(name:Int):Bool;
	static function SwitchToInputMappingScheme(name:Int):Bool;
	...
	static function GetRayfireMapObject(x:Float, y:Float, z:Float, radius:Float, name:Int):Dynamic;
	...
	static function CloudDeleteMemberFile(p0:Int):Int;
	...
	static function FacebookSetHeistComplete(heistName:Int, cashEarned:Int, xpEarned:Int):Bool;
	...
	static function GetCommerceItemCat(index:Int, index2:Int):Int;
	static function GetCloudTimeAsString():Int;
	static function GetCommerceItemId(index:Int):Int;
	static function GetCommerceItemTexturename(index:Int):Int;
	static function GetCommerceProductPrice(index:Int):Int;
	static function GetCommerceItemName(index:Int):Int;
	...
	static function GetOnlineVersion():Int;
	...
	static function GetTimeAsString(time:Int):Int;
	...
	static function NetworkAccessTunableFloat(tunableContext:Int, tunableName:Int, value:Float):Bool;
	...
	static function NetworkAccessTunableBool(tunableContext:Int, tunableName:Int):Bool;
	...
	static function NetworkAddEntityToSynchronisedScene(entity:Int, netScene:Int, animDict:Int, animName:Int, speed:Float, speedMulitiplier:Float,
		flag:Int):Void;
	static function NetworkAccessTunableInt(tunableContext:Int, tunableName:Int, value:Int):Bool;
	...
	static function NetworkAddPedToSynchronisedScene(ped:Int, netScene:Int, animDict:Int, animnName:Int, blendInSpeed:Float, blendOutSpeed:Float,
		duration:Int, flag:Int, playbackRate:Float, p9:Int):Void;
	static function NetworkAddSynchronisedSceneCamera(netScene:Int, animDict:Int, animName:Int):Void;
	...
	static function NetworkAddFriend(networkHandle:Int, message:Int):Bool;
	...
	static function NetworkApplyTransitionParameterString(p0:Int, string:Int, p2:Bool):Void;
	...
	static function NetworkClanAnimation(animDict:Int, animName:Int):Bool;
	static function NetworkClanGetEmblemTxdName(netHandle:Int, txdName:Int):Bool;
	...
	static function NetworkClanGetUiFormattedTag(clanDesc:Int, bufferSize:Int, formattedTag:Int):Void;
	...
	static function NetworkDoesTunableExist(tunableContext:Int, tunableName:Int):Bool;
	...
	static function NetworkGetHostOfScript(scriptName:Int, p1:Int, p2:Int):Int;
	static function NetworkGetFoundGamer(p0:Int, p1:Int):Bool;
	static function NetworkGetFriendName(friendIndex:Int):Int;
	...
	static function NetworkGetFriendNameFromIndex(friendIndex:Int):Int;
	...
	static function NetworkGetGamertagFromHandle(networkHandle:Int):Int;
	...
	static function NetworkGetPresenceInviteContentId(p0:Int):Int;
	static function NetworkGetPresenceInviteInviter(inviteIndex:Int):Int;
	...
	static function NetworkHandleFromMemberId(memberId:Int, networkHandle:Int, bufferSize:Int):Void;
	static function NetworkHasCachedPlayerHeadBlendData(player:Int):Bool;
	static function NetworkHasAgeRestrictedProfile():Bool;
	static function NetworkHandleFromUserId(userId:Int, networkHandle:Int, bufferSize:Int):Void;
	...
	static function NetworkIsFriendOnline(name:Int):Bool;
	static function NetworkIsGameInProgress():Bool;
	static function NetworkIsFriendInMultiplayer(friendName:Int):Bool;
	...
	static function NetworkIsFriendInSameTitle(friendName:Int):Bool;
	...
	static function NetworkIsPlayerAParticipantOnScript(player1:Int, script:Int, player2:Int):Bool;
	...
	static function NetworkIsScriptActive(scriptName:Int, player:Int, p2:Bool, p3:Int):Bool;
	...
	static function NetworkMemberIdFromGamerHandle(networkHandle:Int):Int;
	...
	static function NetworkPlayerGetName(player:Int):Int;
	...
	static function NetworkPlayerGetUserid(player:Int, userID:Int):Int;
	...
	static function NetworkSendTextMessage(message:Int, networkHandle:Int):Bool;
	static function NetworkSendTransitionGamerInstruction(networkHandle:Int, p1:Int, p2:Int, p3:Int, p4:Bool):Bool;
	...
	static function NetworkSetCurrentMissionId(missionId:Int):Void;
	...
	static function NetworkSetRichPresenceString(p0:Int, textLabel:Int):Void;
	...
	static function OpenCommerceStore(p0:Int, p1:Int):Void;
	...
	static function SetBalanceAddMachines(data:Int, dataCount:Int, contentTypeName:Int):Bool;
	static function SetEntityLocallyVisible(entity:Int):Void;
	static function SetEntityLocallyInvisible(entity:Int):Void;
	static function SetBalanceAddMachine(contentId:Int, contentTypeName:Int):Bool;
	...
	static function TextureDownloadGetName(p0:Int):Int;
	...
	static function TextureDownloadRequest(PlayerHandle:Int, FilePath:Int, Name:Int, p3:Bool):Int;
	static function TitleTextureDownloadRequest(FilePath:Int, Name:Int, p2:Bool):Int;
	...
	static function UgcGetCachedDescription(p0:Int, p1:Int):Int;
	...
	static function UgcGetContentName(p0:Int):Int;
	static function UgcGetContentId(p0:Int):Int;
	...
	static function UgcGetContentPath(p0:Int, p1:Int):Int;
	...
	static function UgcGetContentUserId(p0:Int):Int;
	static function UgcGetContentRatingCount(p0:Int, p1:Int):Int;
	static function UgcGetContentUserName(p0:Int):Int;
	...
	static function UgcGetCreateContentId():Int;
	...
	static function UgcGetRootContentId(p0:Int):Int;
	...
	static function UgcQueryByContentId(contentId:Int, latestVersion:Bool, contentTypeName:Int):Bool;
	static function UgcIsLanguageSupported(p0:Int):Bool;
	static function UgcRequestCachedDescription(p0:Int):Int;
	static function UgcQueryByContentIds(data:Int, count:Int, latestVersion:Bool, contentTypeName:Int):Bool;
	static function UgcPublish(contentId:Int, baseContentId:Int, contentTypeName:Int):Bool;
	...
	static function UgcQueryRecentlyCreatedContent(offset:Int, count:Int, contentTypeName:Int, p3:Int):Bool;
	static function UgcSetBookmarked(contentId:Int, bookmarked:Bool, contentTypeName:Int):Bool;
	static function UgcRequestContentDataFromParams(contentTypeName:Int, contentId:Int, p2:Int, p3:Int, p4:Int):Int;
	...
	static function AttachEntitiesToRope(ropeId:Int, ent1:Int, ent2:Int, ent1_x:Float, ent1_y:Float, ent1_z:Float, ent2_x:Float, ent2_y:Float, ent2_z:Float,
		length:Float, p10:Bool, p11:Bool, boneName1:Int, boneName2:Int):Void;
	...
	static function LoadRopeData(ropeId:Int, rope_preset:Int):Void;
	...
	static function ForceCleanupForAllThreadsWithThisName(name:Int, cleanupFlags:Int):Void;
	...
	static function GetPlayerName(player:Int):Int;
	...
	static function AddRelationshipGroup(name:Int, groupHash:Int):Int;
	static function ApplyDamageToPed(ped:Int, damageAmount:Int, armorFirst:Bool):Void;
	static function ApplyPedBlood(ped:Int, boneIndex:Int, xRot:Float, yRot:Float, zRot:Float, woundType:Int):Void;
	...
	static function ApplyPedDamageDecal(ped:Int, damageZone:Int, xOffset:Float, yOffset:Float, heading:Float, scale:Float, alpha:Float, variation:Int,
		fadeIn:Bool, decalName:Int):Void;
	...
	static function ApplyPedDamagePack(ped:Int, damagePack:Int, damage:Float, mult:Float):Void;
	...
	static function ClearPedDamageDecalByZone(ped:Int, p1:Int, p2:Int):Void;
	...
	static function GetAnimInitialOffsetPosition(animDict:Int, animName:Int, x:Float, y:Float, z:Float, xRot:Float, yRot:Float, zRot:Float, p8:Float,
		p9:Int):Vector3;
	...
	static function GetAnimInitialOffsetRotation(animDict:Int, animName:Int, x:Float, y:Float, z:Float, xRot:Float, yRot:Float, zRot:Float, p8:Float,
		p9:Int):Vector3;
	...
	static function GetPedheadshotTxdString(id:Int):Int;
	...
	static function HasActionModeAssetLoaded(asset:Int):Bool;
	...
	static function HasStealthModeAssetLoaded(asset:Int):Bool;
	...
	static function IsPedUsingScenario(ped:Int, scenario:Int):Bool;
	...
	static function IsScriptedScenarioPedUsingConditionalAnim(ped:Int, animDict:Int, anim:Int):Bool;
	...
	static function PlayFacialAnim(ped:Int, animName:Int, animDict:Int):Void;
	...
	static function RemoveActionModeAsset(asset:Int):Void;
	...
	static function RequestActionModeAsset(asset:Int):Void;
	static function RequestPedVehicleVisibilityTracking(ped:Int, p1:Bool):Void;
	static function RemoveStealthModeAsset(asset:Int):Void;
	static function RequestPedheadshotImgUpload(id:Int):Bool;
	static function RequestStealthModeAsset(asset:Int):Void;
	...
	static function SetFacialClipsetOverride(ped:Int, animDict:Int):Void;
	...
	static function SetFacialIdleAnimOverride(ped:Int, animName:Int, animDict:Int):Void;
	...
	static function SetPedAlternateWalkAnim(ped:Int, animDict:Int, animName:Int, p3:Float, p4:Bool):Void;
	static function SetPedAlertness(ped:Int, value:Int):Void;
	static function SetMovementModeOverride(ped:Int, name:Int):Void;
	...
	static function SetPedAlternateMovementAnim(ped:Int, stance:Int, animDictionary:Int, animationName:Int, p4:Float, p5:Bool):Void;
	...
	static function SetPedCoverClipsetOverride(ped:Int, p1:Int):Void;
	...
	static function SetPedCowerHash(ped:Int, p1:Int):Void;
	...
	static function SetPedDriveByClipsetOverride(ped:Int, clipset:Int):Void;
	...
	static function SetPedGestureGroup(ped:Int, animGroupGesture:Int):Void;
	...
	static function SetPedMovementClipset(ped:Int, clipSet:Int, transitionSpeed:Float):Void;
	...
	static function SetPedNameDebug(ped:Int, name:Int):Void;
	...
	static function SetPedStealthMovement(ped:Int, p1:Bool, action:Int):Void;
	...
	static function SetPedStrafeClipset(ped:Int, clipSet:Int):Void;
	...
	static function SetPedUsingActionMode(ped:Int, p1:Bool, p2:Int, action:Int):Void;
	...
	static function SetPedWeaponMovementClipset(ped:Int, clipSet:Int):Void;
	...
	static function BgStartContext(contextName:Int):Void;
	static function BgEndContextHash(contextHash:Int):Void;
	static function BgEndContext(contextName:Int):Void;
	static function DoesScriptExist(scriptName:Int):Bool;
	...
	static function GetNameOfThread(threadId:Int):Int;
	...
	static function GetThisScriptName():Int;
	static function GetNumberOfReferencesOfScriptWithNameHash(scriptHash:Int):Int;
	static function HasScriptLoaded(scriptName:Int):Bool;
	...
	static function RequestScript(scriptName:Int):Void;
	static function SetScriptAsNoLongerNeeded(scriptName:Int):Void;
	...
	static function RockstarMessageGetString():Int;
	static function ScEmailMessagePushGamerToRecipList(networkHandle:Int):Void;
	static function ScGamerdataGetBool(name:Int):Bool;
	static function ScEmailMessageClearRecipList():Void;
	static function ScGamerdataGetFloat(name:Int, outValue:Float):Bool;
	static function ScGamerdataGetInt(name:Int, outValue:Int):Bool;
	static function ScGetNickname():Int;
	...
	static function ScInboxMessageGetDataBool(p0:Int, p1:Int):Bool;
	static function ScInboxMessageGetDataString(p0:Int, context:Int, out:Int):Bool;
	static function ScInboxMessageGetString(p0:Int):Int;
	static function ScInboxMessagePushGamerToEventRecipList(networkHandle:Int):Void;
	static function ScInboxMessageSendBountyPresenceEvent(data:Int):Bool;
	static function ScInboxMessagePop(p0:Int):Bool;
	static function ScInboxMessageGetDataInt(p0:Int, context:Int, out:Int):Bool;
	static function ScInboxMessageGetUgcdata(p0:Int, p1:Int):Bool;
	static function ScLicenseplateAdd(plateText:Int, plateData:Int, tokenOut:Int):Bool;
	static function ScLicenseplateGetPlate(token:Int, plateIndex:Int):Int;
	static function ScLicenseplateGetAddStatus(token:Int):Int;
	static function ScLicenseplateGetAddIsPending(token:Int):Bool;
	static function ScInboxMessageSendUgcStatUpdateEvent(data:Int):Void;
	static function ScLicenseplateSetPlateData(oldPlateText:Int, newPlateText:Int, plateData:Int):Bool;
	static function ScProfanityCheckString(string:Int, token:Int):Bool;
	static function ScLicenseplateGetIsvalidIsPending(token:Int):Bool;
	static function ScLicenseplateGetPlateData(token:Int, plateIndex:Int):Int;
	static function ScLicenseplateGetCount(token:Int):Int;
	static function ScLicenseplateIsvalid(plateText:Int, tokenOut:Int):Bool;
	static function ScLicenseplateGetIsvalidStatus(token:Int):Int;
	static function ScProfanityGetCheckIsValid(token:Int):Bool;
	static function ScPresenceAttrSetString(attrHash:Int, value:Int):Bool;
	...
	static function ScProfanityCheckUgcString(string:Int, token:Int):Bool;
	...
	static function DoesAnimDictExist(animDict:Int):Bool;
	...
	static function HasAnimSetLoaded(animSet:Int):Bool;
	...
	static function HasAnimDictLoaded(animDict:Int):Bool;
	static function HasNamedPtfxAssetLoaded(fxName:Int):Bool;
	static function HasModelLoaded(model:Int):Bool;
	static function IsEntityFocus(entity:Int):Bool;
	static function HasClipSetLoaded(clipSet:Int):Bool;
	static function IsIplActive(iplName:Int):Bool;
	...
	static function RemoveAnimDict(animDict:Int):Void;
	static function RemoveAnimSet(animSet:Int):Void;
	static function PrefetchSrl(srl:Int):Void;
	static function RemoveIpl(iplName:Int):Void;
	...
	static function RemoveNamedPtfxAsset(fxName:Int):Void;
	static function NewLoadSceneStop():Void;
	static function RemoveModelFromCreatorBudget(modelHash:Int):Void;
	static function RemoveClipSet(clipSet:Int):Void;
	static function RequestAdditionalCollisionAtCoord(x:Float, y:Float, z:Float):Void;
	static function RequestAnimDict(animDict:Int):Void;
	static function RequestClipSet(clipSet:Int):Void;
	...
	static function RequestAnimSet(animSet:Int):Void;
	static function RequestIpl(iplName:Int):Void;
	static function RequestModelsInRoom(interior:Int, roomName:Int):Void;
	...
	static function RequestNamedPtfxAsset(fxName:Int):Void;
	static function SetIslandEnabled(islandName:Int, toggle:Bool):Void;
	static function SetHdArea(x:Float, y:Float, z:Float, radius:Float):Void;
	static function SetPlayerSwitchEstablishingShot(name:Int):Void;
	...
	static function SetMapdatacullboxEnabled(name:Int, toggle:Bool):Void;
	...
	static function StartNewScript(scriptName:Int, stackSize:Int):Int;
	...
	static function StartNewScriptWithArgs(scriptName:Int, args:Int, argCount:Int, stackSize:Int):Int;
	...
	static function GetNgstatBoolHash(index:Int, spStat:Bool, charStat:Bool, character:Int, section:Int):Int;
	...
	static function GetNgstatIntHash(index:Int, spStat:Bool, charStat:Bool, character:Int, section:Int):Int;
	...
	static function Leaderboards2ReadByPlatform(p0:Int, gamerHandleCsv:Int, platformName:Int):Bool;
	...
	static function PlaystatsBackgroundScriptAction(action:Int, value:Int):Void;
	...
	static function PlaystatsCheatApplied(cheat:Int):Void;
	...
	static function PlaystatsQuickfixTool(element:Int, item:Int):Void;
	...
	static function PlaystatsRandomMissionDone(name:Int, p1:Int, p2:Int, p3:Int):Void;
	...
	static function StatGetLicensePlate(statName:Int):Int;
	...
	static function StatGetUserId(p0:Int):Int;
	static function StatGetString(statHash:Int, p1:Int):Int;
	static function StatSaveMigrationConsumeContentUnlock(contentId:Int, srcPlatform:Int, srcGamerHandle:Int):Bool;
	static function StatLoadPending(p0:Int):Bool;
	static function StatMigrateSave(platformName:Int):Bool;
	...
	static function StatSetLicensePlate(statName:Int, str:Int):Bool;
	static function StatSetGxtLabel(statName:Int, value:Int, save:Bool):Bool;
	static function StatSetString(statName:Int, value:Int, save:Bool):Bool;
	...
	static function StatSetUserId(statName:Int, value:Int, save:Bool):Bool;
	...
	static function AssistedMovementRemoveRoute(route:Int):Void;
	static function AddPatrolRouteNode(id:Int, guardScenario:Int, x1:Float, y1:Float, z1:Float, x2:Float, y2:Float, z2:Float, waitTime:Int):Void;
	static function AssistedMovementIsRouteLoaded(route:Int):Bool;
	static function AssistedMovementRequestRoute(route:Int):Void;
	...
	static function AssistedMovementSetRouteProperties(route:Int, props:Int):Void;
	...
	static function DoesScenarioGroupExist(scenarioGroup:Int):Bool;
	static function ClosePatrolRoute():Void;
	static function DoesScenarioOfTypeExistInArea(p0:Float, p1:Float, p2:Float, p3:Int, p4:Float, p5:Bool):Bool;
	static function DoesScenarioExistInArea(x:Float, y:Float, z:Float, radius:Float, b:Bool):Bool;
	static function DeletePatrolRoute(patrolRoute:Int):Void;
	...
	static function GetClipSetForScriptedGunTask(p0:Int):Int;
	static function GetIsTaskActive(ped:Int, taskIndex:Int):Bool;
	static function GetIsWaypointRecordingLoaded(name:Int):Bool;
	...
	static function GetTaskMoveNetworkSignalBool(ped:Int, signalName:Int):Bool;
	static function GetScriptTaskStatus(ped:Int, taskHash:Int):Int;
	static function GetTaskMoveNetworkSignalFloat(ped:Int, signalName:Int):Float;
	static function GetTaskMoveNetworkState(ped:Int):Int;
	static function GetVehicleWaypointProgress(vehicle:Int):Int;
	static function IsMoveBlendRatioRunning(ped:Int):Bool;
	static function GetWaypointDistanceAlongRoute(p0:Int, p1:Int):Float;
	static function IsMountedWeaponTaskUnderneathDrivingTask(ped:Int):Bool;
	static function GetTaskMoveNetworkEvent(ped:Int, eventName:Int):Bool;
	...
	static function IsScenarioGroupEnabled(scenarioGroup:Int):Bool;
	static function IsScenarioTypeEnabled(scenarioType:Int):Bool;
	...
	static function OpenPatrolRoute(patrolRoute:Int):Void;
	static function PedHasUseScenarioTask(ped:Int):Bool;
	static function PlayAnimOnRunningScenario(ped:Int, animDict:Int, animName:Int):Void;
	static function RemoveAllCoverBlockingAreas():Void;
	static function RemoveWaypointRecording(name:Int):Void;
	static function RequestTaskMoveNetworkStateTransition(ped:Int, name:Int):Bool;
	...
	static function RequestWaypointRecording(name:Int):Void;
	...
	static function SetExclusiveScenarioGroup(scenarioGroup:Int):Void;
	...
	static function SetScenarioTypeEnabled(scenarioType:Int, toggle:Bool):Void;
	...
	static function SetTaskMoveNetworkSignalFloat(ped:Int, signalName:Int, value:Float):Void;
	static function SetPedPathCanUseLadders(ped:Int, Toggle:Bool):Void;
	static function SetTaskMoveNetworkSignalBool(ped:Int, signalName:Int, value:Bool):Void;
	static function SetTaskVehicleChaseIdealPursuitDistance(ped:Int, distance:Float):Void;
	static function SetScenarioGroupEnabled(scenarioGroup:Int, p1:Bool):Void;
	static function SetTaskVehicleChaseBehaviorFlag(ped:Int, flag:Int, set:Bool):Void;
	static function StopAnimTask(ped:Int, animDictionary:Int, animationName:Int, animExitSpeed:Float):Void;
	...
	static function SetTaskMoveNetworkSignalFloat2(ped:Int, signalName:Int, value:Float):Void;
	...
	static function TaskMoveNetworkByName(ped:Int, task:Int, multiplier:Float, p3:Bool, animDict:Int, flags:Int):Void;
	...
	static function TaskMoveNetworkAdvancedByName(ped:Int, p1:Int, p2:Float, p3:Float, p4:Float, p5:Float, p6:Float, p7:Float, p8:Int, p9:Float, p10:Bool,
		animDict:Int, flags:Int):Void;
	static function TaskMoveNetworkByNameWithInitParams(ped:Int, p1:Int, data:Int, p3:Float, p4:Bool, animDict:Int, flags:Int):Void;
	static function TaskPatrol(ped:Int, p1:Int, p2:Int, p3:Bool, p4:Bool):Void;
	...
	static function TaskPlayAnim(ped:Int, animDictionary:Int, animationName:Int, blendInSpeed:Float, blendOutSpeed:Float, duration:Int, flag:Int,
		playbackRate:Float, lockX:Bool, lockY:Bool, lockZ:Bool):Void;
	static function TaskRappelFromHeli(ped:Int, unused:Float):Void;
	static function TaskPlayPhoneGestureAnimation(ped:Int, animDict:Int, animation:Int, boneMaskType:Int, p4:Float, p5:Float, p6:Bool, p7:Bool):Void;
	static function TaskPutPedDirectlyIntoMelee(ped:Int, meleeTarget:Int, p2:Float, p3:Float, p4:Float, p5:Bool):Void;
	static function TaskPlayAnimAdvanced(ped:Int, animDict:Int, animName:Int, posX:Float, posY:Float, posZ:Float, rotX:Float, rotY:Float, rotZ:Float,
	...
	static function TaskRappelDownWall(ped:Int, x1:Float, y1:Float, z1:Float, x2:Float, y2:Float, z2:Float, minZ:Float, ropeId:Int, clipset:Int, p10:Int):Void;
	...
	static function TaskStandGuard(ped:Int, x:Float, y:Float, z:Float, heading:Float, scenarioName:Int):Void;
	static function TaskStayInCover(ped:Int):Void;
	static function TaskStartScenarioInPlace(ped:Int, scenarioName:Int, unkDelay:Int, playEnterAnim:Bool):Void;
	static function TaskStartScenarioAtPosition(ped:Int, scenarioName:Int, x:Float, y:Float, z:Float, heading:Float, duration:Int, sittingScenario:Bool,
		teleport:Bool):Void;
	...
	static function TaskSweepAimEntity(ped:Int, anim:Int, p2:Int, p3:Int, p4:Int, p5:Int, vehicle:Int, p7:Float, p8:Float):Void;
	...
	static function TaskSynchronizedScene(ped:Int, scene:Int, animDictionary:Int, animationName:Int, speed:Float, speedMultiplier:Float, duration:Int,
	...
	static function TaskVehiclePlayAnim(vehicle:Int, animationSet:Int, animationName:Int):Void;
	static function TaskVehicleFollowWaypointRecording(ped:Int, vehicle:Int, WPRecording:Int, p3:Int, p4:Int, p5:Int, p6:Int, p7:Float, p8:Bool, p9:Float):Void;
	...
	static function UseWaypointRecordingAsAssistedMovementRoute(name:Int, p1:Bool, p2:Float, p3:Float):Void;
	...
	static function WaypointRecordingGetSpeedAtPoint(name:Int, point:Int):Float;
	static function WaypointPlaybackStartAimingAtPed(p0:Int, p1:Int, p2:Bool):Void;
	static function WaypointRecordingGetClosestWaypoint(name:Int, x:Float, y:Float, z:Float, point:Int):Bool;
	static function WaypointRecordingGetNumPoints(name:Int, points:Int):Bool;
	static function WaypointPlaybackStartShootingAtPed(p0:Int, p1:Int, p2:Bool, p3:Int):Void;
	static function WaypointRecordingGetCoord(name:Int, point:Int, coord:Vector3):Bool;
	...
	static function GetZoneFromNameId(zoneName:Int):Int;
	static function GetNameOfZone(x:Float, y:Float, z:Float):Int;
	...
	static function DoesVehicleExistWithDecorator(decorator:Int):Bool;
	...
	static function GetDisplayNameFromVehicleModel(modelHash:Int):Int;
	...
	static function GetModSlotName(vehicle:Int, modType:Int):Int;
	...
	static function GetModTextLabel(vehicle:Int, modType:Int, modValue:Int):Int;
	static function GetMakeNameFromVehicleModel(modelHash:Int):Int;
	static function GetLiveryName(vehicle:Int, liveryIndex:Int):Int;
	...
	static function GetPositionOfVehicleRecordingAtTime(recording:Int, time:Float, script:Int):Vector3;
	...
	static function GetRotationOfVehicleRecordingAtTime(recording:Int, time:Float, script:Int):Vector3;
	static function GetTotalDurationOfVehicleRecording(recording:Int, script:Int):Float;
	...
	static function GetVehicleModColor2Name(vehicle:Int):Int;
	...
	static function GetVehicleModColor1Name(vehicle:Int, p1:Bool):Int;
	...
	static function GetVehicleNumberPlateText(vehicle:Int):Int;
	...
	static function GetVehicleRecordingId(recording:Int, script:Int):Int;
	...
	static function HasVehicleRecordingBeenLoaded(recording:Int, script:Int):Bool;
	...
	static function IsVehicleInGarageArea(garageName:Int, vehicle:Int):Bool;
	...
	static function RemoveVehicleRecording(recording:Int, script:Int):Void;
	...
	static function RequestVehicleRecording(recording:Int, script:Int):Void;
	...
	static function SetVehicleNameDebug(vehicle:Int, name:Int):Void;
	...
	static function SetVehicleNumberPlateText(vehicle:Int, plateText:Int):Void;
	...
	static function StartPlaybackRecordedVehicle(vehicle:Int, recording:Int, script:Int, p3:Bool):Void;
	static function SetVehicleWheelsCanBreakOffWhenBlowUp(vehicle:Int, toggle:Bool):Void;
	static function StartPlaybackRecordedVehicleWithFlags(vehicle:Int, recording:Int, script:Int, flags:Int, time:Int, drivingStyle:Int):Void;
	...
	static function StartPlaybackRecordedVehicleUsingAi(vehicle:Int, recording:Int, script:Int, speed:Float, drivingStyle:Int):Void;
