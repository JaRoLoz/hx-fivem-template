...
extern class Natives {
	...
	static function AddCoverBlockingArea(playerX:Number, playerY:Number, playerZ:Number, radiusX:Number, radiusY:Number, radiusZ:Number, p6:Boolean,
	...
	static function AddOwnedExplosion(ped:Number, x:Number, y:Number, z:Number, explosionType:Number, damageScale:Number, isAudible:Boolean,
		isInvisible:Boolean, cameraShake:Number):Void;
	...
	static function AddRope(x:Number, y:Number, z:Number, rotX:Number, rotY:Number, rotZ:Number, maxLength:Number, ropeType:Number, initLength:Number,
		minLength:Number, lengthChangeRate:Number, onlyPPU:Boolean, collisionOn:Boolean, lockFromFront:Boolean, timeMultiplier:Number, breakable:Boolean,
		unkPtr ? : Number):AddRopeReturnType;
	...
	static function AttachEntityToEntityPhysically(entity1:Number, entity2:Number, boneIndex1:Number, boneIndex2:Number, xPos1:Number, yPos1:Number,
		zPos1:Number, xPos2:Number, yPos2:Number, zPos2:Number, xRot:Number, yRot:Number, zRot:Number, breakForce:Number, fixedRot:Boolean, p15:Boolean,
		collision:Boolean, teleport:Boolean, p18:Number):Void;
	...
	static function CallScaleformMovieFunctionFloatParams(scaleform:Number, methodName:String, param1:Number, param2:Number, param3:Number, param4:Number,
		param5:Number):Void;
	static function CallScaleformMovieMethodWithNumberAndString(scaleform:Number, methodName:String, floatParam1:Number, floatParam2:Number,
		floatParam3:Number, floatParam4:Number, floatParam5:Number, stringParam1:String, stringParam2:String, stringParam3:String, stringParam4:String,
	...
	static function ClearAngledAreaOfVehicles(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, width:Number, p7:Boolean, p8:Boolean,
		p9:Boolean, p10:Boolean, p11:Boolean):Void;
	...
	static function CreateCamWithParams(camName:String, posX:Number, posY:Number, posZ:Number, rotX:Number, rotY:Number, rotZ:Number, fov:Number,
	...
	static function CreateMpGamerTagWithCrewColor(player:Number, username:String, crewIsPrivate:Boolean, crewIsRockstar:Boolean, crewName:String,
		crewRank:Number, crewR:Number, crewG:Number, crewB:Number):Void;
	...
	static function SetMpGamerTagColor(player:Number, username:String, crewIsPrivate:Boolean, crewIsRockstar:Boolean, crewName:String, crewRank:Number,
		crewR:Number, crewG:Number, crewB:Number):Void;
	static function CreateMpGamerTagForNetPlayer(player:Number, username:String, crewIsPrivate:Boolean, crewIsRockstar:Boolean, crewName:String,
		crewRank:Number, crewR:Number, crewG:Number, crewB:Number):Void;
	...
	static function CreateWeaponObject(weaponHash:Number, ammoCount:Number, x:Number, y:Number, z:Number, showWorldModel:Boolean, scale:Number,
		p7:Number):Number;
	...
	static function N_0xca78cfa0366592fe(p0:Number, windowTitle:String, defaultText:String, defaultConcat1:String, defaultConcat2:String,
	...
	static function DrawLightWithRangeWithShadow(x:Number, y:Number, z:Number, r:Number, g:Number, b:Number, range:Number, intensity:Number,
		shadow:Number):Void;
	...
	static function DrawMarker(_type:Number, posX:Number, posY:Number, posZ:Number, dirX:Number, dirY:Number, dirZ:Number, rotX:Number, rotY:Number,
		rotZ:Number, scaleX:Number, scaleY:Number, scaleZ:Number, red:Number, green:Number, blue:Number, alpha:Number, bobUpAndDown:Boolean,
		faceCamera:Boolean, p19:Number, rotate:Boolean, textureDict:String, textureName:String, drawOnEnts:Boolean):Void;
	static function DrawMarker_2(_type:Number, posX:Number, posY:Number, posZ:Number, dirX:Number, dirY:Number, dirZ:Number, rotX:Number, rotY:Number,
		rotZ:Number, scaleX:Number, scaleY:Number, scaleZ:Number, red:Number, green:Number, blue:Number, alpha:Number, bobUpAndDown:Boolean,
		faceCamera:Boolean, p19:Number, rotate:Boolean, textureDict:String, textureName:String, drawOnEnts:Boolean, p24:Boolean):Void;
	...
	static function DrawScaleformMovie_3dNonAdditive(scaleform:Number, posX:Number, posY:Number, posZ:Number, rotX:Number, rotY:Number, rotZ:Number,
		p7:Number, p8:Number, p9:Number, scaleX:Number, scaleY:Number, scaleZ:Number, p13:Number):Void;
	...
	static function DrawSprite(textureDict:String, textureName:String, screenX:Number, screenY:Number, width:Number, height:Number, heading:Number,
		red:Number, green:Number, blue:Number, alpha:Number):Void;
	static function DrawSpritePoly(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, x3:Number, y3:Number, z3:Number, red:Number,
	...
	static function N_0x97c9e4e7024a8f2c(crewTypeIsPrivate:Boolean, crewTagContainsRockstar:Boolean, rank:Number, hasFounderStatus:Boolean,
		isImportant:Boolean, clanHandle:Number, r:Number, g:Number, b:Number):N_0x97c9e4e7024a8f2cReturnType;
	...
	static function GetAnimDuration(animDict:String, animName:String):Number;
	static function GetAnimInitialOffsetPosition(animDict:String, animName:String, x:Number, y:Number, z:Number, xRot:Number, yRot:Number, zRot:Number,
		p8:Number, p9:Number):Vector3;
	static function GetAnimInitialOffsetRotation(animDict:String, animName:String, x:Number, y:Number, z:Number, xRot:Number, yRot:Number, zRot:Number,
		p8:Number, p9:Number):Vector3;
	...
	static function GetDlcWeaponComponentDataSp(dlcWeaponIndex:Number, dlcWeapCompIndex:Number, ComponentDataPtr ? :
		Number):GetDlcWeaponComponentDataSpReturnType;
	...
	static function GetNthClosestVehicleNodeFavourDirection(x:Number, y:Number, z:Number, desiredX:Number, desiredY:Number, desiredZ:Number,
		nthClosest:Number, nodetype:Number, p10:Number, p11:Number):GetNthClosestVehicleNodeFavourDirectionReturnType;
	...
	static function GolfTrailSetColour(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Number, p11:Number):Void;
	static function N_0x12995f2e53ffa601(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Number, p11:Number):Void;
	...
	static function GolfTrailSetFixedControlPoint(_type:Number, xPos:Number, yPos:Number, zPos:Number, p4:Number, red:Number, green:Number, blue:Number,
		alpha:Number):Void;
	static function N_0xb1bb03742917a5d6(_type:Number, xPos:Number, yPos:Number, zPos:Number, p4:Number, red:Number, green:Number, blue:Number,
		alpha:Number):Void;
	...
	static function IsAnyAirDefenseZoneInsideSphere(x:Number, y:Number, z:Number, radius:Number, SphereIndex ? :
		Number):IsAnyAirDefenseZoneInsideSphereReturnType;
	...
	static function IsAreaOccupied(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Boolean, p7:Boolean, p8:Boolean, p9:Boolean,
		p10:Boolean, p11:Number, p12:Boolean):Boolean;
	...
	static function IsPositionOccupied(x:Number, y:Number, z:Number, range:Number, p4:Boolean, checkVehicles:Boolean, checkPeds:Boolean, p7:Boolean,
		p8:Boolean, ignoreEntity:Number, p10:Boolean):Boolean;
	...
	static function N_0x29682e2ccf21e9b5(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
	...
	static function N_0x39455bf4f4f55186(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Number, p11:Number, p12:Number):Number;
	...
	static function N_0xa0ad167e4b39d9a2(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Number, p11:Number, p12:Number, p13:Number):Number;
	...
	static function N_0xf56dfb7b61be7276(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number, p9:Number,
		p10:Number, p11:Number, p12 ? : Number):N_0xf56dfb7b61be7276ReturnType;
	...
	static function N_0x3c5fd37b5499582e(categoryHash:Number, itemHash:Number, actionTypeHash:Number, value:Number,
		flags:Number):N_0x3c5fd37b5499582eReturnType;
	...
	static function NetworkAddEntityToSynchronisedScene(entity:Number, netScene:Number, animDict:String, animName:String, speed:Number,
		speedMulitiplier:Number, flag:Number):Void;
	...
	static function NetworkAddPedToSynchronisedScene(ped:Number, netScene:Number, animDict:String, animnName:String, blendInSpeed:Number,
		blendOutSpeed:Number, duration:Number, flag:Number, playbackRate:Number, p9:Number):Void;
	...
	static function NetworkCheckDataManagerSucceededForHandle(friendDataIndex:Number, networkHandle ? :
		Number):NetworkCheckDataManagerSucceededForHandleReturnType;
	...
	static function NetworkDoTransitionQuickmatchWithGroup(p0:Number, p1:Number, p2:Number, p3:Number,
		p5:Number):NetworkDoTransitionQuickmatchWithGroupReturnType;
	...
	static function NetworkHostTransition(p0:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Boolean, p6:Boolean, p7:Number, p8:Number,
		p9:Number):Boolean;
	...
	static function NetworkStartRespawnSearchInAngledAreaForPlayer(player:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number,
		width:Number, p8:Number, p9:Number, p10:Number, flags:Number):Boolean;
	...
	static function SetEntityCoordsWithoutPlantsReset(entity:Number, xPos:Number, yPos:Number, zPos:Number, alive:Boolean, deadFlag:Boolean,
		ragdollFlag:Boolean, clearArea:Boolean):Void;
	...
	static function SetPedAngledDefensiveArea(ped:Number, p1:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Boolean,
		p9:Boolean):Void;
	...
	static function SetPedDefensiveAreaAttachedToPed(ped:Number, attachPed:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number,
		p8:Number, p9:Boolean, p10:Boolean):Void;
	static function SetPedDefensiveAreaDirection(ped:Number, p1:Number, p2:Number, p3:Number, p4:Boolean):Void;
	static function SetPedDefensiveSphereAttachedToPed(ped:Number, target:Number, xOffset:Number, yOffset:Number, zOffset:Number, radius:Number,
		p6:Boolean):Void;
	...
	static function SetPedToRagdollWithFall(ped:Number, time:Number, p2:Number, ragdollType:Number, x:Number, y:Number, z:Number, p7:Number, p8:Number,
		p9:Number, p10:Number, p11:Number, p12:Number, p13:Number):Boolean;
	...
	static function N_0x15803fec3b9a872b(labelTitle:String, labelMsg:String, p2:Number, p3:Number, labelMsg2:String, p5:Boolean, p6:Number, p7:Number,
		p8:String, p9:String, background:Boolean, errorCode:Number):Void;
	...
	static function SetWarningMessage_2(titleMsg:String, entryLine1:String, flags:Number, promptMsg:String, p4:Boolean, p5:Number, background:Boolean,
		showBg:Boolean):Number;
	static function SetWarningMessageWithHeaderAndSubstringFlags(entryHeader:String, entryLine1:String, instructionalKey:Number, entryLine2:String,
		p4:Boolean, p5:Number, p6:Number, p9:Boolean):SetWarningMessageWithHeaderAndSubstringFlagsReturnType;
	...
	static function SetWarningMessageWithHeaderUnk(entryHeader:String, entryLine1:String, flags:Number, entryLine2:String, p4:Boolean, p5:Number,
		showBg:Boolean, p9:Number, p10:Number):SetWarningMessageWithHeaderUnkReturnType;
	...
	static function SlerpNearQuaternion(t:Number, x:Number, y:Number, z:Number, w:Number, x1:Number, y1:Number, z1:Number,
		w1:Number):SlerpNearQuaternionReturnType;
	...
	static function N_0x6f60e89a7b64ee1d(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number, yRot:Number,
		zRot:Number, scale:Number, xAxis:Boolean, yAxis:Boolean, zAxis:Boolean):Number;
	static function StartParticleFxLoopedOnEntity_2(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number,
		yRot:Number, zRot:Number, scale:Number, xAxis:Boolean, yAxis:Boolean, zAxis:Boolean):Number;
	...
	static function N_0xdde23f30cc5a0f03(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number, yRot:Number,
	...
	static function StartParticleFxNonLoopedOnEntity_2(effectName:String, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number, rotX:Number,
		rotY:Number, rotZ:Number, scale:Number, axisX:Boolean, axisY:Boolean, axisZ:Boolean):Boolean;
	static function StartNetworkedParticleFxNonLoopedOnEntityBone(effectName:String, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number,
		rotX:Number, rotY:Number, rotZ:Number, boneIndex:Number, scale:Number, axisX:Boolean, axisY:Boolean, axisZ:Boolean):Boolean;
	...
	static function StartParticleFxNonLoopedOnPedBone_2(effectName:String, ped:Number, offsetX:Number, offsetY:Number, offsetZ:Number, rotX:Number,
		rotY:Number, rotZ:Number, boneIndex:Number, scale:Number, axisX:Boolean, axisY:Boolean, axisZ:Boolean):Boolean;
	...
	static function StartParticleFxLoopedOnEntity(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number, yRot:Number,
		zRot:Number, scale:Number, xAxis:Boolean, yAxis:Boolean, zAxis:Boolean):Number;
	static function StartParticleFxLoopedOnEntityBone(effectName:String, entity:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number,
		yRot:Number, zRot:Number, boneIndex:Number, scale:Number, xAxis:Boolean, yAxis:Boolean, zAxis:Boolean):Number;
	static function StartParticleFxLoopedOnPedBone(effectName:String, ped:Number, xOffset:Number, yOffset:Number, zOffset:Number, xRot:Number, yRot:Number,
		zRot:Number, boneIndex:Number, scale:Number, xAxis:Boolean, yAxis:Boolean, zAxis:Boolean):Number;
	static function StartParticleFxNonLoopedAtCoord(effectName:String, xPos:Number, yPos:Number, zPos:Number, xRot:Number, yRot:Number, zRot:Number,
		scale:Number, xAxis:Boolean, yAxis:Boolean, zAxis:Boolean):Number;
	static function StartParticleFxNonLoopedOnEntity(effectName:String, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number, rotX:Number,
		rotY:Number, rotZ:Number, scale:Number, axisX:Boolean, axisY:Boolean, axisZ:Boolean):Boolean;
	...
	static function TaskDriveBy(driverPed:Number, targetPed:Number, targetVehicle:Number, targetX:Number, targetY:Number, targetZ:Number,
		distanceToShoot:Number, pedAccuracy:Number, p8:Boolean, firingPattern:Number):Void;
	...
	static function TaskFollowToOffsetOfEntity(ped:Number, entity:Number, offsetX:Number, offsetY:Number, offsetZ:Number, movementSpeed:Number,
	...
	static function TaskMoveNetworkAdvancedByName(ped:Number, p1:String, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number,
		p9:Number, p10:Boolean, animDict:String, flags:Number):Void;
	...
	static function TaskPlaneGotoPreciseVtol(ped:Number, vehicle:Number, p2:Number, p3:Number, p4:Number, p5:Number, p6:Number, p7:Number, p8:Number,
		p9:Number):Void;
	static function TaskPlaneLand(pilot:Number, plane:Number, runwayStartX:Number, runwayStartY:Number, runwayStartZ:Number, runwayEndX:Number,
	...
	static function TaskPlayAnim(ped:Number, animDictionary:String, animationName:String, blendInSpeed:Number, blendOutSpeed:Number, duration:Number,
	...
	static function TaskRappelDownWall(ped:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, minZ:Number, ropeId:Number,
		clipset:String, p10:Number):Void;
	static function N_0xeaf66acddc794793(ped:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, minZ:Number, ropeId:Number,
		clipset:String, p10:Number):Void;
	...
	static function TaskVehicleGotoNavmesh(ped:Number, vehicle:Number, x:Number, y:Number, z:Number, speed:Number, behaviorFlag:Number,
	...
	static function TaskVehicleMissionCoorsTarget(ped:Number, vehicle:Number, x:Number, y:Number, z:Number, p5:Number, p6:Number, p7:Number, p8:Number,
		p9:Number, DriveAgainstTraffic:Boolean):Void;
	...
	static function WaypointRecordingGetClosestWaypoint(name:String, x:Number, y:Number, z:Number, point ? :
		Number):WaypointRecordingGetClosestWaypointReturnType;
